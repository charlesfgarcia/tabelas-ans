...
-- Copiando estrutura para tabela agendamento_cirurgico.ea_procedimentos
CREATE TABLE IF NOT EXISTS `ea_procedimentos` (
  `codigo` int(11) NOT NULL,
  `procedimento` varchar(500) NOT NULL,
  PRIMARY KEY (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela agendamento_cirurgico.ea_procedimentos: ~845 rows (aproximadamente)
/*!40000 ALTER TABLE `ea_procedimentos` DISABLE KEYS */;
INSERT INTO `ea_procedimentos` (`codigo`, `procedimento`) VALUES
	...
	(10103023, 'Atendimento ao recém-nascido em sala de parto (parto normal ou operatório de baixo risco)'),
	...
	(10105050, 'Transporte extra-hospitalar aéreo ou aquático de pacientes graves, 1ª hora - a partir do deslocamento do médico - acompanhamento médico'),
	(10105069, 'Transporte extra-hospitalar aéreo ou aquático de pacientes graves, por hora adicional - acompanhamento médico'),
	...
	(10106065, 'Exame de aptidão física e mental, ou em portadores de mobilidade reduzida, para fins de inscrição ou renovação da CNH (Carteira Nacional de Habilitação)'),
	(10106073, 'Junta Médica (três ou mais profissionais) - destina-se ao esclarecimento diagnóstico ou decisão de conduta em caso de difícil solução - por profissional'),
	...
	(10106111, 'Exame de aptidão física e mental para concessão de benefícios fiscais conferidos pelas Secretaria da Receita Federal e da Fazenda Estadual, a quem fazem jus portadores de mobilidade reduzida, com necessidade de adaptação veicular'),
	(10106120, 'Exame de aptidão física e mental para ratificação, quando a condição física e mental assim o requerer, dos exames realizados pelo órgão previdenciário, incluindo restrição ou liberação para a condução de veículo automotor'),
	(10106138, 'Prova de direção veicular em banca especial - Avaliação Clínica durante a prova de direção veicular procedida por dois médicos simultaneamente'),
	...
	(20101023, 'Análise da proporcionalidade cineantropométrica'),
	...
	(20101112, 'Avaliação da composição corporal por pesagem hidrostática'),
	(20101120, 'Controle anti-doping (por período de 2 horas) - durante competições'),
	(20101139, 'Controle anti-doping (por período de 2 horas) - fora de competições'),
	(20101155, 'Prestação de serviços em delegações ou competições esportivas'),
	(20101171, 'Rejeição de enxerto renal - tratamento ambulatorial - avaliação clínica diária'),
	(20101198, 'Teste e adaptação de lente de contato (sessão) - binocular'),
	...
	(20102011, 'Holter de 24 horas - 2 ou mais canais - analógico'),
	(20102020, 'Holter de 24 horas - 3 canais - digital'),
	(20102038, 'Monitorização ambulatorial da pressão arterial - MAPA (24 horas)'),
	(20102062, 'Monitor de eventos sintomáticos por 15 a 30 dias (LOOPER)'),
	(20102070, 'Tilt teste'),
	...
	(20102111, 'Monitorização eletrocardiográfica programada com transcrição - não contínua'),
	(20102119, 'Monitorização eletrocardiográfica programada com transcrição - não contínua'),
	(20102127, 'Holter 7 dias'),
	(20102135, 'Holter cerebral'),
	(20102143, 'Tilt teste com provas farmacológicas'),
	(20103018, 'Adaptação e treinamento de recursos ópticos para visão subnormal (por sessão) - binocular'),
	(20103026, 'Amputação bilateral (preparação do coto)'),
	(20103034, 'Amputação bilateral (treinamento protético)'),
	(20103042, 'Amputação unilateral (preparação do coto)'),
	(20103050, 'Amputação unilateral (treinamento protético)'),
	(20103069, 'Assistência fisiátrica respiratória em pré e pós-operatório de condições cirúrgicas'),
	(20103077, 'Ataxias'),
	(20103093, 'Atendimento fisiátrico no pré e pós-operatório de pacientes para prevenção de sequelas'),
	(20103107, 'Atendimento fisiátrico no pré e pós-parto'),
	(20103115, 'Atividade reflexa ou aplicação de técnica cinesioterápica específica'),
	(20103123, 'Atividades em escola de postura (máximo de 10 pessoas) - por sessão'),
	...
	(20103212, 'Distúrbios circulatórios artério-venosos e linfáticos'),
	(20103220, 'Doenças pulmonares atendidas em ambulatório'),
	(20103239, 'Exercícios de ortóptica (por sessão)'),
	(20103247, 'Exercícios para reabilitação do asmático (ERAC) - por sessão coletiva'),
	(20103255, 'Exercícios para reabilitação do asmático (ERAI) - por sessão individual'),
	(20103263, 'Hemiparesia'),
	(20103271, 'Hemiplegia'),
	(20103280, 'Hemiplegia e hemiparesia com afasia'),
	(20103298, 'Hipo ou agenesia de membros'),
	(20103301, 'Infiltração de ponto gatilho (por músculo) ou agulhamento seco (por músculo)'),
	(20103310, 'Lesão nervosa periférica afetando mais de um nervo com alterações sensitivas e/ou motoras'),
	(20103328, 'Lesão nervosa periférica afetando um nervo com alterações sensitivas e/ou motoras'),
	(20103336, 'Manipulação vertebral'),
	(20103344, 'Miopatias'),
	(20103360, 'Paciente com D.P.O.C. em atendimento ambulatorial necessitando reeducação e reabilitação respiratória'),
	(20103379, 'Paciente em pós-operatório de cirurgia cardíaca, atendido em ambulatório, duas a três vezes por semana'),
	(20103387, 'Pacientes com doença isquêmica do coração, atendido em ambulatório de 8 a 24 semanas'),
	(20103395, 'Pacientes com doença isquêmica do coração, atendido em ambulatório, até 8 semanas de programa'),
	(20103409, 'Pacientes com doenças neuro-músculo-esqueléticas com envolvimento tegumentar'),
	(20103417, 'Pacientes sem doença coronariana clinicamente manifesta, mas considerada de alto  risco,  atendido  em ambulatório, duas a três vezes por semana'),
	...
	(20103522, 'Patologias osteomioarticulares com dependência de atividades da vida diária'),
	(20103530, 'Recuperação funcional pós-operatória ou por imobilização da patologia vertebral'),
	(20103549, 'Procedimentos mesoterápicos (por região anatômica)'),
	(20103557, 'Procedimentos mesoterápicos com calcitonina (qualquer segmento)'),
	(20103565, 'Processos inflamatórios pélvicos'),
	(20103573, 'Programa de exercício supervisionado com obtenção de eletrocardiograma e/ou saturação de O2 - sessão individual'),
	(20103581, 'Programa de exercício supervisionado com obtenção de eletrocardiograma e/ou saturação de O2 - sessão coletiva'),
	(20103590, 'Programa de exercício supervisionado sem obtenção de eletrocardiograma e/ou saturação de O2 - sessão individual'),
	(20103603, 'Programa de exercício supervisionado sem obtenção de eletrocardiograma e/ou saturação de O2 - sessão coletiva'),
	(20103611, 'Queimados - seguimento ambulatorial para prevenção de sequelas (por segmento)'),
	(20103620, 'Reabilitação de paciente com endoprótese'),
	...
	(20103662, 'Recuperação funcional pós-operatória ou pós-imobilização gessada de  patologia  osteomioarticular  com complicações neurovasculares afetando um membro'),
	(20103670, 'Recuperação funcional pós-operatória ou pós-imobilização gessada de  patologia  osteomioarticular  com complicações neurovasculares afetando mais de um membro'),
	(20103689, 'Retardo do desenvolvimento psicomotor'),
	(20103697, 'Sequelas de traumatismos torácicos e abdominais'),
	(20103700, 'Sequelas em politraumatizados (em diferentes segmentos)'),
	(20103719, 'Sinusites'),
	(20103727, 'Reabilitação  cardíaca supervisionada. Programa de 12 semanas. Duas a três sessões por semana (por sessão)'),
	(20103743, 'Exercícios de pleóptica'),
	(20103751, 'Leme, análise de marcha'),
	(20104014, 'Actinoterapia (por sessão)'),
	(20104022, 'Aplicação de hipossensibilizante - em consultório (AHC) exclusive o alérgeno - planejamento técnico para'),
	...
	(20104138, 'Imunoterapia específica - 30 dias - planejamento técnico'),
	(20104146, 'Imunoterapia inespecífica - 30 dias - planejamento técnico'),
	(20104154, 'Instilação vesical ou uretral'),
	(20104170, 'Sessão de eletroconvulsoterapia (em sala com oxímetro de pulso, monitor de ECG, EEG), sob anestesia'),
	(20104189, 'Sessão de oxigenoterapia hiperbárica (por sessão de 2 horas)'),
	(20104197, 'Sessão de psicoterapia de casal'),
	(20104200, 'Sessão de psicoterapia de grupo (por paciente)'),
	...
	(20104260, 'Terapia oncológica com aplicação de medicamentos por via intracavitária ou intratecal  - por procedimento'),
	(20104278, 'Terapia oncológica com aplicação intra-arterial ou intravenosa de medicamentos em infusão de duração mínima de 6 horas - planejamento e 1º dia de tratamento'),
	...
	(20104383, 'Pulsoterapia intravenosa (por sessão) - ambulatorial'),
	(20104391, 'Terapia imunobiológica intravenosa (por sessão) - ambulatorial'),
	(20104405, 'Terapia fotodinâmica'),
	(20104413, 'Estimulação magnética transcraniana superficial (repetida) - EMT'),
	...
	(20105010, 'Perícia forense, por psiquiatra forense'),
	...
	(20201010, 'Acompanhamento clínico de transplante renal no período de internação do receptor e do doador (pós-operatório até 15 dias)'),
	(20201028, 'Acompanhamento peroperatório'),
	(20201036, 'Assistência cardiológica peroperatória em cirurgia geral e em parto (primeira hora)'),
	(20201044, 'Assistência cardiológica peroperatória em cirurgia geral e em parto (horas suplementares) - máximo de 4 horas'),
	(20201052, 'Cardioversão elétrica eletiva (avaliação clínica, eletrocardiográfica, indispensável à desfibrilação)'),
	(20201060, 'Rejeição de enxerto renal - tratamento internado - avaliação clínica diária - por visita'),
	(20201079, 'Transplante duplo rim-pâncreas - acompanhamento clínico (pós-operatório até 15 dias)'),
	...
	(20203012, 'Assistência fisiátrica respiratória em paciente internado com ventilação mecânica'),
	...
	(20203063, 'Pacientes com doença isquêmica do coração, hospitalizado, até 8 semanas de programa'),
	(20203071, 'Pacientes em pós-operatório de cirurgia cardíaca, hospitalizado, até 8 semanas de programa'),
	...
	(20204086, 'Terapia oncológica com aplicação intra-arterial de medicamentos, em regime de aplicação peroperatória, por meio de cronoinfusor ou perfusor extra-corpórea'),
	...
	(30101042, 'Alopecia parcial - rotação múltipla de retalhos'),
	(30101050, 'Apêndice pré-auricular - ressecção'),
	(30101069, 'Autonomização de retalho - por estágio'),
	(30101077, 'Biópsia de pele, tumores superficiais, tecido celular subcutâneo, linfonodo superficial, etc'),
	(30101085, 'Biópsia de unha'),
	(30101093, 'Calosidade e/ou mal perfurante - desbastamento (por lesão)'),
	...
	(30101158, 'Correção cirúrgica de sequelas de alopecia traumática com microenxertos pilosos (por região)'),
	(30101166, 'Correção de deformidades nos membros com utilização de implantes'),
	(30101174, 'Correção de deformidades por exérese de tumores, cicatrizes ou ferimentos com o emprego de expansores  em retalhos  musculares ou miocutâneos (por estágio)'),
	...
	(30101190, 'Correção de lipodistrofia braquial, crural ou trocanteriana de membros superiores e inferiores'),
	...
	(30101220, 'Curativo de queimaduras - por unidade topográfica (UT) hospitalar'),
	...
	(30101255, 'Curetagem simples de lesões de pele (por grupo de até 5 lesões)'),
	...
	(30101298, 'Eletrocoagulação de lesões de pele e mucosas - com ou sem curetagem (por grupo de até 5 lesões)'),
	...
	(30101387, 'Escarectomia descompressiva (pele e estruturas profundas) - por unidade topográfica (UT)'),
	...
	(30101433, 'Exérese de higroma cístico no RN e lactente'),
	(30101441, 'Exérese de lesão com auto-enxertia'),
	(30101450, 'Exérese e sutura de lesões (circulares ou não) com rotação de retalhos cutâneos'),
	...
	(30101492, 'Exérese e sutura simples de pequenas lesões (por grupo de até 5 lesões)'),
	(30101506, 'Exérese tangencial (shaving) - (por grupo de até 5 lesões)'),
	(30101514, 'Expansão tissular (por sessão)'),
	(30101522, 'Extensos ferimentos, cicatrizes ou tumores - excisão e retalhos cutâneos da região'),
	(30101530, 'Extensos ferimentos, cicatrizes ou tumores - exérese e emprego de retalhos cutâneos ou musculares  cruzados (por estágio)'),
	(30101549, 'Extensos ferimentos, cicatrizes ou tumores - exérese e retalhos cutâneos à distância'),
	(30101557, 'Extensos ferimentos, cicatrizes ou tumores - exérese e rotação de retalho fasciocutâneo ou axial'),
	...
	(30101646, 'Infiltração  intralesional, cicatricial / hemangiomas - por sessão'),
	...
	(30101751, 'Retração cicatricial de zona de flexão e extensão de membros superiores e inferiores - tratamento cirúrgico'),
	(30101760, 'Retração cicatricial do cotovelo - tratamento cirúrgico'),
	(30101778, 'Retração de aponevrose palmar (Dupuytren) - tratamento cirúrgico'),
	...
	(30101859, 'Tratamento de anomalias pilosas a laser/photoderm - por sessão'),
	...
	(30101905, 'Tratamento de lesões cutâneas e vasculares a laser/photoderm - por sessão'),
	(30101913, 'TU partes moles - exérese'),
	(30101921, 'Exérese e sutura de hemangioma, linfangioma ou nevus (por grupo de até 5 lesões)'),
	...
	(30204054, 'Parotidectomia total ampliada com ou sem reconstrução com retalhos locais'),
	(30204062, 'Parotidectomia total com conservação do nervo facial'),
	(30204070, 'Parotidectomia total com reconstrução do nervo facial'),
	...
	(30212030, 'Esvaziamento cervical radical (especificar o lado)'),
	(30212049, 'Esvaziamento cervical radical ampliado'),
	(30212057, 'Esvaziamento cervical seletivo (especificar o lado)'),
	...
	(30214033, 'Reimplante de paratireóide previamente preservada'),
	(30214041, 'Tratamento cirúrgico do hiperparatireoidismo primário'),
	(30214050, 'Tratamento cirúrgico do hiperparatireoidismo secundário'),
	...
	(30301092, 'Correção de bolsas palpebrais - unilateral'),
	(30301106, 'Dermatocalaze ou blefarocalaze exérese - unilateral'),
	(30301114, 'Epicanto - correção cirúrgica - unilateral'),
	(30301122, 'Epilação'),
	(30301130, 'Epilação de cílios (diatermo-coagulação)'),
	(30301149, 'Fissura palpebral - correção cirúrgica'),
	(30301157, 'Lagoftalmo - correção cirúrgica'),
	(30301165, 'Pálpebra - reconstrução parcial (com ou sem ressecção de tumor)'),
	(30301173, 'Pálpebra - reconstrução total (com ou sem ressecção de tumor) - por estágio'),
	(30301181, 'Ptose palpebral - correção cirúrgica - unilateral'),
	(30301190, 'Ressecção de tumores palpebrais'),
	(30301203, 'Retração palpebral - correção cirúrgica'),
	(30301211, 'Simbléfaro com ou sem enxerto - correção cirúrgica'),
	(30301220, 'Supercílio - reconstrução total'),
	(30301238, 'Sutura de pálpebra'),
	(30301246, 'Tarsorrafia'),
	(30301254, 'Telecanto - correção cirúrgica - unilateral'),
	(30301262, 'Triquíase com ou sem enxerto'),
	(30301270, 'Xantelasma palpebral - exérese - unilateral'),
	...
	(30302056, 'Exérese de tumor com abordagem craniofacial oncológica (tempo facial) pálpebra, cavidade orbitária e olhos'),
	(30302064, 'Fratura de órbita - redução cirúrgica'),
	(30302072, 'Fratura de órbita - redução cirúrgica e enxerto ósseo'),
	...
	(30302110, 'Reconstrução parcial da cavidade orbital - por estágio'),
	(30302129, 'Reconstrução total da cavidade orbital - por estágio'),
	...
	(30304040, 'PTK ceratectomia fototerapêutica - monocular'),
	(30304059, 'Recobrimento conjuntival'),
	(30304067, 'Sutura de córnea (com ou sem hérnia de íris)'),
	(30304075, 'Tarsoconjuntivoceratoplastia'),
	(30304083, 'Implante de anel intra-estromal'),
	(30304091, 'Fotoablação de superfície convencional - PRK'),
	(30304105, 'Delaminação corneana com fotoablação estromal - LASIK'),
	(30304113, 'Transplante lamelar anterior de córnea'),
	(30304121, 'Transplante lamelar posterior de córnea'),
	(30304156, 'Cross-linking (CXL) de colágeno corneano'),
	(30305012, 'Paracentese da câmara anterior'),
	(30305020, 'Reconstrução da câmara anterior'),
	(30305039, 'Remoção de hifema'),
	(30305047, 'Retirada de corpo estranho da câmara anterior'),
	(30306019, 'Capsulotomia YAG ou cirúrgica'),
	(30306027, 'Facectomia com lente intra-ocular com facoemulsificação'),
	(30306035, 'Facectomia com lente intra-ocular sem facoemulsificação'),
	(30306043, 'Facectomia sem implante'),
	(30306051, 'Fixação iriana de lente intra-ocular'),
	(30306060, 'Implante secundário / explante / fixação escleral ou iriana'),
	(30306078, 'Remoção de pigmentos da lente intra-ocular com yag-laser'),
	...
	(30307066, 'Membranectomia EPI ou sub-retiniana'),
	(30307074, 'Retirada de corpo estranho do corpo vítreo'),
	(30307082, 'Retirada de óleo de silicone via pars plana'),
	(30307090, 'Troca fluido gasosa'),
	(30307104, 'Vitrectomia a céu aberto - ceratoprótese'),
	(30307112, 'Vitrectomia anterior'),
	(30307120, 'Vitrectomia vias pars plana'),
	(30307139, 'Infusão intravítrea de medicação anti-inflamatória'),
	...
	(30309018, 'Enucleação ou evisceração com ou sem implante'),
	(30309026, 'Injeção retrobulbar'),
	(30309034, 'Reconstituição de globo ocular com lesão de estruturas intra-oculares'),
	(30310016, 'Biópsia de íris e corpo ciliar'),
	(30310024, 'Cicloterapia - qualquer técnica'),
	(30310032, 'Cirurgias fistulizantes antiglaucomatosas'),
	(30310040, 'Cirurgias fistulizantes com implantes valvulares'),
	(30310059, 'Drenagem de descolamento de coróide'),
	...
	(30311047, 'Estrabismo horizontal - monocular - tratamento ciúrgico'),
	(30311055, 'Injeção de toxina botulínica - monocular'),
	(30312019, 'Aplicação de placa radiativa episcleral'),
	(30312027, 'Biópsia de retina'),
	(30312035, 'Exérese de tumor de coróide e/ou corpo ciliar'),
	(30312043, 'Fotocoagulação (laser) - por sessão  - monocular'),
	...
	(30312132, 'Implante intravítreo de polímero farmacológico de liberação controlada'),
	(30312159, 'Termoterapia transpupilar'),
	(30313015, 'Cirurgia da glândula lacrimal'),
	(30313023, 'Dacriocistectomia - unilateral'),
	(30313031, 'Dacriocistorrinostomia com ou sem intubação - unilateral'),
	(30313040, 'Fechamento dos pontos lacrimais'),
	(30313058, 'Reconstituição de vias lacrimais com silicone ou outro material'),
	(30313066, 'Sondagem das vias lacrimais - com ou sem lavagem'),
	...
	(30501091, 'Corpos estranhos - retirada sob anestesia geral / hospital (nariz)'),
	...
	(30502195, 'Biópsia de seios paranasais - qualquer via'),
	...
	(30502284, 'Antrostomia maxilar, etmoidectomia etc a laser (abertura de todas as cavidades paranasais a laser)'),
	...
	(30601274, 'Correção de deformidades da parede torácica por vídeo'),
	(30601282, 'Vídeo para procedimentos sobre a coluna vertebral'),
	...
	(30602033, 'Correção cirúrgica da assimetria mamária'),
	...
	(30602122, 'Correção da hipertrofia mamária - unilateral'),
	(30602130, 'Linfadenectomia axilar'),
	(30602149, 'Mastectomia radical ou radical modificada - qualquer técnica'),
	...
	(30602181, 'Punção ou biópsia percutânea de agulha fina - por nódulo (máximo de 3 nódulos por mama)'),
	...
	(30602238, 'Reconstrução mamária com retalho muscular ou miocutâneo - unilateral'),
	(30602246, 'Reconstrução mamária com retalhos cutâneos regionais'),
	(30602254, 'Reconstrução parcial da mama pós-quadrantectomia'),
	(30602262, 'Reconstrução da mama com prótese e/ou expansor'),
	...
	(30602343, 'Linfadenectomia por incisão extra-axilar'),
	...
	(30701147, 'Interdigital da 1ª comissura dos dedos do pé - transplantes cutâneos'),
	...
	(30702011, 'Grande dorsal (latissimus dorsi) - transplantes músculo-cutâneos com microanastomoses vasculares'),
	...
	(30702054, 'Reto interno (gracilis) - transplantes músculo-cutâneos com microanastomoses vasculares'),
	(30702062, 'Serrato maior (serratus) - transplantes músculo-cutâneos com microanastomoses vasculares'),
	(30702070, 'Tensor da fascia lata (tensor fascia lata) - transplantes músculo-cutâneos com microanastomoses vasculares'),
	(30702089, 'Trapézio (trapezius)'),
	(30703018, 'Bíceps femoral (biceps femoris)'),
	(30703026, 'Extensor comum dos dedos (extensor digitorum longus)'),
	(30703034, 'Extensor próprio do dedo gordo (extensor hallucis longus)'),
	(30703042, 'Flexor curto plantar (flexor digitorum brevis)'),
	(30703050, 'Grande dorsal (latissimus dorsi) - transplantes musculares com microanastomoses vasculares'),
	(30703069, 'Grande peitoral (pectoralis major)'),
	(30703077, 'Músculo pédio (extensor digitorum brevis)'),
	...
	(30703107, 'Primeiro radial externo (extensor carpi radialis longus)'),
	(30703115, 'Reto anterior (rectus femoris)'),
	(30703123, 'Reto interno (gracilis) - transplantes musculares com microanastomoses vasculares'),
	(30703131, 'Sartório (sartorius)'),
	(30703140, 'Semimembranoso (semimembranosus)'),
	(30703158, 'Semitendinoso (semitendinosus)'),
	(30703166, 'Serrato maior (serratus) - transplantes musculares com microanastomoses vasculares'),
	(30703174, 'Supinador longo (brachioradialis)'),
	(30703182, 'Tensor da fascia lata (tensor fascia lata) - transplantes musculares com microanastomoses vasculares'),
	(30704014, 'Costela'),
	(30704022, 'Ilíaco'),
	(30704030, 'Osteocutâneo de ilíaco'),
	(30704049, 'Osteocutâneos de costela'),
	(30704057, 'Osteomusculocutâneo de costela'),
	(30704065, 'Outros transplantes ósseos e osteomusculocutâneos'),
	(30704073, 'Perônio ou fíbula'),
	(30704081, 'Transplante ósseo vascularizado (microanastomose)'),
	(30705010, 'Autotransplante de dois retalhos  musculares combinados, isolados e associados entre si, ligados por um único pedículo'),
	(30705029, 'Autotransplante de dois retalhos cutâneos combinados, isolados e associados entre si, ligados por um único pedículo vascular'),
	(30705037, 'Autotransplante de dois retalhos,  um  cutâneo  combinado a um muscular,  isolados  e associados entre si, ligados por um único pedículo vascular'),
	(30705045, 'Autotransplante de dois retalhos, um cutâneo combinado a retalho osteomuscular, isolados e associados entre sí, ligados por um único pedículo vascular'),
	(30705053, 'Autotransplante de epiplon'),
	(30705061, 'Autotransplante de outros retalhos,  isolados  entre  si, e associados mediante um único pedículo vascular comuns aos retalhos'),
	(30705070, 'Autotransplante de três retalhos, um cutâneo separado, combinado a outros dois retalhos musculares isolados e associados, ligados por um único pedículo vascular'),
	(30705100, 'Reimplante de segmentos distais do membro superior, com ressecção segmentar'),
	(30706017, 'Reimplante do membro inferior do nível médio proximal da perna até a coxa'),
	(30706025, 'Reimplante do membro inferior do pé até o terço médio da perna'),
	(30706033, 'Reimplante do membro superior, do nível médio do antebraço até o ombro'),
	(30707013, 'Transplante articular de metatarsofalângica para a mão'),
	(30707021, 'Transplante de 2º pododáctilo para mão'),
	(30707030, 'Transplante de dedos do pé para a mão'),
	(30707048, 'Transplante do 2º pododáctilo para o polegar'),
	(30707056, 'Transplante do hallux para polegar'),
	(30707064, 'Transplante de dois pododáctilos para a mão'),
	(30709016, 'Instalação de halo craniano'),
	(30709024, 'Tração cutânea'),
	(30709032, 'Tração transesquelética (por membro)'),
	(30710014, 'Retirada de fios ou pinos metálicos transósseos'),
	(30710022, 'Retirada de fios, pinos, parafusos ou hastes metálicas intra-ósseas'),
	(30710030, 'Retirada de placas'),
	(30710049, 'Retirada de próteses de substituição de pequenas articulações'),
	(30710057, 'Retirada de fixadores externos'),
	(30710065, 'Retirada de prótese de substituição (grandes e médias articulações)'),
	(30711010, 'Imobilizações não-gessadas (qualquer segmento)'),
	...
	(30713137, 'Punção articular diagnóstica ou terapêutica (infiltração) - orientada ou não por método de imagem'),
	(30713145, 'Punção extra-articular diagnóstica ou terapêutica (infiltração/agulhamento seco) - orientada ou não por método de imagem'),
	...
	(30714028, 'Corpo estranho intra-ósseo - tratamento cirúrgico'),
	(30714036, 'Corpo estranho intramuscular - tratamento cirúrgico'),
	(30715016, 'Artrodese da coluna com instrumentação por segmento'),
	...
	(30715121, 'Fratura de coluna sem gesso - tratamento conservador'),
	(30715130, 'Fratura do cóccix - redução incruenta'),
	(30715148, 'Fratura do cóccix - tratamento cirúrgico'),
	...
	(30715172, 'Hemivértebra - ressecção via anterior ou posterior - tratamento cirúrgico'),
	...
	(30715237, 'Outras afecções da coluna - tratamento incruento'),
	(30715245, 'Pseudartrose de coluna - tratamento cirúrgico'),
	(30715253, 'Punção liquórica'),
	(30715261, 'Retirada de corpo estranho - tratamento cirúrgico'),
	...
	(30715350, 'Tratamento microcirúrgico das lesões intramedulares (tumor, malformações arteriovenosas, siringomielia, parasitoses)'),
	(30715369, 'Tratamento microcirúrgico do canal vertebral estreito por segmento'),
	(30715377, 'Tratamento pré-natal dos disrafismos espinhais'),
	...
	(30717051, 'Deformidade (doença) Sprengel - tratamento cirúrgico'),
	(30717060, 'Desarticulação ao nível do ombro - tratamento cirúrgico'),
	(30717078, 'Escápula em ressalto - tratamento cirúrgico'),
	(30717086, 'Fratura de cintura escapular - tratamento conservador'),
	(30717094, 'Fraturas e/ou luxações e/ou avulsões - redução incruenta - em articulação escápulo-umeral e cintura escapular'),
	(30717108, 'Fraturas e/ou luxações e/ou avulsões - tratamento cirúrgico - em articulação escápulo-umeral e cintura escapular'),
	(30717116, 'Luxações crônicas inveteradas e recidivantes - tratamento cirúrgico - em articulação escápulo-umeral e cintura escapular'),
	...
	(30718031, 'Fixador externo dinâmico com ou sem alongamento - tratamento cirúrgico'),
	(30718040, 'Fratura (incluindo descolamento epifisário) - redução incruenta'),
	(30718058, 'Fratura (incluindo descolamento epifisário) - tratamento cirúrgico'),
	(30718066, 'Fratura de úmero - tratamento conservador'),
	(30718074, 'Fraturas e pseudartroses - fixador externo - tratamento cirúrgico'),
	(30718082, 'Osteomielite de úmero - tratamento cirúrgico'),
	(30718090, 'Pseudartroses, osteotomias, alongamentos/encurtamentos - tratamento cirúrgico'),
	(30718104, 'Osteomielite de úmero - tratamento incruento'),
	(30719011, 'Artrodese - tratamento cirúrgico'),
	(30719020, 'Artroplastia com implante - tratamento cirúrgico'),
	(30719038, 'Artroplastias sem implante - tratamento cirúrgico'),
	...
	(30719070, 'Fratura de cotovelo - tratamento conservador'),
	(30719089, 'Fraturas / pseudartroses / artroses / com fixador externo dinâmico - tratamento cirúrgico'),
	(30719097, 'Fraturas e ou luxações - redução incruenta'),
	(30719100, 'Fraturas e ou luxações - tratamento cirúrgico'),
	(30719119, 'Lesões ligamentares - redução incruenta'),
	(30719127, 'Tendinites, sinovites e artrites - tratamento cirúrgico'),
	(30719135, 'Artrodiastase - tratamento cirúrgico com fixador externo'),
	...
	(30720087, 'Fratura do antebraço - tratamento conservador'),
	(30720095, 'Fratura e/ou luxações (incluindo descolamento epifisário cotovelo-punho) - tratamento cirúrgico'),
	...
	(30720141, 'Ressecção da cabeça do rádio e/ ou da extremidade distal ulna - tratamento cirúrgico'),
	...
	(30721105, 'Coto de amputação punho e antebraço - revisão'),
	(30721113, 'Desarticulação do punho - tratamento cirúrgico'),
	(30721121, 'Encurtamento rádio/ulnar'),
	(30721130, 'Fratura de punho - tratamento conservador'),
	...
	(30721172, 'Fraturas do carpo - tratamento conservador'),
	...
	(30722012, 'Abscesso de mão e dedos - tenossinovites / espaços palmares / dorsais e comissurais - tratamento cirúrgico'),
	...
	(30722179, 'Bridas congênitas - tratamento cirúrgico'),
	(30722209, 'Capsulectomias múltiplas MF ou IF'),
	(30722217, 'Capsulectomias única MF e IF'),
	(30722225, 'Centralização da ulna (tratamento da mão torta radial)'),
	(30722233, 'Contratura isquêmica de mão - tratamento cirúrgico'),
	(30722241, 'Coto de amputação digital - revisão'),
	(30722250, 'Dedo colo de cisne - tratamento cirúrgico'),
	(30722268, 'Dedo em botoeira - tratamento cirúrgico'),
	(30722276, 'Dedo em gatilho, capsulotomia / fasciotomia - tratamento cirúrgico'),
	(30722284, 'Dedo em martelo - tratamento cirúrgico'),
	(30722292, 'Dedo em martelo - tratamento conservador'),
	(30722306, 'Enxerto ósseo (perda de substância) - tratamento cirúrgico'),
	(30722314, 'Exploração cirúrgica de tendão de mão'),
	(30722322, 'Falangização'),
	(30722330, 'Fixador externo em cirurgia da mão'),
	(30722349, 'Fratura de falanges - tratamento conservador'),
	(30722357, 'Fratura de Bennett - redução incruenta'),
	(30722365, 'Fratura de Bennett - tratamento cirúrgico'),
	(30722373, 'Fratura de osso da mão - tratamento conservador'),
	(30722381, 'Fratura de metacarpiano - tratamento conservador'),
	(30722390, 'Fratura/artrodese com fixador externo'),
	(30722403, 'Fraturas de falanges ou metacarpianos - redução incruenta'),
	(30722411, 'Fraturas de falanges ou metacarpianos - tratamento cirúrgico com fixação'),
	(30722420, 'Fraturas e/ou luxações de falanges (interfalangeanas) - redução incruenta'),
	(30722438, 'Fraturas e/ou luxações de falanges (interfalangeanas) - tratamento cirúrgico'),
	(30722446, 'Fraturas e/ou luxações de metacarpianos - redução incruenta'),
	(30722454, 'Gigantismo ao nível da mão - tratamento cirúrgico'),
	...
	(30722497, 'Luxação metacarpofalangeana - redução incruenta'),
	(30722500, 'Luxação metacarpofalangeana - tratamento cirúrgico'),
	(30722519, 'Osteomielite ao nível da mão - tratamento cirúrgico'),
	(30722527, 'Osteossíntese de fratura de falange e metacarpeana com fixação externa'),
	(30722535, 'Osteossíntese de fratura de falange e metacarpeana com uso de miniparafuso'),
	(30722543, 'Perda de substância da mão (reparação) - tratamento cirúrgico'),
	(30722551, 'Plástica ungueal'),
	(30722560, 'Policização ou transferência digital'),
	(30722578, 'Polidactilia articulada - tratamento cirúrgico'),
	(30722586, 'Polidactilia não articulada - tratamento cirúrgico'),
	(30722594, 'Prótese (implante) para ossos do carpo'),
	(30722608, 'Pseudartrose com perda de substâncias de metacarpiano e falanges'),
	(30722616, 'Pseudartrose do escafóide - tratamento cirúrgico'),
	(30722624, 'Pseudartrose dos ossos da mão - tratamento cirúrgico'),
	(30722632, 'Reconstrução da falange com retalho homodigital'),
	(30722640, 'Reconstrução de leito ungueal'),
	(30722659, 'Reconstrução do polegar com retalho ilhado osteocutâneo antebraquial'),
	(30722667, 'Reimplante de dois dedos da mão'),
	(30722675, 'Reimplante do membro superior nível transmetacarpiano até o terço distal do antebraço'),
	(30722683, 'Reimplante do polegar'),
	(30722691, 'Reparações cutâneas com retalho ilhado antebraquial invertido'),
	(30722705, 'Ressecção 1ª fileira dos ossos do carpo'),
	(30722713, 'Ressecção de cisto sinovial'),
	(30722721, 'Retração cicatricial de mais de um dedo, sem comprometimento tendinoso - tratamento cirúrgico'),
	(30722730, 'Retração cicatricial de um dedo sem comprometimento tendinoso - tratamento cirúrgico'),
	(30722748, 'Retração cicatricial dos dedos com lesão tendínea - tratamento cirúrgico'),
	(30722756, 'Revascularização  do  polegar  ou  outro  dedo'),
	...
	(30722861, 'Tratamento cirúrgico da sindactilia múltipla com emprego de expansor - por estágio'),
	...
	(30722918, 'Rotura do aparelho extensor do dedo - tratamento cirúrgico'),
	(30723019, 'Biópsia cirúrgica de cintura pélvica'),
	(30723027, 'Desarticulação interílio abdominal - tratamento cirúrgico'),
	(30723035, 'Fratura da cintura pélvica - tratamento conservador'),
	(30723043, 'Fratura/luxação com fixador externo - tratamento cirúrgico'),
	(30723051, 'Fraturas e/ou luxações do anel pélvico (com uma ou mais abordagens) - tratamento cirúrgico'),
	...
	(30723116, 'Fratura ou disjunção ao nível da pelve - tratamento conservador com gesso'),
	(30723124, 'Fratura ou disjunção ao nível da pelve - tratamento conservador sem gesso'),
	(30724015, 'Artrite séptica  - tratamento cirúrgico - articulação coxo-femoral'),
	...
	(30724139, 'Epifisiodese com abaixamento do grande trocanter - tratamento cirúrgico'),
	(30724147, 'Epifisiolistese proximal de fêmur (fixação "in situ") - tratamento cirúrgico'),
	(30724155, 'Fratura de acetábulo (com uma ou mais abordagens) - tratamento cirúrgico'),
	...
	(30724210, 'Luxação congênita de quadril (redução incruenta com ou sem tenotomia de adutores)'),
	...
	(30724252, 'Punção-biópsia coxo-femoral-artrocentese'),
	...
	(30725135, 'Fraturas,  pseudartroses,  correção  de  deformidades e  alongamentos com fixador externo dinâmico - tratamento cirúrgico'),
	...
	(30726077, 'Epifisites e tendinites - tratamento cirúrgico'),
	(30726085, 'Fratura de joelho - tratamento conservador'),
	...
	(30726255, 'Revisões de artroplastia total - tratamento cirúrgico'),
	(30726263, 'Revisões de realinhamentos do aparelho extensor - tratamento cirúrgico'),
	(30726271, 'Revisões de reconstruções intra-articulares - tratamento cirúrgico'),
	(30726280, 'Toalete cirúrgica - correção de joelho flexo - tratamento cirúrgico'),
	...
	(30727014, 'Alongamento / transporte ósseo / pseudoartrose com fixador externo - perna'),
	(30727022, 'Alongamento com fixador dinâmico - tratamento cirúrgico'),
	(30727030, 'Alongamento dos ossos da perna - tratamento cirúrgico'),
	(30727049, 'Amputação de perna - tratamento cirúrgico'),
	(30727057, 'Biópsia cirúrgica de tíbia ou fíbula'),
	(30727065, 'Correção de deformidade adquirida de tíbia com fixador externo'),
	(30727073, 'Correção de deformidades congênitas na perna com fixador externo'),
	(30727081, 'Encurtamento dos ossos da perna - tratamento cirúrgico'),
	(30727090, 'Epifisiodese de tíbia/fíbula - tratamento cirúrgico'),
	(30727103, 'Fratura de osso da perna - tratamento conservador'),
	(30727111, 'Fraturas de fíbula (inclui o descolamento epifisário) - tratamento cirúrgico'),
	...
	(30727162, 'Osteotomias e/ou pseudartroses - tratamento cirúrgico'),
	(30727170, 'Transposição de fíbula/tíbia - tratamento cirúrgico'),
	...
	(30728010, 'Amputação ao nível do tornozelo - tratamento cirúrgico'),
	(30728029, 'Artrite ou osteoartrite - tratamento cirúrgico'),
	...
	(30728096, 'Fratura de tornozelo - tratamento conservador'),
	...
	(30728134, 'Lesões ligamentares agudas ao nível do tornozelo - tratamento incruento'),
	...
	(30728177, 'Pseudartroses ou osteotomias ao nível do tornozelo - tratamento cirúrgico'),
	(30729017, 'Amputação ao nível do pé - tratamento cirúrgico'),
	(30729025, 'Amputação/desarticulação de pododáctilos (por segmento) - tratamento cirúrgico'),
	...
	(30729084, 'Correção de deformidades do pé com fixador externo dinâmico - tratamento cirúrgico'),
	(30729092, 'Correção de pé torto congênito com fixador externo'),
	(30729106, 'Deformidade dos dedos - tratamento cirúrgico'),
	(30729114, 'Exérese ungueal'),
	(30729122, 'Fasciotomia ou ressecção de fascia plantar - tratamento cirúrgico'),
	(30729130, 'Fratura de osso do pé - tratamento conservador'),
	...
	(30729289, 'Tratamento cirúrgico da sindactilia complexa e /ou múltipla'),
	(30729297, 'Tratamento cirúrgico da sindactilia simples'),
	(30729300, 'Tratamento cirúrgico de gigantismo'),
	(30729319, 'Tratamento cirúrgico de linfedema ao nível do pé'),
	(30729327, 'Tratamento cirúrgico de polidactilia múltipla e/ou complexa'),
	(30729335, 'Tratamento cirúrgico de polidactilia simples'),
	(30729343, 'Tratamento cirúrgico do mal perfurante plantar'),
	...
	(30730112, 'Miorrafias'),
	(30730120, 'Terapia por ondas de choque extracorpórea em partes moles - acompanhamento 1ª aplicação'),
	(30730139, 'Terapia por ondas de choque extracorpórea em partes moles - acompanhamento reaplicações'),
	...
	(30731127, 'Tenoplastia de tendão em outras regiões'),
	(30731135, 'Tenorrafia múltipla em outras regiões'),
	(30731143, 'Tenorrafia no túnel osteofibroso - mais de 2 dígitos'),
	(30731151, 'Tenorrafia no túnel osteofibroso até 2 dígitos'),
	(30731160, 'Tenorrafia única em outras regiões'),
	(30731178, 'Tenossinovectomia de mão ou punho'),
	(30731186, 'Tenossinovites estenosantes - tratamento cirúrgico'),
	(30731194, 'Tenossinovites infecciosas - drenagem'),
	(30731208, 'Tenotomia'),
	(30731216, 'Transposição de mais de 1 tendão - tratamento cirúrgico'),
	(30731224, 'Transposição única de tendão'),
	(30731232, 'Tumores de tendão ou sinovial - tratamento cirúrgico'),
	(30731240, 'Alongamento de tendões - tratamento cruento'),
	...
	(30732050, 'Terapia por ondas de choque extracorpórea em partes ósseas - acompanhamento 1ª aplicação'),
	(30732069, 'Terapia por ondas de choque extracorpórea em partes ósseas - acompanhamento reaplicações'),
	...
	(30733014, 'Sinovectomia total  - procedimento videoartroscópico de joelho'),
	(30733022, 'Sinovectomia parcial ou subtotal - procedimento videoartroscópico de joelho'),
	...
	(30733065, 'Reparo ou sutura de um menisco - procedimento videoartroscópico de joelho'),
	...
	(30733081, 'Fratura com redução e/ou estabilização da superfície articular - um compartimento #  - procedimento videoartroscópico de joelho'),
	(30733090, 'Tratamento cirúrgico da artrofibrose #  - procedimento videoartroscópico de joelho'),
	(30733103, 'Instabilidade femoro-patelar, release lateral da patela, retencionamento, reforço ou reconstrução do ligamento patelo-femoral medial #  - procedimento videoartroscópico de joelho'),
	...
	(30736013, 'Sinovectomia  total - procedimento videoartroscópico de cotovelo'),
	...
	(30736048, 'Osteocondroplastia - estabilização, ressecção e/ou plastia (enxertia) # - procedimento videoartroscópico de cotovelo'),
	(30736056, 'Reconstrução, retencionamento ou reforço de ligamento #  - procedimento videoartroscópico de cotovelo'),
	(30736064, 'Fraturas: redução e estabilização para cada superfície - procedimento videoartroscópico de cotovelo'),
	(30737010, 'Sinovectomia total - procedimento videoartroscópico de punho e túnel do carpo'),
	...
	(30737044, 'Osteocondroplastia - estabilização, ressecção e/ou plastia (enxertia) - procedimento videoartroscópico de punho e túnel do carpo'),
	...
	(30737060, 'Fraturas - redução e estabilização de cada superfície - procedimento videoartroscópico de punho e túnel do carpo'),
	(30737079, 'Túnel do carpo - descompressão - procedimento videoartroscópico de punho e túnel do carpo'),
	(30738016, 'Sinovectomia total - procedimento videoartroscópico de coxofemoral'),
	(30738024, 'Sinovectomia parcial e/ou remoção de corpos livres - procedimento videoartroscópico de coxofemoral'),
	(30738032, 'Desbridamento do labrum ou ligamento redondo com ou sem condroplastia - procedimento videoartroscópico de coxofemoral'),
	...
	(30801010, 'Colocação de órtese traqueal, traqueobrônquica ou brônquica, por via endoscópica (tubo de silicone ou metálico)'),
	...
	(30802032, 'Colocação de molde brônquico por toracotomia'),
	(30802040, 'Broncoplastia e/ou arterioplastia por videotoracoscopia'),
	(30802059, 'Broncotomia e/ou broncorrafia por videotoracoscopia'),
	...
	(30803047, 'Correção de fístula bronco-pleural (qualquer técnica)'),
	(30803055, 'Drenagem tubular aberta de cavidade pulmonar'),
	(30803063, 'Embolectomia pulmonar'),
	(30803071, 'Lobectomia por malformação pulmonar'),
	(30803080, 'Lobectomia pulmonar'),
	(30803098, 'Metastasectomia pulmonar unilateral (qualquer técnica)'),
	(30803101, 'Pneumonectomia'),
	(30803110, 'Pneumonectomia de totalização'),
	(30803128, 'Pneumorrafia'),
	(30803136, 'Pneumostomia (cavernostomia) com costectomia e estoma cutâneo-cavitário'),
	(30803144, 'Posicionamento de agulhas radiativas por toracotomia (braquiterapia)'),
	(30803152, 'Segmentectomia (qualquer técnica)'),
	(30803160, 'Tromboendarterectomia pulmonar'),
	(30803179, 'Bulectomia unilateral por videotoracoscopia'),
	(30803187, 'Cirurgia redutora do volume pulmonar unilateral  por videotoracoscopia'),
	(30803195, 'Correção de fístula bronco-pleural por videotoracoscopia'),
	...
	(30803225, 'Metastasectomia pulmonar unilateral por videotoracoscopia'),
	(30803233, 'Segmentectomia por videotoracoscopia'),
	(30803241, 'Biópsia transcutânea de pulmão por agulha'),
	(30804019, 'Biópsia percutânea de pleura por agulha'),
	...
	(30804094, 'Repleção de cavidade pleural com solução de antibiótico para tratamento de empiema'),
	(30804108, 'Ressecção de tumor da pleura localizado'),
	(30804116, 'Retirada de dreno tubular torácico (colocado em outro serviço)'),
	(30804124, 'Tenda pleural'),
	(30804132, 'Toracostomia com drenagem pleural fechada'),
	(30804140, 'Tratamento operatório da hemorragia intrapleural'),
	(30804159, 'Descorticação pulmonar por videotoracoscopia'),
	(30804167, 'Pleurectomia por videotoracoscopia'),
	(30804175, 'Pleurodese por video'),
	(30804183, 'Pleuroscopia por vídeo'),
	(30804191, 'Ressecção de tumor da pleura localizado por vídeo'),
	(30804205, 'Tenda pleural por vídeo'),
	(30804213, 'Tratamento operatório da hemorragia intrapleural por  vídeo'),
	(30805015, 'Ressecção de bócio intratorácico'),
	(30805023, 'Biópsia de linfonodos pré-escalênicos ou do confluente venoso'),
	(30805031, 'Biópsia de tumor do mediastino (qualquer via)'),
	(30805040, 'Cisto ou duplicação brônquica ou esôfagica - tratamento cirúrgico'),
	(30805074, 'Ligadura de artérias brônquicas por toracotomia para controle de hemoptise'),
	(30805082, 'Ligadura de ducto-torácico (qualquer via)'),
	(30805090, 'Linfadenectomia mediastinal'),
	(30805104, 'Mediastinoscopia, via cervical'),
	(30805112, 'Mediastinotomia (via paraesternal, transesternal, cervical)'),
	(30805120, 'Mediastinotomia extrapleural por via posterior'),
	(30805139, 'Pericardiotomia com abertura pleuro-pericárdica (qualquer técnica)'),
	(30805147, 'Ressecção de tumor de mediastino'),
	(30805155, 'Timectomia (qualquer via)'),
	(30805163, 'Tratamento da mediastinite (qualquer via)'),
	(30805171, 'Vagotomia troncular terapêutica por toracotomia'),
	(30805180, 'Biópsia de tumor do mediastino por vídeo'),
	(30805198, 'Cisto ou duplicação brônquica ou esofágica – tratamento cirúrgico por vídeo'),
	(30805201, 'Ligadura de artérias brônquicas para controle de hemoptise por vídeo'),
	(30805210, 'Ligadura de ducto-torácico por vídeo'),
	(30805228, 'Linfadenectomia mediastinal por vídeo'),
	(30805236, 'Mediastinoscopia, via cervical por vídeo'),
	(30805244, 'Mediastinotomia extrapleural por via posterior por vídeo'),
	(30805252, 'Pericardiotomia com abertura pleuro-pericárdica por vídeo'),
	(30805260, 'Ressecção de tumor de mediastino por vídeo'),
	(30805279, 'Timectomia por vídeo'),
	(30805287, 'Tratamento da mediastinite por vídeo'),
	(30805295, 'Retirada de corpo estranho do mediastino'),
	(30806011, 'Abscesso subfrênico - tratamento cirúrgico'),
	(30806020, 'Eventração diafragmática - tratamento cirúrgico'),
	(30806038, 'Hérnia diafragmática - tratamento cirúrgico (qualquer técnica)'),
	(30806046, 'Implante de marca-passo diafragmático definitivo'),
	(30806054, 'Hérnia diafragmática – tratamento cirúrgico por vídeo'),
	...
	(30901090, 'Redirecionamento do fluxo sanguíneo (com anastomose direta, retalho, tubo) - em defeitos cardíacos congenitos'),
	(30901103, 'Ressecção (infundíbulo, septo, membranas, bandas) - em defeitos cardíacos congenitos'),
	...
	(30904064, 'Implante de estimulador cardíaco artificial multissítio'),
	...
	(30904137, 'Implante de marca-passo monocameral (gerador + eletrodo atrial ou ventricular)'),
	...
	(30904170, 'Implante de gerador de eventos (Looper implantável)'),
	...
	(30905044, 'Instalação do circuíto de circulação extracorpórea em crianças de baixo peso (10 kg)'),
	...
	(30906121, 'Artéria hipogástrica - unilateral - qualquer técnica'),
	(30906130, 'Artéria mesentérica inferior - qualquer técnica'),
	(30906148, 'Artéria mesentérica superior - qualquer técnica'),
	...
	(30906342, 'Pontes aorto-cervicais ou endarterectomias dos troncos supra-aórticos'),
	(30906350, 'Pontes transcervicais - qualquer tipo'),
	(30906377, 'Preparo de veia autóloga para remendos vasculares'),
	(30906385, 'Arterioplastia da femoral profunda (profundoplastia)'),
	(30906393, 'Reoperação de aorta abdominal'),
	(30906407, 'Retirada de enxerto infectado em posição não aórtica'),
	(30906415, 'Revascularização aorto-femoral - unilateral'),
	(30906423, 'Revascularização arterial de membro superior'),
	(30906431, 'Tratamento cirúrgico da isquemia cerebral'),
	(30906440, 'Tratamento cirúrgico de síndrome vértebro basilar'),
	(30906458, 'Tratamento cirúrgico de tumor carotídeo'),
	(30906466, 'Tronco celíaco - qualquer técnica'),
	(30907012, 'Cirurgia de restauração venosa com pontes em cavidades'),
	(30907020, 'Cirurgia de restauração venosa com pontes nos membros'),
	(30907039, 'Cura cirúrgica da impotência coeundi venosa'),
	(30907047, 'Cura cirúrgica de hipertensão portal - qualquer tipo'),
	(30907063, 'Escleroterapia de veias - por sessão'),
	(30907071, 'Fulguração de telangiectasias (por grupo)'),
	(30907080, 'Implante de filtro de veia cava'),
	(30907098, 'Interrupção cirúrgica veia cava inferior'),
	(30907101, 'Tratamento cirúrgico de varizes com lipodermatoesclerose ou úlcera (um membro)'),
	(30907110, 'Trombectomia venosa'),
	(30907128, 'Valvuloplastia ou interposição de segmento valvulado venoso'),
	(30907136, 'Varizes - tratamento cirúrgico de dois membros'),
	(30907144, 'Varizes - tratamento cirúrgico de um membro'),
	(30907152, 'Varizes - ressecção de colaterais com anestesia local em consultório / ambulatório'),
	(30908019, 'Fístula aorto-cava, reno-cava ou ílio-ilíaca'),
	(30908027, 'Fístula arteriovenosa - com enxerto'),
	(30908035, 'Fístula arteriovenosa cervical ou cefálica extracraniana'),
	(30908043, 'Fístula arteriovenosa congênita - reintervenção'),
	(30908051, 'Fístula arteriovenosa congênita - correção cirúrgica radical'),
	(30908060, 'Fístula arteriovenosa congênita para redução de fluxo'),
	(30908078, 'Fístula arteriovenosa direta'),
	(30908086, 'Fístula arteriovenosa dos grandes vasos intratorácicos'),
	(30908094, 'Fístula arteriovenosa dos membros'),
	(30908108, 'Tromboembolectomia de fístula arteriovenosa'),
	...
	(30909147, 'Hemodepuração de casos agudos (sessão hemodiálise, hemofiltração, hemodiafiltração isolada, plasmaferese ou hemoperfusão) - até 12 horas'),
	(30910013, 'Aneurisma roto ou trombosado de aorta abdominal abaixo da artéria renal'),
	(30910021, 'Aneurismas rotos ou trombosados - outros'),
	(30910030, 'Aneurismas rotos ou trombosados de aorta abdominal acima da artéria renal'),
	(30910048, 'Aneurismas rotos ou trombosados de artérias viscerais'),
	(30910056, 'Aneurismas rotos ou trombosados de axilar, femoral, poplítea'),
	(30910064, 'Aneurismas rotos ou trombosados de carótida, subclávia, ilíaca'),
	(30910072, 'Aneurismas rotos ou trombosados torácicos ou tóraco-abdominais'),
	(30910080, 'Embolectomia ou tromboembolectomia arterial'),
	(30910099, 'Exploração vascular em traumas de outros segmentos'),
	(30910102, 'Exploração vascular em traumas torácicos e abdominais'),
	(30910110, 'Lesões vasculares cervicais e cérvico-torácicas'),
	(30910129, 'Lesões vasculares de membro inferior ou superior - unilateral'),
	(30910137, 'Lesões vasculares intra-abdominais'),
	(30910145, 'Lesões vasculares traumáticas intratorácicas'),
	(30911010, 'Avaliação da viabilidade miocárdica por cateter'),
	(30911028, 'Avaliação fisiológica da gravidade de obstruções (cateter ou guia)'),
	(30911036, 'Biópsia endomiocárdica'),
	(30911044, 'Cateterismo cardíaco D e/ou E com  ou  sem  cinecoronariografia / cineangiografia  com  avaliação  de reatividade vascular pulmonar ou teste de sobrecarga hemodinânica'),
	...
	(30911079, 'Cateterismo cardíaco E e/ou D com cineangiocoronariografia e ventriculografia'),
	(30911087, 'Cateterismo cardíaco E e/ou D com cineangiocoronariografia, ventriculografia e estudo angiográfico  da aorta e/ou ramos tóraco-abdominais e/ou membros'),
	...
	(30911117, 'Estudo eletrofisiológico - mapeamento eletro-eletrônico tridimensional - do sistema de condução com ou sem ação farmacológica'),
	(30911125, 'Estudo hemodinâmico das cardiopatias congênitas  estruturalmente  complexas (menos: CIA, CIV, PCA, Co, AO, estenose aórtica e pulmonar isoladas)'),
	(30911133, 'Estudo hemodinâmico de cardiopatias congênitas e/ou valvopatias  com  ou  sem  cinecoronariografia  ou oximetria'),
	(30911141, 'Estudo ultrassonográfico intravascular'),
	(30911150, 'Mapeamento de feixes anômalos e focos ectópicos por eletrofisiologia intracavitária, com provas'),
	(30911168, 'Teste de avaliação do limiar de fibrilação ventricular'),
	(30911176, 'Mapeamento Eletrofisiológico Cardíaco Convencional'),
	(30912016, 'Ablação de circuito arritmogênico por cateter de radiofrequência'),
	...
	(30912091, 'Implante de prótese intravascular na aorta/pulmonar ou ramos com ou sem angioplastia'),
	(30912105, 'Implante de stent coronário com ou sem angioplastia por balão concomitante (1 vaso)'),
	...
	(30912164, 'Punção transeptal com introdução de cateter multipolar nas camaras esquerdas e/ou veias pulmonares'),
	(30912172, 'Radiação ou antiproliferação intracoronária'),
	...
	(30912202, 'Redução miocárdica por infusão seletiva de drogas'),
	(30912210, 'Retirada percutânea de corpos estranhos vasculares'),
	(30912229, 'Revascularização transmiocárdica percutânea'),
	...
	(30912270, 'Ateromectomia rotacional, direcional, extracional ou uso de laser coronariano com ou sem angioplastia por balão, com ou sem implante de stent'),
	(30912288, 'Procedimento terapêutico nas cardiopatias congênitas, exceto atriosseptostomia'),
	(30913012, 'Implante de cateter venoso central por punção, para NPP, QT, Hemodepuração ou para infusão de soros/drogas'),
	(30913020, 'Instalação de cateter para monitorização hemodinâmica à beira do leito (Swan-Ganz)'),
	(30913047, 'Instalação de circuito para assistência mecânica circulatória prolongada (toracotomia)'),
	(30913055, 'Manutenção de circuito para assistência mecânica circulatória prolongada - período de 6 horas'),
	...
	(30913101, 'Implante cirúrgico de cateter de longa permanência para NPP, QT ou para Hemodepuração'),
	(30913128, 'Retirada cirúrgica de cateter de longa permanência para NPP, QT ou para Hemodepuração'),
	...
	(30917034, 'Cardiotomia (ferimento, corpo estranho, exploração)'),
	...
	(30918030, 'Mapeamento eletroanatômico tridimensional'),
	(30918081, 'Ablação percutânea por cateter para tratamento de arritmias cardíacas complexas (Fibrilação atrial, Taquicardia Ventricular com modificação de cicatriz, Taquicardias Atriais Macrorreentrantes com modificaçõa de cicatriz) por energia de radiofrequência'),
	(31001017, 'Atresia de esôfago com fístula traqueal - tratamento cirúrgico'),
	(31001025, 'Atresia de esôfago sem fístula (dupla estomia) - tratamento cirúrgico'),
	...
	(31001084, 'Estenose de esôfago - tratamento cirúrgico via torácica'),
	(31001092, 'Faringo-laringo-esofagectomia total com ou sem toracotomia'),
	(31001106, 'Fístula tráqueo esofágica - tratamento cirúrgico via cervical'),
	(31001114, 'Fístula tráqueo esofágica - tratamento cirúrgico via torácica'),
	(31001149, 'Reintervenção sobre a transição esôfago gástrica'),
	(31001157, 'Ressecção do esôfago cervical e/ou torácico e transplante com microcirurgia'),
	(31001165, 'Substituição esofágica - cólon ou tubo gástrico'),
	(31001173, 'Tratamento cirúrgico das varizes esofágicas'),
	(31001181, 'Tratamento cirúrgico conservador do megaesofago'),
	(31001190, 'Tunelização esofágica'),
	(31001203, 'Esofagorrafia cervical'),
	(31001211, 'Esofagorrafia torácica'),
	(31001220, 'Esofagostomia'),
	(31001238, 'Tratamento cirúrgico do divertículo esofágico'),
	(31001246, 'Tratamento cirúrgico do divertículo faringoesofágico'),
	(31001254, 'Esofagectomia subtotal com linfadenectomia com ou sem toracotomia'),
	(31001262, 'Refluxo gastroesofágico - tratamento cirúrgico (Hérnia de hiato)'),
	(31001270, 'Reconstrução do esôfago cervical e torácico com transplante segmentar de intestino'),
	(31001289, 'Reconstrução do esôfago cervical ou torácico, com transplante de intestino'),
	(31001297, 'Dissecção do esôfago torácico (qualquer técnica)'),
	(31001300, 'Esofagectomia distal com ou sem toracotomia por videolaparoscopia'),
	(31001319, 'Reintervenção sobre a transição esôfago gástrica por videolaparoscopia'),
	(31001327, 'Tratamento cirúrgico das varizes esofágicas por videolaparoscopia'),
	(31001335, 'Tratamento cirúrgico conservador do megaesofago por videolaparoscopia'),
	(31001343, 'Esofagorrafia torácica por videotoracoscopia'),
	(31001351, 'Tratamento cirúrgico do divertículo esofágico por videotoracoscopia'),
	...
	(31002021, 'Conversão de anastomose gastrojejunal (qualquer técnica)'),
	...
	(31002064, 'Gastrectomia parcial com linfadenectomia'),
	(31002072, 'Gastrectomia parcial com vagotomia'),
	(31002080, 'Gastrectomia parcial sem vagotomia'),
	(31002099, 'Gastrectomia polar superior com reconstrução jejunal com toracotomia'),
	(31002102, 'Gastrectomia polar superior com reconstrução jejunal sem toracotomia'),
	(31002110, 'Gastrectomia total com linfadenectomia'),
	...
	(31002161, 'Gastrotomia para retirada de CE ou lesão isolada'),
	(31002170, 'Gastrotomia para qualquer finalidade'),
	(31002188, 'Membrana antral - tratamento cirúrgico'),
	(31002196, 'Piloroplastia'),
	(31002218, 'Gastroplastia para obesidade mórbida - qualquer técnica'),
	(31002242, 'Tratamento cirúrgico das varizes gástricas'),
	(31002250, 'Vagotomia com operação de drenagem'),
	(31002269, 'Vagotomia gástrica proximal ou superseletiva com duodenoplastia (operação de drenagem)'),
	(31002277, 'Vagotomia superseletiva ou vagotomia gástrica proximal'),
	(31002285, 'Colocação de banda gástrica por videolaparoscopia'),
	(31002293, 'Conversão de anastomose gastrojejunal por videolaparoscopia'),
	(31002307, 'Gastrectomia parcial com linfadenectomia por videolaparoscopia'),
	(31002315, 'Gastrectomia parcial com vagotomia por videolaparoscopia'),
	(31002323, 'Gastrectomia parcial sem vagotomia por videolaparoscopia'),
	(31002331, 'Gastrectomia total com linfadenectomia por videolaparoscopia'),
	(31002340, 'Gastrectomia total via abdominal por videolaparoscopia'),
	(31002358, 'Gastroenteroanastomose por videolaparoscopia'),
	(31002366, 'Gastrotomia para retirada de CE ou lesão isolada por videolaparoscopia'),
	(31002374, 'Piloroplastia por videolaparoscopia'),
	(31002390, 'Gastroplastia para obesidade mórbida por videolaparoscopia'),
	(31002404, 'Vagotomia gástrica proximal ou superseletiva com duodenoplastia (operação de drenagem) por videolaparoscopia'),
	(31002412, 'Vagotomia superseletiva ou vagotomia gástrica proximal por videolaparoscopia'),
	(31003010, 'Amputação abdômino-perineal do reto (completa)'),
	(31003028, 'Amputação do reto por procidência'),
	(31003036, 'Anomalia anorretal - correção via sagital posterior'),
	(31003044, 'Anomalia anorretal - tratamento cirúrgico via abdômino-perineal'),
	(31003052, 'Anomalia anorretal - tratamento cirúrgico via perineal'),
	(31003060, 'Anorretomiomectomia'),
	(31003079, 'Apendicectomia'),
	(31003087, 'Apple-Peel - tratamento cirúrgico'),
	(31003095, 'Atresia de cólon - tratamento cirúrgico'),
	(31003109, 'Atresia de duodeno - tratamento cirúrgico'),
	(31003117, 'Atresia jejunal distal ou ileal - tratamento cirúrgico'),
	(31003125, 'Atresia jejunal proximal - tratamento cirúrgico'),
	(31003133, 'Cirurgia de abaixamento (qualquer técnica)'),
	(31003141, 'Cirurgia de acesso posterior'),
	(31003150, 'Cisto mesentérico - tratamento cirúrgico'),
	(31003168, 'Colectomia parcial com colostomia'),
	(31003176, 'Colectomia parcial sem colostomia'),
	(31003184, 'Colectomia total com íleo-reto-anastomose'),
	...
	(31003273, 'Duplicação do tubo digestivo - tratamento cirúrgico'),
	(31003281, 'Enterectomia segmentar'),
	(31003290, 'Entero-anastomose  (qualquer segmento)'),
	(31003303, 'Enterocolite necrotizante - tratamento cirúrgico'),
	(31003311, 'Enteropexia (qualquer segmento)'),
	(31003320, 'Enterotomia e/ou enterorrafia de qualquer segmento (por sutura ou ressecção)'),
	(31003338, 'Esporão retal - ressecção'),
	(31003346, 'Esvaziamento pélvico anterior ou posterior - procedimento cirúrgico'),
	(31003354, 'Esvaziamento pélvico total - procedimento cirurgico'),
	(31003362, 'Fecaloma - remoção manual'),
	(31003370, 'Fechamento de colostomia ou enterostomia'),
	...
	(31003435, 'Invaginação intestinal sem ressecção - tratamento cirúrgico'),
	(31003451, 'Má-rotação intestinal - tratamento cirúrgico'),
	(31003460, 'Megacólon congênito - tratamento cirúrgico'),
	(31003478, 'Membrana duodenal - tratamento cirúrgico'),
	(31003486, 'Pâncreas anular - tratamento cirúrgico'),
	(31003494, 'Perfuração duodenal ou delgado - tratamento cirúrgico'),
	(31003508, 'Piloromiotomia'),
	(31003516, 'Procidência do reto - redução manual'),
	(31003524, 'Proctocolectomia total'),
	(31003532, 'Proctocolectomia total com reservatório ileal'),
	(31003540, 'Ressecção total de intestino delgado'),
	(31003559, 'Retossigmoidectomia abdominal'),
	(31003567, 'Tumor anorretal - ressecção anorretal, tratamento cirúrgico'),
	(31003575, 'Amputação abdômino-perineal do reto (completa) por videolaparoscopia'),
	(31003583, 'Apendicectomia por videolaparoscopia'),
	(31003591, 'Cirurgia de abaixamento por videolaparoscopia'),
	(31003605, 'Cisto mesentérico - tratamento cirúrgico por videolaparoscopia'),
	(31003613, 'Colectomia parcial com colostomia por videolaparoscopia'),
	(31003621, 'Colectomia parcial sem colostomia por videolaparoscopia'),
	(31003630, 'Colectomia total com íleo-reto-anastomose por videolaparoscopia'),
	(31003648, 'Colectomia total com ileostomia por videolaparoscopia'),
	(31003656, 'Distorção de volvo por videolaparoscopia'),
	(31003664, 'Divertículo de Meckel - exérese por videolaparoscopia'),
	(31003672, 'Enterectomia segmentar por videolaparoscopia'),
	(31003680, 'Entero-anastomose (qualque segmento) por videolaparoscopia'),
	(31003699, 'Enteropexia (qualquer segmento) por videolaparoscopia'),
	(31003702, 'Esvaziamento pélvico anterior ou posterior por videolaparoscopia'),
	(31003710, 'Esvaziamento pélvico total por videolaparoscopia'),
	(31003729, 'Fixação do reto por via abdominal por videolaparoscopia'),
	(31003737, 'Megacólon congênito - tratamento cirúrgico por videolaparoscopia'),
	(31003745, 'Pâncreas anular - tratamento cirúrgico por videolaparoscopia'),
	(31003753, 'Perfuração duodenal ou delgado - tratamento cirúrgico por videolaparoscopia'),
	(31003761, 'Piloromiotomia por videolaparoscopia'),
	(31003770, 'Proctocolectomia total com reservatório ileal por videolaparoscopia'),
	(31003788, 'Proctocolectomia total por videolaparoscopia'),
	...
	(31004067, 'Dilatação digital ou instrumental do ânus e/ou do reto'),
	(31004075, 'Esfincteroplastia anal (qualquer técnica)'),
	(31004083, 'Estenose anal - tratamento cirúrgico (qualquer técnica)'),
	(31004091, 'Excisão de plicoma'),
	(31004105, 'Fissurectomia com ou sem esfincterotomia'),
	(31004113, 'Fístula reto-vaginal e fístula anal em ferradura - tratamento cirúrgico via perineal'),
	...
	(31004156, 'Fistulectomia anorretal com abaixamento mucoso'),
	(31004164, 'Fistulectomia perineal'),
	(31004172, 'Hemorróidas - fotocoagulação com raio infravermelho (por sessão)'),
	(31004180, 'Hemorróidas - ligadura elástica (por sessão)'),
	(31004199, 'Hemorróidas - tratamento esclerosante (por sessão)'),
	(31004202, 'Hemorroidectomia aberta ou fechada, com ou sem esfincterotomia'),
	(31004210, 'Laceração anorretal - tratamento cirúrgico por via perineal'),
	...
	(31004261, 'Prolapso retal - tratamento cirúrgico'),
	(31004270, 'Reconstituição de esfincter anal por plástica muscular (qualquer técnica)'),
	...
	(31004342, 'Anopexia mecânica com grampeador'),
	(31005012, 'Abscesso hepático - drenagem cirúrgica (até 3 fragmentos)'),
	(31005020, 'Alcoolização percutânea dirigida de tumor hepático'),
	(31005039, 'Anastomose biliodigestiva intra-hepática'),
	(31005047, 'Atresia de vias biliares - tratamento cirúrgico'),
	(31005063, 'Biópsia hepática por laparotomia (até 3 fragmentos)'),
	(31005071, 'Biópsia hepática transparietal (até 3 fragmentos)'),
	(31005080, 'Laparotomia para implantação cirúrgica de cateter arterial visceral para quimioterapia'),
	(31005098, 'Cisto de colédoco - tratamento cirúrgico'),
	(31005101, 'Colecistectomia com colangiografia'),
	(31005110, 'Colecistectomia com fístula biliodigestiva'),
	(31005128, 'Colecistectomia sem colangiografia'),
	(31005136, 'Colecistojejunostomia'),
	(31005144, 'Colecistostomia'),
	(31005152, 'Colédoco ou hepático-jejunostomia (qualquer técnica)'),
	(31005160, 'Colédoco ou hepaticoplastia'),
	(31005179, 'Colédoco-duodenostomia'),
	(31005187, 'Coledocotomia ou coledocostomia sem colecistectomia'),
	(31005195, 'Coledocoscopia intra-operatória'),
	(31005209, 'Derivação porto sistêmica'),
	(31005217, 'Desconexão ázigos - portal com esplenectomia'),
	(31005225, 'Desconexão ázigos - portal sem esplenectomia'),
	(31005233, 'Desvascularização hepática'),
	(31005241, 'Drenagem biliar trans-hepática'),
	(31005250, 'Enucleação de metástases hepáticas'),
	(31005268, 'Enucleação de metástases, por metástase'),
	(31005276, 'Hepatorrafia'),
	(31005284, 'Hepatorrafia complexa com lesão de estruturas vasculares biliares'),
	...
	(31005330, 'Radioablação / termoablação de tumores hepáticos'),
	(31005357, 'Ressecção de cisto hepático com hepatectomia'),
	(31005365, 'Ressecção de cisto hepático sem hepatectomia'),
	(31005373, 'Ressecção de tumor de vesícula ou da via biliar com hepatectomia'),
	(31005381, 'Ressecção de tumor de vesícula ou da via biliar sem hepatectomia'),
	(31005390, 'Segmentectomia hepática'),
	(31005403, 'Sequestrectomia hepática'),
	(31005420, 'Tratamento cirúrgico de estenose cicatricial das vias biliares'),
	(31005438, 'Trissegmentectomias'),
	(31005446, 'Coledocotomia ou coledocostomia com colecistectomia'),
	(31005454, 'Abscesso hepático - drenagem cirúrgica por videolaparoscopia'),
	(31005462, 'Alcoolização percutânea dirigida de tumor hepático por videolaparoscopia'),
	...
	(31005497, 'Colecistectomia sem colangiografia por videolaparoscopia'),
	(31005500, 'Colecistojejunostomia por videolaparoscopia'),
	(31005519, 'Colecistostomia por videolaparoscopia'),
	(31005527, 'Colédoco ou hepático-jejunostomia por videolaparoscopia'),
	(31005535, 'Colédoco-duodenostomia por videolaparoscopia'),
	...
	(31005578, 'Desconexão ázigos - portal sem esplenectomia por videolaparoscopia'),
	(31005586, 'Enucleação de metástase hepáticas por videolaparoscopia'),
	(31005594, 'Hepatorrafia complexa com lesão de estruturas vasculares biliares por videolaparoscopia'),
	(31005608, 'Hepatorrafia por videolaparoscopia'),
	(31005616, 'Lobectomia hepática direita por videolaparoscopia'),
	(31005624, 'Lobectomia hepática esquerda por videolaparoscopia'),
	(31005632, 'Punção hepática para drenagem de abcessos por videolaparoscopia'),
	(31005640, 'Radioablação / termoablação de tumores hepáticos por videolaparoscopia'),
	...
	(31005675, 'Biópsia hepática por videolaparoscopia'),
	(31005683, 'Biópsia hepática por laparotomia (acima de 3 fragmentos)'),
	(31005691, 'Biópsia hepática transparietal (acima de 3 fragmentos)'),
	(31006019, 'Biópsia de pâncreas por laparotomia'),
	(31006027, 'Biópsia de pâncreas por punção dirigida'),
	(31006035, 'Enucleação de tumores pancreáticos'),
	(31006043, 'Hipoglicemia - tratamento cirúrgico (pancreatotomia parcial ou total)'),
	(31006051, 'Pancreatectomia corpo caudal com preservação do baço'),
	(31006060, 'Pancreatectomia parcial ou sequestrectomia'),
	(31006078, 'Pancreato-duodenectomia com linfadenectomia'),
	(31006086, 'Pancreato-enterostomia'),
	(31006094, 'Pancreatorrafia'),
	(31006108, 'Pseudocisto pâncreas - drenagem externa (qualquer técnica)'),
	(31006116, 'Pseudocisto pâncreas - drenagem interna (qualquer técnica)'),
	(31006124, 'Cisto pancreático - cistojejunoanastomose - tratamento cirúrgico'),
	(31006132, 'Cisto pancreático - gastroanastomose - tratamento cirúrgico'),
	(31006159, 'Biópsia de pâncreas por videolaparoscopia'),
	(31006167, 'Enucleação de tumores pancreáticos por videolaparoscopia'),
	...
	(31007058, 'Esplenectomia parcial por videolaparoscopia'),
	(31007066, 'Esplenectomia total por videolaparoscopia'),
	(31007074, 'Esplenorrafia por videolaparoscopia'),
	(31008011, 'Diálise peritoneal intermitente - agudo ou crônico (por sessão)'),
	(31008020, 'Diálise peritoneal ambulatorial contínua (CAPD) 9 dias - treinamento'),
	(31008038, 'Diálise peritoneal ambulatorial contínua (CAPD) por mês/paciente'),
	(31008046, 'Diálise peritoneal automática (APD) - tratamento (agudo ou crônico)'),
	...
	(31008100, 'Epiploplastia por videolaparoscopia'),
	(31008119, 'Diálise peritoneal automática por mês (agudo ou crônico)'),
	(31009018, 'Abscesso perineal - drenagem cirúrgica'),
	(31009026, 'Biópsia de parede abdominal'),
	(31009042, 'Cisto sacro-coccígeo - tratamento cirúrgico'),
	(31009050, 'Diástase dos retos-abdominais - tratamento cirúrgico'),
	(31009069, 'Hérnia inguinal encarcerada em RN ou lactente - tratamento cirúrgico'),
	(31009077, 'Herniorrafia com ressecção intestinal - estrangulada'),
	...
	(31009123, 'Herniorrafia inguinal no RN ou lactente'),
	(31009131, 'Herniorrafia lombar'),
	(31009140, 'Herniorrafia recidivante'),
	(31009158, 'Herniorrafia sem ressecção intestinal encarcerada'),
	...
	(31009220, 'Onfalocele/gastrosquise em 1 tempo ou primeiro tempo ou prótese - tratamento cirúrgico'),
	(31009239, 'Onfalocele/gastrosquise - segundo tempo - tratamento cirúrgico'),
	(31009247, 'Paracentese abdominal'),
	(31009255, 'Reconstrução da parede abdominal com retalho muscular ou miocutâneo'),
	(31009263, 'Reparação de outras hérnias (inclui herniorrafia muscular)'),
	(31009271, 'Ressecção de cisto ou fístula de úraco'),
	(31009280, 'Ressecção de cisto ou fístula ou restos do ducto onfalomesentérico'),
	(31009298, 'Ressutura da parede abdominal (por deiscência total ou evisceração)'),
	...
	(31009328, 'Herniorrafia crural - unilateral por videolaparoscopia'),
	(31009336, 'Herniorrafia inguinal - unilateral por videolaparoscopia'),
	(31009344, 'Herniorrafia recidivante por videolaparoscopia'),
	...
	(31009360, 'Herniorrafia inguinal em criança - unilateral'),
	(31101011, 'Abscesso renal ou peri-renal - drenagem cirúrgica'),
	(31101020, 'Abscesso renal ou peri-renal - drenagem percutânea'),
	(31101038, 'Adrenalectomia unilateral'),
	(31101046, 'Angioplastia renal unilateral a céu aberto'),
	(31101054, 'Angioplastia renal unilateral transluminal'),
	...
	(31101100, 'Estenose de junção pieloureteral - tratamento cirúrgico'),
	(31101119, 'Fístula pielo-cutânea - tratamento cirúrgico'),
	(31101127, 'Lombotomia exploradora'),
	(31101135, 'Marsupialização de cistos renais unilateral'),
	(31101151, 'Nefrectomia parcial com ureterectomia'),
	(31101160, 'Nefrectomia parcial unilateral'),
	(31101178, 'Nefrectomia parcial unilateral extracorpórea'),
	(31101186, 'Nefrectomia radical unilateral'),
	(31101194, 'Nefrectomia total unilateral'),
	(31101208, 'Nefro ou pieloenterocistostomia unilateral'),
	...
	(31101240, 'Nefrolitotripsia extracorpórea - 1ª sessão'),
	(31101259, 'Nefrolitotripsia extracorpórea - reaplicações (até 3 meses)'),
	(31101275, 'Nefrolitotripsia percutânea unilateral (MEC., E.H., ou US)'),
	...
	(31101321, 'Nefroureterectomia com ressecção vesical unilateral'),
	(31101330, 'Pielolitotomia com nefrolitotomia anatrófica unilateral'),
	(31101348, 'Pielolitotomia com nefrolitotomia simples unilateral'),
	...
	(31101399, 'Punção aspirativa renal para diagnóstico de rejeição (ato médico)'),
	(31101402, 'Punção biópsia renal percutânea'),
	(31101410, 'Revascularização renal - qualquer técnica'),
	(31101429, 'Sinfisiotomia (rim em ferradura)'),
	(31101437, 'Transuretero anastomose'),
	(31101445, 'Tratamento cirúrgico da fístula pielo-intestinal'),
	...
	(31101496, 'Marsupialização laparoscópica de cisto renal unilateral'),
	...
	(31101550, 'Nefrectomia radical laparoscópica unilateral'),
	(31101569, 'Nefrectomia parcial laparoscópica unilateral'),
	(31101577, 'Nefrolitotripsia percutânea unilateral a laser'),
	(31101585, 'Nefrectomia total unilateral por videolaparoscopia'),
	(31101593, 'Cisto de supra-renal - tratamento cirúrgico'),
	(31102018, 'Biópsia cirúrgica de ureter unilateral'),
	(31102026, 'Biópsia endoscópica de ureter unilateral'),
	(31102034, 'Cateterismo ureteral unilateral'),
	(31102042, 'Colocação cirúrgica de duplo J unilateral'),
	(31102050, 'Colocação cistoscópica de duplo J unilateral'),
	(31102069, 'Colocação nefroscópica de duplo J unilateral'),
	(31102077, 'Colocação ureteroscópica de duplo J unilateral'),
	(31102085, 'Dilatação endoscópica unilateral'),
	(31102093, 'Duplicação pieloureteral - tratamento cirúrgico'),
	(31102107, 'Fístula uretero-cutânea unilateral (tratamento cirúrgico)'),
	(31102115, 'Fístula uretero-intestinal unilateral (tratamento cirúrgico)'),
	(31102123, 'Fístula uretero-vaginal unilateral (tratamento cirúrgico)'),
	(31102131, 'Meatotomia endoscópica unilateral'),
	(31102174, 'Reimplante ureterointestinal uni ou bilateral'),
	(31102182, 'Reimplante ureteral por via extra ou intravesical unilateral'),
	(31102204, 'Reimplante uretero-vesical unilateral - via combinada'),
	(31102220, 'Retirada endoscópica de cálculo de ureter unilateral'),
	(31102239, 'Transureterostomia'),
	(31102247, 'Ureterectomia unilateral'),
	(31102255, 'Ureterocele unilateral - ressecção a céu aberto'),
	(31102263, 'Ureteroceles - tratamento endoscópico'),
	...
	(31102310, 'Ureterolitotripsia extracorpórea - 1ª sessão'),
	(31102328, 'Ureterolitotripsia extracorpórea - reaplicações (até 3 meses)'),
	...
	(31102433, 'Ureterotomia interna percutânea unilateral'),
	(31102441, 'Ureterotomia interna ureteroscópica flexível unilateral'),
	(31102450, 'Ureterotomia interna ureteroscópica rígida unilateral'),
	(31102468, 'Ureteroureterocistoneostomia'),
	(31102476, 'Ureteroureterostomia unilateral'),
	(31102492, 'Ureterolitotomia laparoscópica unilateral'),
	(31102506, 'Ureterólise laparoscópica unilateral'),
	(31102514, 'Ureteroureterostomia laparoscópica unilateral'),
	(31102522, 'Ureteroplastia laparoscópica unilateral'),
	(31102530, 'Correção laparoscópica de refluxo vesico-ureteral unilateral'),
	(31102549, 'Reimplante uretero-vesical laparoscópico unilateral'),
	(31102557, 'Reimplante ureterointestinal laparoscópico unilateral'),
	...
	(31103030, 'Biópsia endoscópica de bexiga (inclui cistoscopia)'),
	...
	(31103103, 'Cistolitotripsia extracorpórea - 1ª sessão'),
	(31103111, 'Cistolitotripsia extracorpórea - reaplicações (até 3 meses)'),
	(31103138, 'Cistolitotripsia percutânea (U.S., E.H., E.C.)'),
	(31103146, 'Cistolitotripsia transuretral (U.S., E.H., E.C.)'),
	(31103154, 'Cistoplastia redutora'),
	(31103162, 'Cistorrafia (trauma)'),
	(31103170, 'Cistostomia cirúrgica'),
	(31103189, 'Cistostomia com procedimento endoscópico'),
	(31103197, 'Cistostomia por punção com trocater'),
	(31103200, 'Colo de divertículo - ressecção endoscópica'),
	(31103219, 'Colo vesical - ressecção endoscópica'),
	(31103227, 'Corpo estranho - extração cirúrgica'),
	(31103235, 'Corpo estranho - extração endoscópica'),
	(31103243, 'Diverticulectomia vesical'),
	(31103251, 'Enterocistoplastia (ampliação vesical)'),
	(31103260, 'Extrofia em cloaca - tratamento cirúrgico'),
	(31103278, 'Extrofia vesical - tratamento cirúrgico'),
	(31103286, 'Fístula vésico-cutânea - tratamento cirúrgico'),
	(31103294, 'Fístula vésico-entérica - tratamento cirúrgico'),
	(31103308, 'Fístula vésico-retal - tratamento cirúrgico'),
	(31103316, 'Fístula vésico-uterina - tratamento cirúrgico'),
	(31103324, 'Fístula vésico-vaginal - tratamento cirúrgico'),
	(31103332, 'Incontinência urinária - "sling" vaginal ou abdominal'),
	(31103340, 'Incontinência urinária - suspensão endoscópica de colo'),
	...
	(31103391, 'Pólipos vesicais - ressecção endoscópica'),
	(31103405, 'Punção e aspiração vesical'),
	(31103413, 'Reimplante uretero-vesical à Boari'),
	(31103430, 'Retenção por coágulo - aspiração vesical'),
	...
	(31103510, 'Correção laparoscópica de incontinência urinária'),
	(31103529, 'Cistectomia parcial laparoscópica'),
	(31103537, 'Cistectomia radical laparoscópica (inclui próstata ou útero)'),
	(31103545, 'Neobexiga laparoscópica'),
	(31103553, 'Diverticulectomia vesical laparoscópica'),
	...
	(31104010, 'Abscesso periuretral - tratamento cirúrgico'),
	(31104029, 'Biópsia endoscópica de uretra'),
	(31104037, 'Corpo estranho ou cálculo - extração cirúrgica'),
	(31104045, 'Corpo estranho ou cálculo - extração endoscópica'),
	(31104053, 'Divertículo uretral - tratamento cirúrgico'),
	(31104061, 'Eletrocoagulação endoscópica'),
	(31104070, 'Esfincterotomia - uretra'),
	(31104088, 'Fístula uretro-cutânea - correção cirúrgica'),
	(31104096, 'Fístula uretro-retal - correção cirúrgica'),
	(31104100, 'Fístula uretro-vaginal - correção cirúrgica'),
	(31104118, 'Incontinência urinária masculina - tratamento cirúrgico (exclui implante de esfincter artificial)'),
	...
	(31104231, 'Uretrotomia interna com prótese endouretral'),
	...
	(31104282, 'Incontinência urinária masculina - esfincter artificial'),
	(31104290, 'Retirada e/ou substituição de implante no tratamento da incontinência urinária masculina - esfincter artificial'),
	(31201016, 'Ablação prostática a laser'),
	(31201024, 'Abscesso de próstata - drenagem'),
	(31201032, 'Biópsia prostática - até 8 fragmentos'),
	(31201040, 'Biópsia prostática - mais de 8 fragmentos'),
	(31201059, 'Eletrovaporização de próstata'),
	(31201067, 'Hemorragia da loja prostática - evacuação e irrigação'),
	(31201075, 'Hemorragia da loja prostática - revisão endoscópica'),
	(31201083, 'Hipertrofia prostática - hipertermia ou termoterapia'),
	(31201091, 'Hipertrofia prostática - implante de prótese'),
	(31201105, 'Hipertrofia prostática - tratamento por dilatação'),
	...
	(31201156, 'Exérese laparoscópica de cisto de vesícula seminal unilateral'),
	(31201164, 'Hipertrofia prostática - tratamento por diatemia'),
	(31202012, 'Biópsia escrotal'),
	(31202020, 'Drenagem de abscesso - escroto'),
	(31202039, 'Elefantíase peno-escrotal - tratamento cirúrgico'),
	(31202047, 'Exérese de cisto escrotal'),
	(31202055, 'Plástica escrotal'),
	(31202063, 'Reconstrução da bolsa escrotal com retalho inguinal pediculado - por estágio'),
	...
	(31203051, 'Implante de prótese testicular unilateral'),
	...
	(31203140, 'Orquiectomia intra-abdominal laparoscópica unilateral'),
	(31203159, 'Correção laparoscópica de varicocele unilateral'),
	...
	(31206093, 'Fratura de pênis - tratamento cirúrgico'),
	(31206107, 'Hipospadia - por estágio - tratamento cirúrgico'),
	(31206115, 'Hipospadia distal - tratamento em 1 tempo - tratamento cirúrgico'),
	(31206123, 'Hipospadia proximal - tratamento em 1 tempo - tratamento cirúrgico'),
	...
	(31206166, 'Neofaloplastia com retalho inguinal pediculado com reconstrução uretral - por estágio'),
	(31206174, 'Parafimose - redução manual ou cirúrgica'),
	(31206182, 'Pênis curvo congênito - tratamento cirúrgico'),
	...
	(31206247, 'Reconstrução de pênis com enxerto - plástica total'),
	...
	(31301061, 'Excisão radical local da vulva (não inclui a linfadenectomia)'),
	...
	(31301126, 'Vulvectomia ampliada (não inclui a linfadenectomia)'),
	...
	(31302068, 'Colporrafia ou colpoperineoplastia incluindo ressecção de septo ou ressutura de parede vaginal'),
	...
	(31303056, 'Curetagem ginecológica semiótica e/ou terapêutica com ou sem dilatação de colo uterino'),
	...
	(31303153, 'Traquelectomia - amputação, conização - (com ou sem cirurgia de alta frequência / CAF)'),
	(31303161, 'Traquelectomia radical (não inclui a linfadenectomia)'),
	(31303170, 'Histeroscopia cirúrgica com biópsia e/ou curetagem uterina, lise de sinéquias, retirada de corpo estranho'),
	(31303188, 'Histeroscopia com ressectoscópio para miomectomia, polipectomia, metroplastia, endometrectomia e ressecção de sinéquias'),
	...
	(31303242, 'Metroplastia laparoscópica'),
	...
	(31304036, 'Recanalização tubária (qualquer técnica), uni ou bilateral (com microscópio ou lupa)'),
	...
	(31304095, 'Implante de dispositivo intratubário não hormonal'),
	...
	(31306080, 'Retração cicraticial perineal'),
	...
	(31307175, 'Culdoplastia laparoscópica (Mac Call, Moschowicz, etc)'),
	(31307183, 'Endometriose peritoneal - tratamento cirúrgico via laparoscópica'),
	(31307191, 'Epiploplastia ou aplicação de membranas antiaderentes via laparoscópica'),
	(31307205, 'Liberação laparoscópica de aderências pélvicas com ou sem ressecção de cistos peritoneais ou salpingólise'),
	(31307213, 'Ligadura de veia ovariana laparoscópica'),
	(31307221, 'Ligamentopexia pélvica laparoscópica'),
	(31307230, 'Neurectomia laparoscópica pré-sacral ou do nervo gênito-femoral'),
	(31307248, 'Omentectomia laparoscópica'),
	(31307256, 'Ressecção laparoscópica de tumor de parede abdominal'),
	(31307264, 'Ressecção ou ligadura laparoscópica de varizes pélvicas'),
	(31307272, 'Secção laparoscópica de ligamentos útero-sacros'),
	(31307280, 'Endometriose  - tratamento cirúrgico via laparoscópica'),
	(31308015, 'Aspiração de folículos para fertilização'),
	(31308023, 'GIFT (transferência de gametas para as trompas)'),
	(31308031, 'Inseminação artificial'),
	(31308040, 'Transferência de embrião para o útero'),
	(31309011, 'Amniorredução ou amnioinfusão'),
	(31309020, 'Aspiração manual intra-uterina (AMIU) pós-abortamento'),
	(31309038, 'Assistência ao trabalho de parto, por hora (até o limite de 6 horas). Não deverá ser considerado se o parto ocorrer na primeira hora após o início da assistência. Após a primeira hora, além da assistência, remunera-se o parto (via baixa ou cesariana).'),
	(31309046, 'Cerclagem do colo uterino (qualquer técnica)'),
	(31309054, 'Cesariana'),
	(31309062, 'Curetagem pós-abortamento'),
	(31309070, 'Derivações em cirurgia fetal'),
	(31309089, 'Gravidez  ectópica - cirurgia'),
	(31309097, 'Maturação cervical para indução de abortamento ou de trabalho de parto'),
	(31309100, 'Inversão uterina aguda - redução manual'),
	(31309119, 'Inversão uterina - tratamento cirúrgico'),
	(31309127, 'Parto (via vaginal)'),
	(31309135, 'Parto múltiplo (cada um subsequente ao inicial)'),
	(31309143, 'Punção escalpofetal para avaliação PH fetal'),
	(31309151, 'Revisão obstétrica de parto ocorrido fora do hospital (inclui exame, dequitação e sutura de lacerações até de 2º grau)'),
	(31309178, 'Versão cefálica externa'),
	(31309186, 'Gravidez ectópica - cirurgia laparoscópica'),
	(31309194, 'Inversão uterina - tratamento cirúrgico laparoscópico'),
	(31309208, 'Cesariana com histerectomia'),
	(31309216, 'Cirurgia fetal guiada por ultrassonografia'),
	(31309224, 'Cirurgia fetal endoscópica (guiada por ultrassonografia e fetoscópio)'),
	(31309232, 'Intervenção do obstetra na cirurgia fetal a céu aberto'),
	(31309259, 'Amniodrenagem ou amnioinfusão guiadas por ultrassonografia'),
	...
	(31401040, 'Craniotomia para remoção de corpo estranho'),
	...
	(31401368, 'Craniectomia para tumores cerebelares'),
	(31401376, 'Craniotomia exploradora com ou sem biópsia'),
	...
	(31402038, 'Tampão sanguíneo peridural para tratamento de cefaléia após punção (não indicada na profilaxia da cefaléia)'),
	(31403018, 'Biópsia de nervo'),
	(31403026, 'Bloqueio de nervo periférico - nervos periféricos'),
	...
	(31405029, 'Tratamento cirúrgico de lesão do sistema nervoso autônomo - qualquer método'),
	...
	(31503020, 'Transplante cardiopulmonar (receptor)'),
	(31504019, 'Transplante pulmonar (doador)'),
	(31504027, 'Transplante pulmonar unilateral (receptor)'),
	(31505015, 'Transplante hepático (receptor)'),
	(31505023, 'Transplante hepático (doador)'),
	(31506011, 'Transplante renal (receptor)'),
	(31506038, 'Nefrectomia em doador vivo - para transplante'),
	...
	(31602118, 'Bloqueio de nervo periférico - bloqueios anestésicos de nervos e estímulos neurovasculares'),
	(31602126, 'Bloqueio facetário para-espinhoso'),
	(31602134, 'Bloqueio neurolítico de nervos cranianos ou cérvico-torácico'),
	(31602142, 'Bloqueio neurolítico do plexo celíaco, simpático lombar ou torácico'),
	(31602150, 'Bloqueio neurolítico peridural ou subaracnóideo'),
	...
	(31602215, 'Laser - por sessão'),
	(31602223, 'Passagem de catéter peridural ou subaracnóideo com bloqueio de prova'),
	...
	(40101037, 'Teste ergométrico computadorizado (inclui ECG basal convencional)'),
	(40101045, 'Teste ergométrico convencional - 3 ou mais derivações simultâneas (inclui ECG basal convencional)'),
	(40101053, 'Variabilidade da frequência cardíaca'),
	(40101061, 'Ergoespirometria ou teste cardiopulmonar de exercício completo (espirometria forçada, consumo de O2, produção de CO2 e derivados, ECG, oximetria)'),
	(40102017, 'Bilimetria gástrica ou esofágica de 24 horas'),
	...
	(40102106, 'pH-metria esofágica computadorizada com três canais'),
	(40102114, 'Impedâncio pH-metria esofágica'),
	(40102122, 'pH-metria gástrica de 24 horas com quatro canais'),
	(40102130, 'pH-metria esofágica de 24 horas com quatro canais'),
	(40102149, 'Manometria Biliar'),
	(40103013, 'Análise computadorizada da voz'),
	(40103021, 'Análise computadorizada de papila e/ou fibras nervosas - monocular (GDX)'),
	...
	(40103072, 'Audiometria tonal limiar com testes de discriminação'),
	(40103080, 'Audiometria tonal limiar infantil condicionada (qualquer técnica) - Peep-show'),
	...
	(40103110, 'Audiometria vocal com mensagem competitiva (SSI, SSW)'),
	(40103129, 'Avaliação neurofisiológica  da função  sexual (inclui eletroneuromiografia de MMII, RBC, NCDP, PEGC)'),
	(40103137, 'Campimetria computadorizada - monocular'),
	(40103145, 'Variação de contingente negativo (PE/Tardio)'),
	(40103153, 'Craniocorporografia'),
	...
	(40103382, 'EMG para monitoração de quimodenervação (por sessão)'),
	(40103390, 'EMG quantitativa ou EMG de fibra única'),
	...
	(40103455, 'Otoemissões acústicas produto de distorção'),
	(40103463, 'Otoemissões evocadas transientes'),
	(40103471, 'Perimetria com scanning laser ophthalmoscope - monocular'),
	(40103480, 'Pesquisa de pares cranianos relacionados com o VIII PAR'),
	(40103498, 'Potencial evocado auditivo de tronco cerebral (PEA-TC)'),
	...
	(40103676, 'Rinometria acústica'),
	(40103684, 'Reflexo cutâneo-simpático'),
	(40103714, 'Teste de estimulação repetitiva (um ou mais músculos)'),
	(40103722, 'Teste de fístula perilinfática com eletronistagmografia'),
	...
	(40103765, 'Videonistagmografia infravermelha'),
	(40103781, 'Audiometria ocupacional ou de seleção'),
	(40103790, 'Audiometrias de altas frequências'),
	...
	(40104010, 'Avaliação muscular por dinamometria computadorizada (isocinética) - por articulação'),
	(40104028, 'Cronaximetria'),
	(40104036, 'Curva  I/T - medida de latência de nervo periférico'),
	(40104044, 'Ergotonometria músculo-esquelético (tetra, paraparesia e hemiparesia)'),
	(40104125, 'Sistema tridimensional de avaliação do movimento que inclui vídeo acoplado à plataforma da força e eletromiografia'),
	(40105016, 'Determinação das pressões respiratórias máximas'),
	(40105024, 'Determinação dos volumes pulmonares por diluição de gases'),
	(40105032, 'Determinação dos volumes pulmonares por pletismografia'),
	(40105040, 'Medida da difusão do monóxido de carbono'),
	(40105059, 'Medida de pico de fluxo expiratório'),
	(40105067, 'Medida seriada por 3 semanas do pico de fluxo expiratório'),
	(40105075, 'Prova de função pulmonar completa (ou espirometria)'),
	(40105083, 'Resistência das vias aéreas por oscilometria'),
	(40105091, 'Resistência das vias aéreas por pletismografia'),
	(40105105, 'Espirografia Simples - capacidade vital lenta'),
	(40105113, 'Regulação ventilatória - 1) medida de ventilação e do padrão ventilatório'),
	(40105121, 'Regulação ventilatória - 2) determinação da pressão de oclusão'),
	(40105130, 'Regulação ventilatória - 3) resposta a hipoxia e hipercapnia'),
	...
	(40201058, 'Broncoscopia com ou sem aspirado ou lavado brônquico bilateral'),
	...
	(40201198, 'Vídeo-endoscopia do esfíncter velo-palatino com ótica flexível'),
	(40201201, 'Vídeo-endoscopia do esfíncter velo-palatino com ótica rígida'),
	(40201210, 'Vídeo-endoscopia naso-sinusal com ótica flexível'),
	(40201228, 'Vídeo-endoscopia naso-sinusal com ótica rígida'),
	(40201236, 'Vídeo-laringo-estroboscopia com endoscópio flexível'),
	(40201244, 'Vídeo-laringo-estroboscopia com endoscópio rígido'),
	...
	(40201317, 'Medida de pressão de varizes de esôfago endoscópica'),
	...
	(40201384, 'Aplicação de plasma de argônio por broncoscopia'),
	(40201392, 'Aplicação de plasma de argônio por colonoscopia'),
	(40201406, 'Aplicação de plasma de argônio por sigmoidoscopia'),
	...
	(40202062, 'Cecostomia'),
	(40202070, 'Cistoenterostomia com colocação de prótese ou dreno'),
	(40202089, 'Colagem de fístula por via endoscópica'),
	(40202097, 'Colocação de cânula sob orientação endoscópica'),
	(40202100, 'Colocação de cateter para braquiterapia endobrônquica'),
	(40202119, 'Colocação de prótese coledociana por via endoscópica'),
	(40202127, 'Colocação de prótese traqueal ou brônquica'),
	(40202135, 'Colonoscopia com magnificação e tatuagem'),
	(40202143, 'Descompressão colônica por colonoscopia'),
	(40202151, 'Desobstrução brônquica com laser ou eletrocautério'),
	...
	(40202410, 'Laringoscopia/traqueoscopia com retirada de corpo estranho (tubo rígido)'),
	...
	(40202585, 'Retirada de corpo estranho no brônquio ou brônquico'),
	(40202593, 'Retirada de tumor ou papiloma por broncoscopia'),
	(40202607, 'Tamponamento de varizes do esôfago e estômago'),
	...
	(40202720, 'Retossigmoidoscopia rígida com biópsia e/ou citologia'),
	...
	(40202763, 'Laringoscopia/traqueoscopia com laser para exérese de papiloma/tumor'),
	(40202771, 'Retirada de balão intragástrico por via endoscópica'),
	(40301010, '3-metil histidina, pesquisa e/ou dosagem no soro'),
	(40301028, '5-nucleotidase - pesquisa e/ou dosagem'),
	(40301036, 'Acetaminofen - pesquisa e/ou dosagem'),
	(40301044, 'Acetilcolinesterase, em eritrócitos - pesquisa e/ou dosagem'),
	(40301052, 'Acetona, pesquisa e/ou dosagem no soro'),
	(40301060, 'Ácido ascórbico (vitamina C) - pesquisa e/ou dosagem'),
	(40301079, 'Ácido beta hidroxi butírico - pesquisa e/ou dosagem'),
	(40301087, 'Ácido fólico, pesquisa e/ou dosagem nos eritrócitos'),
	(40301095, 'Ácido glioxílico - pesquisa e/ou dosagem'),
	(40301109, 'Ácido láctico (lactato) - pesquisa e/ou dosagem'),
	(40301117, 'Ácido orótico - pesquisa e/ou dosagem'),
	(40301125, 'Ácido oxálico - pesquisa e/ou dosagem'),
	(40301133, 'Ácido pirúvico - pesquisa e/ou dosagem'),
	(40301141, 'Ácido siálico - pesquisa e/ou dosagem'),
	(40301150, 'Ácido úrico - pesquisa e/ou dosagem'),
	(40301168, 'Ácido valpróico - pesquisa e/ou dosagem'),
	(40301176, 'Ácidos biliares - pesquisa e/ou dosagem'),
	(40301184, 'Ácidos graxos livres - pesquisa e/ou dosagem'),
	...
	(40301249, 'Alfa-1-antitripsina, pesquisa e/ou dosagem no soro'),
	(40301257, 'Alfa-1-glicoproteína ácida - pesquisa e/ou dosagem'),
	(40301265, 'Alfa-2-macroglobulina - pesquisa e/ou dosagem'),
	(40301273, 'Alumínio, pesquisa e/ou dosagem no soro'),
	(40301281, 'Amilase - pesquisa e/ou dosagem'),
	(40301290, 'Aminoácidos, fracionamento e quantificação'),
	(40301303, 'Amiodarona - pesquisa e/ou dosagem'),
	(40301311, 'Amitriptilina, nortriptilina (cada) - pesquisa e/ou dosagem'),
	...
	(40301354, 'Apolipoproteína A (Apo A) - pesquisa e/ou dosagem'),
	(40301362, 'Apolipoproteína B (Apo B) - pesquisa e/ou dosagem'),
	(40301370, 'Barbitúricos, antidepressivos tricíclicos (cada) - pesquisa e/ou dosagem'),
	(40301389, 'Beta-glicuronidase - pesquisa e/ou dosagem'),
	(40301397, 'Bilirrubinas (direta, indireta e total) - pesquisa e/ou dosagem'),
	(40301400, 'Cálcio - pesquisa e/ou dosagem'),
	(40301419, 'Cálcio iônico - pesquisa e/ou dosagem'),
	(40301427, 'Capacidade de fixação de ferro - pesquisa e/ou dosagem'),
	(40301435, 'Carbamazepina - pesquisa e/ou dosagem'),
	(40301443, 'Carnitina livre - pesquisa e/ou dosagem'),
	(40301451, 'Carnitina total e frações - pesquisa e/ou dosagem'),
	(40301460, 'Caroteno - pesquisa e/ou dosagem'),
	(40301478, 'Ceruloplasmina - pesquisa e/ou dosagem'),
	(40301486, 'Ciclosporina, methotrexate - cada - pesquisa e/ou dosagem'),
	...
	(40301540, 'Clomipramina - pesquisa e/ou dosagem'),
	(40301559, 'Cloro - pesquisa e/ou dosagem'),
	(40301567, 'Cobre - pesquisa e/ou dosagem'),
	(40301575, 'Cocaína, pesquisa e/ou dosagem'),
	...
	(40301613, 'Cotinina - pesquisa e/ou dosagem'),
	(40301621, 'Creatina - pesquisa e/ou dosagem'),
	(40301630, 'Creatinina - pesquisa e/ou dosagem'),
	(40301648, 'Creatino fosfoquinase total (CK) - pesquisa e/ou dosagem'),
	(40301656, 'Creatino fosfoquinase - fração MB - massa - pesquisa e/ou dosagem'),
	(40301664, 'Creatino fosfoquinase - fração MB - atividade - pesquisa e/ou dosagem'),
	(40301672, 'Cromatografia de aminoácidos (perfil qualitatitivo) - pesquisa e/ou dosagem'),
	(40301680, 'Curva glicêmica (4 dosagens) via oral ou endovenosa'),
	(40301699, 'Desidrogenase alfa-hidroxibutírica - pesquisa e/ou dosagem'),
	(40301702, 'Desidrogenase glutâmica - pesquisa e/ou dosagem'),
	(40301710, 'Desidrogenase isocítrica - pesquisa e/ou dosagem'),
	(40301729, 'Desidrogenase láctica - pesquisa e/ou dosagem'),
	(40301737, 'Desidrogenase láctica - isoenzimas fracionadas - pesquisa e/ou dosagem'),
	(40301745, 'Benzodiazepínicos e similares (cada) - pesquisa e/ou dosagem'),
	(40301753, 'Digitoxina ou digoxina - pesquisa e/ou dosagem'),
	...
	(40301800, 'Etossuximida - pesquisa e/ou dosagem'),
	...
	(40301869, 'Fosfatase ácida fração prostática - pesquisa e/ou dosagem'),
	(40301877, 'Fosfatase ácida total - pesquisa e/ou dosagem'),
	(40301885, 'Fosfatase alcalina - pesquisa e/ou dosagem'),
	(40301893, 'Fosfatase alcalina com fracionamento de isoenzimas - pesquisa e/ou dosagem'),
	...
	(40301982, 'Galactose 1-fosfatouridil transferase, pesquisa e/ou dosagem'),
	(40301990, 'Gama-glutamil transferase - pesquisa e/ou dosagem'),
	(40302016, 'Gasometria (pH, pCO2, SA, O2, excesso base) - pesquisa e/ou dosagem'),
	...
	(40302059, 'Glicose-6-fosfato deidrogenase (G6FD) - pesquisa e/ou dosagem'),
	(40302067, 'Haptoglobina - pesquisa e/ou dosagem'),
	(40302075, 'Hemoglobina glicada (A1 total) - pesquisa e/ou dosagem'),
	(40302083, 'Hemoglobina plasmática livre - pesquisa e/ou dosagem'),
	(40302091, 'Hexosaminidase A - pesquisa e/ou dosagem'),
	(40302105, 'Hidroxiprolina - pesquisa e/ou dosagem'),
	(40302113, 'Homocisteína - pesquisa e/ou dosagem'),
	(40302121, 'Imipramina - desipramina - pesquisa e/ou dosagem'),
	(40302130, 'Amilase ou alfa-amilase, isoenzimas - pesquisa e/ou dosagem'),
	(40302148, 'Isomerase fosfohexose - pesquisa e/ou dosagem'),
	(40302156, 'Isoniazida - pesquisa e/ou dosagem'),
	(40302164, 'Lactose, teste de tolerância'),
	(40302172, 'Leucino aminopeptidase - pesquisa e/ou dosagem'),
	(40302180, 'Lidocaina - pesquisa e/ou dosagem'),
	(40302199, 'Lipase - pesquisa e/ou dosagem'),
	(40302202, 'Lipase lipoprotéica - pesquisa e/ou dosagem'),
	(40302210, 'Lipoproteína (a) - Lp (a) - pesquisa e/ou dosagem'),
	(40302229, 'Lítio - pesquisa e/ou dosagem'),
	(40302237, 'Magnésio - pesquisa e/ou dosagem'),
	(40302245, 'Mioglobina, pesquisa e/ou dosagem'),
	(40302253, 'Nitrogênio amoniacal - pesquisa e/ou dosagem'),
	(40302261, 'Nitrogênio total - pesquisa e/ou dosagem'),
	(40302270, 'Osmolalidade - pesquisa e/ou dosagem'),
	(40302288, 'Oxcarbazepina, pesquisa e/ou dosagem'),
	(40302296, 'Piruvato quinase - pesquisa e/ou dosagem'),
	(40302300, 'Porfirinas quantitativas (cada) - pesquisa e/ou dosagem'),
	(40302318, 'Potássio - pesquisa e/ou dosagem'),
	(40302326, 'Pré-albumina - pesquisa e/ou dosagem'),
	(40302334, 'Primidona - pesquisa e/ou dosagem'),
	(40302342, 'Procainamida - pesquisa e/ou dosagem'),
	(40302350, 'Propanolol - pesquisa e/ou dosagem'),
	(40302369, 'Proteína ligadora do retinol - pesquisa e/ou dosagem'),
	(40302377, 'Proteínas totais - pesquisa e/ou dosagem'),
	(40302385, 'Proteínas totais albumina e globulina - pesquisa e/ou dosagem'),
	(40302393, 'Quinidina - pesquisa e/ou dosagem'),
	(40302407, 'Reserva alcalina (bicarbonato) - pesquisa e/ou dosagem'),
	(40302415, 'Sacarose, teste de tolerância'),
	(40302423, 'Sódio - pesquisa e/ou dosagem'),
	(40302431, 'Succinil acetona - pesquisa e/ou dosagem'),
	(40302440, 'Sulfonamidas livre e acetilada (% de acetilação) - pesquisa e/ou dosagem'),
	(40302458, 'Tacrolimus - pesquisa e/ou dosagem'),
	(40302466, 'Tálio, pesquisa e/ou dosagem'),
	(40302474, 'Teofilina - pesquisa e/ou dosagem'),
	(40302482, 'Teste de tolerância a insulina ou hipoglicemiantes orais (até 6 dosagens)'),
	(40302490, 'Tirosina - pesquisa e/ou dosagem'),
	(40302504, 'Transaminase oxalacética (amino transferase aspartato) - pesquisa e/ou dosagem'),
	...
	(40302555, 'Trimipramina - pesquisa e/ou dosagem'),
	(40302563, 'Tripsina imuno reativa (IRT) - pesquisa e/ou dosagem'),
	...
	(40302652, 'Mucopolissacaridose, pesquisa e/ou dosagem'),
	...
	(40302750, 'Perfil lipídico / lipidograma (lípidios totais, colesterol, triglicerídios e eletroforese lipoproteínas) - pesquisa e/ou dosagem'),
	(40302768, 'PAPP-A - pesquisa e/ou dosagem'),
	(40302776, 'Peptídeo natriurético BNP/PROBNP - pesquisa e/ou dosagem'),
	(40302784, 'Vitamina B1, pesquisa e/ou dosagem'),
	(40302792, 'Vitamina B2, pesquisa e/ou dosagem'),
	(40302806, 'Vitamina B3, pesquisa e/ou dosagem'),
	(40302814, 'Vitamina B6, pesquisa e/ou dosagem'),
	(40302822, 'Vitamina D2, pesquisa e/ou dosagem'),
	(40302830, 'Vitamina "D" 25 HIDROXI, pesquisa e/ou dosagem (Vitamina D3)'),
	(40302849, 'Vitamina K,- pesquisa e/ou dosagem'),
	(40302857, '6-Monoacetilmorfina urinária'),
	(40302865, '7 Dihidrocolesterol, dosagem'),
	(40302873, 'Ácido Gama-hidroxibutirico, dosagem soro'),
	...
	(40302954, 'Cartilagem oligomérica proteína (COMP)'),
	(40302962, 'Cistatina C'),
	(40302970, 'Clearance de água livre'),
	(40302989, 'Clearance de amilase'),
	(40302997, 'Colágeno ensaio de ligação'),
	(40303012, 'Alfa -1-antitripsina, (fezes) - pesquisa e/ou dosagem'),
	(40303020, 'Anal Swab, pesquisa de oxiúrus'),
	(40303039, 'Coprológico funcional (caracteres, pH, digestibilidade, amônia, ácidos orgânicos e interpretação)'),
	(40303047, 'Eosinófilos, pesquisa nas fezes'),
	(40303055, 'Gordura fecal, dosagem'),
	(40303063, 'Hematoxilina férrica, pesquisa de protozoários nas fezes'),
	(40303071, 'Identificação de helmintos,  exame de fragmentos - nas fezes'),
	(40303080, 'Larvas (fezes), pesquisa'),
	(40303098, 'Leucócitos e hemácias, pesquisa nas fezes'),
	(40303101, 'Leveduras, pesquisa nas fezes'),
	(40303110, 'Parasitológico - nas fezes'),
	(40303128, 'Parasitológico, colheita múltipla com fornecimento do líquido conservante nas fezes'),
	(40303136, 'Sangue oculto, pesquisa nas fezes'),
	(40303144, 'Shistossoma, pesquisa ovos em fragmentos mucosa após biópsia retal'),
	(40303152, 'Substâncias redutoras nas fezes - pesquisa'),
	(40303160, 'Tripsina, prova de (digestão da gelatina)'),
	(40303179, 'Esteatócrito, triagem para gordura fecal'),
	...
	(40303225, 'Nitrôgenio fecal, dosagem'),
	(40303233, 'Pesquisa de VRE'),
	(40303241, 'Toxina botuliníca, pesquisa (fezes)'),
	(40303250, 'Sangue oculto nas fezes, pesquisa imunológica'),
	(40303268, 'Oograma nas fezes'),
	(40303276, 'Resíduos alimentares, identificação, fezes'),
	(40303284, 'Elastase pancreática fecal'),
	(40303292, 'Fibrinopeptídeo A, antígeno'),
	...
	(40304027, 'Anticorpo anti A e B, pesquisa e/ou dosagem'),
	(40304035, 'Anticorpos antiplaquetários, citometria de fluxo'),
	(40304043, 'Anticorpos irregulares - pesquisa e/ou dosagem'),
	(40304051, 'Anticorpos irregulares, pesquisa (meio salino a temperatura ambiente e 37º e teste indireto de coombs)'),
	(40304060, 'Antitrombina III, dosagem'),
	(40304078, 'Ativador tissular de plasminogênio (TPA) - pesquisa e/ou dosagem'),
	(40304086, 'CD... (antígeno de dif. Celular, cada determinação) - pesquisa e/ou dosagem'),
	(40304094, 'Citoquímica para classificar leucemia: esterase, fosfatase leucocitária, PAS, peroxidase ou SB,  etc - cada'),
	(40304108, 'Coombs direto'),
	(40304116, 'Enzimas  eritrocitárias,  (adenilatoquinase,  desidrogenase láctica,  fosfofructoquinase,  fosfoglicerato quinase, gliceraldeído, 3  - fosfato   desidrogenase, glicose  fosfato isomerase,  glicose 6 - fosfato desidrogenase, glutation peroxidase, glutation'),
	...
	(40304264, 'Fibrinogênio, teste funcional, dosagem'),
	(40304272, 'Filária, pesquisa'),
	(40304280, 'Grupo ABO, classificação reversa - determinação'),
	(40304299, 'Grupo sanguíneo ABO, e fator Rho (inclui Du) - determinação'),
	...
	(40304370, 'Hemossedimentação, (VHS) - pesquisa e/ou dosagem'),
	(40304388, 'Hemossiderina (siderócitos), sangue ou urina - pesquisa e/ou dosagem'),
	(40304396, 'Heparina, dosagem'),
	(40304400, 'Inibidor do TPA (PAI) - pesquisa e/ou dosagem'),
	(40304418, 'Leucócitos, contagem'),
	(40304434, 'Meta-hemoglobina, determinação da'),
	(40304450, 'Plaquetas, teste de agregação (por agente agregante), cada'),
	(40304469, 'Plasminogênio, dosagem'),
	(40304477, 'Plasmódio, pesquisa'),
	(40304485, 'Medula óssea, aspiração para mielograma ou microbiológico'),
	...
	(40304523, 'Protoporfirina eritrocitária livre - zinco - pesquisa e/ou dosagem'),
	...
	(40304574, 'Ristocetina, co-fator, teste funcional, dosagem'),
	(40304582, 'Tempo de coagulação - determinação'),
	(40304590, 'Tempo de protrombina - determinação'),
	(40304604, 'Tempo de reptilase - determinação'),
	(40304612, 'Tempo de sangramento de IVY - deteminação'),
	(40304620, 'Tempo de trombina - determinação'),
	(40304639, 'Tempo de tromboplastina parcial ativada - determinação'),
	(40304647, 'Tripanossoma, pesquisa'),
	(40304655, 'Tromboelastograma  - pesquisa e/ou dosagem'),
	(40304663, 'Alfa-2antiplasmina, teste funcional'),
	...
	(40304701, 'Imunofenotipagem para doença residual mínima (*)'),
	(40304710, 'Imunofenotipagem para hemoglobinúria paroxistica noturna (*)'),
	(40304728, 'Imunofenotipagem para leucemias agudas ou sindrome mielodisplásica (*)'),
	(40304736, 'Imunofenotipagem para linfoma não hodgkin / sindrome linfoproliferativa crônica (*)'),
	(40304744, 'Imunofenotipagem para perfil imune (*)'),
	(40304752, 'Fator IX, dosagem do inibidor'),
	(40304760, 'Inibidor dos fatores da hemostasia, triagem'),
	(40304779, 'Produtos de degradação da fibrina, quantitativo - pesquisa e/ou dosagem'),
	...
	(40304817, 'Enzimas eritrocitárias, rastreio para deficiência'),
	(40304825, 'Esplenograma (citologia)'),
	(40304833, 'Hemoglobina instabilidade a 37 graus C - pesquisa e/ou dosagem'),
	(40304841, 'Hemoglobina, solubilidade (HbS e HbD) - pesquisa e/ou dosagem'),
	(40304850, 'Hemoglobinopatia - triagem (El.HB., hemoglob. fetal. reticulócitos, corpos de H, T. falcização hemácias, resist. osmótica, termo estabilidade)'),
	(40304868, 'Estreptozima - pesquisa e/ou dosagem'),
	...
	(40304922, 'Coagulograma (TS, TC, prova do laço, retração do coágulo, contagem de plaquetas, tempo de protombina, tempo de tromboplastina, parcial ativado) - pesquisa e/ou dosagem'),
	...
	(40304973, 'Alfa talassemia anal molecular sangue'),
	(40304981, 'Analisador da função plaquetaria PFA-100'),
	(40305015, '1,25-dihidroxi vitamina D - pesquisa e/ou dosagem'),
	(40305040, '17-cetogênicos (17-CGS) - pesquisa e/ou dosagem'),
	(40305058, '17-cetogênicos cromatografia - pesquisa e/ou dosagem'),
	...
	(40305422, 'Leptina - pesquisa e/ou dosagem'),
	(40305449, 'N-telopeptídeo - pesquisa e/ou dosagem'),
	(40305465, 'Paratormônio - PTH ou fração (cada) - pesquisa e/ou dosagem'),
	(40305490, 'Piridinolina - pesquisa e/ou dosagem'),
	(40305503, 'Pregnandiol - pesquisa e/ou dosagem'),
	(40305511, 'Pregnantriol - pesquisa e/ou dosagem'),
	(40305546, 'Prova do LH-Rh, dosagem do FSH sem fornecimento de medicamento (cada)'),
	(40305554, 'Prova do LH-Rh, dosagem do LH sem fornecimento de medicamento (cada)'),
	(40305562, 'Prova do TRH-HPR, dosagem do HPR sem fornecimento do material (cada)'),
	...
	(40305600, 'Iodo protéico (PBI) - pesquisa e/ou dosagem'),
	(40305619, 'Lactogênico placentário hormônio - pesquisa e/ou dosagem'),
	(40305627, 'Provas de função tireoideana (T3, T4, índices e TSH)'),
	(40305635, 'Somatotrófico coriônico (HCS ou PHL) - pesquisa e/ou dosagem'),
	...
	(40306178, 'Anticorpo anti-DNAse B - pesquisa e/ou dosagem'),
	(40306186, 'Anticorpo anti-hormônio do crescimento - pesquisa e/ou dosagem'),
	...
	(40306224, 'Anticorpos anti-influenza A,  IgM - pesquisa e/ou dosagem'),
	(40306232, 'Anticorpos anti-influenza B, IgG - pesquisa e/ou dosagem'),
	(40306240, 'Anticorpos anti-influenza B, IgM - pesquisa e/ou dosagem'),
	(40306259, 'Anticorpos antiendomisio - IgG, IgM, IgA (cada) - pesquisa e/ou dosagem'),
	(40306267, 'Anticorpos naturais - isoaglutininas, pesquisas'),
	(40306275, 'Anticorpos naturais - isoaglutininas, titulagem'),
	...
	(40306321, 'Antigliadina (glúten) - IgM - pesquisa e/ou dosagem'),
	...
	(40306437, 'Antiperoxidase tireoideana - pesquisa e/ou dosagem'),
	...
	(40306470, 'Beta-2-microglobulina - pesquisa e/ou dosagem'),
	(40306488, 'Biotinidase atividade da, qualitativo - pesquisa e/ou dosagem'),
	(40306496, 'Blastomicose, reação sorológica'),
	(40306500, 'Brucela - IgG - pesquisa e/ou dosagem'),
	(40306518, 'Brucela - IgM - pesquisa e/ou dosagem'),
	(40306526, 'Brucela, prova rápida'),
	...
	(40306569, 'CA 50 - pesquisa e/ou dosagem'),
	(40306577, 'CA-242 - pesquisa e/ou dosagem'),
	(40306585, 'CA-27-29 - pesquisa e/ou dosagem'),
	(40306593, 'Caxumba, IgG - pesquisa e/ou dosagem'),
	(40306607, 'Caxumba, IgM - pesquisa e/ou dosagem'),
	(40306615, 'Chagas IgG - pesquisa e/ou dosagem'),
	(40306623, 'Chagas IgM - pesquisa e/ou dosagem'),
	(40306631, 'Chlamydia - IgG - pesquisa e/ou dosagem'),
	(40306640, 'Chlamydia - IgM - pesquisa e/ou dosagem'),
	(40306658, 'Cisticercose, AC - pesquisa e/ou dosagem'),
	(40306666, 'Citomegalovírus IgG - pesquisa e/ou dosagem'),
	(40306674, 'Citomegalovírus IgM - pesquisa e/ou dosagem'),
	(40306682, 'Clostridium difficile, toxina A - pesquisa e/ou dosagem'),
	(40306690, 'Complemento C2 - pesquisa e/ou dosagem'),
	(40306704, 'Complemento C3 - pesquisa e/ou dosagem'),
	(40306712, 'Complemento C4 - pesquisa e/ou dosagem'),
	(40306720, 'Complemento C5 - pesquisa e/ou dosagem'),
	(40306739, 'Complemento CH-100 - pesquisa e/ou dosagem'),
	(40306747, 'Complemento CH-50 - pesquisa e/ou dosagem'),
	(40306755, 'Crio-aglutinina, globulina, dosagem, cada'),
	(40306763, 'Crio-aglutinina, globulina, pesquisa, cada'),
	(40306771, 'Cross match (prova cruzada de histocompatibilidade para transplante renal)'),
	(40306780, 'Cultura ou estimulação dos linfócitos "in vitro" por concanavalina, PHA ou pokweed'),
	(40306798, 'Dengue - IgG e IgM (cada) - pesquisa e/ou dosagem'),
	(40306801, 'Echovírus (painel) sorologia para'),
	(40306810, 'Equinococose (Hidatidose), reação sorológica'),
	(40306828, 'Equinococose, IDR - pesquisa e/ou dosagem'),
	(40306836, 'Esporotricose, reação sorológica'),
	(40306844, 'Esporotriquina, IDR - pesquisa e/ou dosagem'),
	(40306852, 'Fator antinúcleo, (FAN) - pesquisa e/ou dosagem'),
	(40306860, 'Fator reumatóide, quantitativo - pesquisa e/ou dosagem'),
	(40306879, 'Filaria sorologia - pesquisa e/ou dosagem'),
	(40306887, 'Genotipagem do sistema HLA'),
	(40306895, 'Giardia, reação sorológica'),
	(40306909, 'Helicobacter pylori - IgA - pesquisa e/ou dosagem'),
	(40306917, 'Helicobacter pylori - IgG - pesquisa e/ou dosagem'),
	(40306925, 'Helicobacter pylori - IgM - pesquisa e/ou dosagem'),
	(40306933, 'Hepatite A - HAV - IgG - pesquisa e/ou dosagem'),
	(40306941, 'Hepatite A - HAV - IgM - pesquisa e/ou dosagem'),
	(40306950, 'Hepatite B - HBCAC - IgG (anti-core IgG ou Acoreg) - pesquisa e/ou dosagem'),
	(40306968, 'Hepatite B - HBCAC - IgM (anti-core IgM ou Acorem) - pesquisa e/ou dosagem'),
	(40306976, 'Hepatite B - HBeAC (anti HBE) - pesquisa e/ou dosagem'),
	(40306984, 'Hepatite B - HBeAG (antígeno "E") - pesquisa e/ou dosagem'),
	(40306992, 'Hepatite B - HBSAC (anti-antígeno de superfície) - pesquisa e/ou dosagem'),
	...
	(40307042, 'Hepatite C - imunoblot - pesquisa e/ou dosagem'),
	(40307050, 'Hepatite delta, anticorpo IgG - pesquisa e/ou dosagem'),
	(40307069, 'Hepatite delta, anticorpo IgM - pesquisa e/ou dosagem'),
	(40307077, 'Hepatite delta, antígeno - pesquisa e/ou dosagem'),
	(40307085, 'Herpes simples - IgG - pesquisa e/ou dosagem'),
	(40307093, 'Herpes simples - IgM - pesquisa e/ou dosagem'),
	(40307107, 'Herpes zoster - IgG - pesquisa e/ou dosagem'),
	(40307115, 'Herpes zoster - IgM - pesquisa e/ou dosagem'),
	(40307123, 'Hipersensibilidade retardada (intradermo reação IDeR ) candidina, caxumba, estreptoquinase-dornase, PPD, tricofitina, vírus vacinal, outro(s), cada'),
	(40307131, 'Histamina, dosagem'),
	(40307140, 'Histona - pesquisa e/ou dosagem'),
	(40307158, 'Histoplasmose, reação sorológica'),
	(40307166, 'HIV - antígeno P24 - pesquisa e/ou dosagem'),
	...
	(40307255, 'IgE, grupo específico, cada - pesquisa e/ou dosagem'),
	(40307263, 'IgE, por alérgeno (cada) - pesquisa e/ou dosagem'),
	(40307271, 'IgE, total - pesquisa e/ou dosagem'),
	(40307280, 'IgG - pesquisa e/ou dosagem'),
	(40307298, 'IgG, subclasses 1,2,3,4 (cada) - pesquisa e/ou dosagem'),
	(40307301, 'IgM - pesquisa e/ou dosagem'),
	(40307310, 'Imunocomplexos circulantes - pesquisa e/ou dosagem'),
	(40307328, 'Imunocomplexos circulantes, com células Raji - pesquisa e/ou dosagem'),
	(40307336, 'Imunoeletroforese (estudo da gamopatia) - pesquisa e/ou dosagem'),
	(40307344, 'Inibidor de C1 esterase - pesquisa e/ou dosagem'),
	(40307352, 'Isospora, pesquisa de antígeno - pesquisa e/ou dosagem'),
	(40307360, 'Ito (cancro mole), IDeR - pesquisa e/ou dosagem'),
	(40307379, 'Kveim (sarcoidose), IDeR - pesquisa e/ou dosagem'),
	(40307387, 'Legionella - IgG e IgM (cada) - pesquisa e/ou dosagem'),
	(40307395, 'Leishmaniose - IgG e IgM (cada) - pesquisa e/ou dosagem'),
	...
	(40307433, 'Linfócitos T "helper" contagem de (IF com OKT-4) (CD-4+) citometria de fluxo'),
	(40307441, 'Linfócitos T supressores contagem de (IF com OKT-8) (D-8) citometria de fluxo'),
	(40307450, 'Listeriose, reação sorológica'),
	(40307468, 'Lyme - IgG - pesquisa e/ou dosagem'),
	(40307476, 'Lyme - IgM - pesquisa e/ou dosagem'),
	(40307484, 'Malária - IgG - pesquisa e/ou dosagem'),
	(40307492, 'Malária - IgM - pesquisa e/ou dosagem'),
	(40307506, 'Mantoux, IDeR'),
	(40307514, 'MCA (antígeno cárcino-mamário) - pesquisa e/ou dosagem'),
	(40307522, 'Micoplasma pneumoniae - IgG - pesquisa e/ou dosagem'),
	(40307530, 'Micoplasma pneumoniae - IgM - pesquisa e/ou dosagem'),
	(40307565, 'Mononucleose - Epstein BARR - IgG - pesquisa e/ou dosagem'),
	(40307573, 'Mononucleose, anti-VCA (EBV) IgG - pesquisa e/ou dosagem'),
	(40307581, 'Mononucleose, anti-VCA (EBV) IgM - pesquisa e/ou dosagem'),
	(40307590, 'Montenegro, IDeR'),
	(40307603, 'Outros testes bioquímicos para determinação do risco fetal (cada)'),
	(40307611, 'Parvovírus - IgG, IgM (cada) - pesquisa e/ou dosagem'),
	(40307620, 'Peptídio intestinal vasoativo, dosagem'),
	(40307638, 'PPD (tuberculina), IDeR'),
	(40307654, 'Proteína C, teste imunológico'),
	(40307662, 'Proteína eosinofílica catiônica (ECP) - pesquisa e/ou dosagem'),
	(40307689, 'Reação sorológica para coxsackie, neutralização IgG'),
	(40307697, 'Rubéola - IgG - pesquisa e/ou dosagem'),
	(40307700, 'Rubéola - IgM - pesquisa e/ou dosagem'),
	(40307719, 'Schistosomose - IgG - pesquisa e/ou dosagem'),
	(40307727, 'Schistosomose - IgM - pesquisa e/ou dosagem'),
	...
	(40307778, 'Teste de inibição da migração dos linfócitos (para cada antígeno)'),
	(40307786, 'Teste respiratório para H. Pylori'),
	(40307794, 'Toxocara cannis - IgG - pesquisa e/ou dosagem'),
	(40307808, 'Toxocara cannis - IgM - pesquisa e/ou dosagem'),
	...
	(40307859, 'Vírus sincicial respiratório - Elisa - IgG - pesquisa e/ou dosagem'),
	(40307867, 'Waaler-Rose (fator reumatóide) - pesquisa e/ou dosagem'),
	(40307875, 'Western Blot (anticorpos anti-HIV) - pesquisa e/ou dosagem'),
	(40307883, 'Western Blot (anticorpos anti-HTVI ou HTLVII) (cada) - pesquisa e/ou dosagem'),
	(40307891, 'Widal, reação de'),
	(40307905, 'Alérgenos - perfil antigênico (painel C/36 antígenos) - pesquisa e/ou dosagem'),
	(40307913, 'Anti-DMP - pesquisa e/ou dosagem'),
	(40307921, 'Anti-hialuronidase, determinação da'),
	(40307930, 'Antidesoxiribonuclease B, neutralização quantitativa - pesquisa e/ou dosagem'),
	(40307948, 'Antifígado (glomérulo, tub. Renal corte rim de rato), IFI - pesquisa e/ou dosagem'),
	(40307956, 'Antígenos metílicos solúveis do BCG (1 aplicação)'),
	(40307964, 'Chagas, hemoaglutinação'),
	(40307972, 'Chagas (Machado Guerreiro)'),
	(40307999, 'Complemento C3, C4 - turbid. ou nefolométrico C3A - pesquisa e/ou dosagem'),
	(40308014, 'Crioglobulinas, caracterização - imunoeletroforese'),
	(40308022, 'DNCB - teste de contato'),
	(40308030, 'Fator reumatóide, teste do látex (qualitativo) - pesquisa'),
	(40308049, 'Frei (linfogranuloma venéreo), IDeR - pesquisa e/ou dosagem'),
	(40308065, 'Gonococo - hemaglutinação (HA)'),
	(40308081, 'Hidatidose (equinococose) IDi dupla - pesquisa e/ou dosagem'),
	(40308090, 'NBT estimulado'),
	(40308120, 'Sarampo - anticorpos IgG - pesquisa e/ou dosagem'),
	(40308138, 'Sarampo - anticorpos IgM - pesquisa e/ou dosagem'),
	(40308154, 'Toxoplasmose - IgA - pesquisa e/ou dosagem'),
	(40308162, 'Varicela, IgG - pesquisa e/ou dosagem'),
	(40308170, 'Varicela, IgM - pesquisa e/ou dosagem'),
	(40308197, 'Vírus sincicial respiratório - pesquisa direta'),
	(40308200, 'Weil Felix (Ricketsiose), reação de aglutinação'),
	(40308219, 'Anticorpo anti Saccharamyces - ASCA - pesquisa e/ou dosagem'),
	(40308235, 'HER2 dosagem do receptor'),
	(40308243, 'Poliomelite sorologia'),
	(40308251, 'Proteína Amiloide A - pesquisa e/ou dosagem'),
	(40308278, 'Schistosomose, pesquisa'),
	(40308286, 'Sífilis anticorpo total - pesquisa e/ou dosagem'),
	(40308294, 'Sífilis IgM - pesquisa e/ou dosagem'),
	(40308308, 'Amebíase, IgG - pesquisa e/ou dosagem'),
	(40308316, 'Amebíase, IgM - pesquisa e/ou dosagem'),
	(40308324, 'Gonococo - IgG - pesquisa e/ou dosagem'),
	(40308332, 'Gonococo - IgM - pesquisa e/ou dosagem'),
	(40308340, 'Mononucleose, sorologia para (Monoteste ou Paul-Bunnel), cada'),
	(40308359, 'Psitacose - IgG - pesquisa e/ou dosagem'),
	(40308367, 'Psitacose - IgM - pesquisa e/ou dosagem'),
	(40308375, 'Psitacose - IgA - pesquisa e/ou dosagem'),
	(40308383, 'Proteína C reativa, qualitativa - pesquisa'),
	(40308391, 'Proteína C reativa, quantitativa - pesquisa e/ou dosagem'),
	...
	(40308430, 'Ameba, pesquisa antígeno nas fezes, Elisa'),
	(40308448, 'Anti 68 KD (Cóclea)'),
	(40308456, 'Anti citosol hepático'),
	...
	(40308570, 'Anti YO'),
	(40308588, 'Anti YO líquor'),
	(40308596, 'Anticorpos anti 21 hidroxilase'),
	(40308600, 'Anticorpos anti adrenal'),
	(40308618, 'Anticorpos anti anexina'),
	(40308626, 'Anticorpos anti antígeno hepático solúvel'),
	(40308634, 'Anticorpos anti coccidióides, soro'),
	(40308642, 'Anticorpos anti colágeno tipo 2'),
	...
	(40308693, 'Anticorpos anti granulócitos'),
	(40308707, 'Anticorpos anti Hantavirus'),
	(40308715, 'Anticorpos anti líquor arbovirus, painel'),
	(40308723, 'Anticorpos anti líquor bartonella'),
	(40308731, 'Anticorpos anti líquor gangliosídeo, painel'),
	(40308740, 'Anticorpos anti líquor GM1'),
	...
	(40308804, 'Anticorpos anti peptídeo cíclico citrulinado - IgG'),
	(40308812, 'Anticorpos anti PM1'),
	(40308820, 'Anticorpos anti reticulina'),
	(40308839, 'Anticorpos anti strongilóides'),
	(40308847, 'Anticorpos anti sulfatídeo'),
	(40308855, 'Anticorpos anti vírus herpes  6 líquor - IgG/IgM'),
	(40308863, 'Anticorpos anti vírus herpes 6'),
	(40308871, 'Anticorpos anti vírus rábico'),
	(40308880, 'Anticorpos arbovírus, painel'),
	(40308898, 'Anticorpos Beta 2 glicoproteina I  - IgG/IgM/IgA'),
	(40308901, 'Acetilcolina, anticorpos bloqueador receptor'),
	(40308910, 'Anticorpos contra canal de cálcio regulado por voltagem'),
	...
	(40308960, 'Anticorpos Gangliosídeos, soro'),
	(40308979, 'Anticorpos Gd1A - IgG'),
	(40308987, 'Anticorpos Gd1A - IgM'),
	(40308995, 'Anticorpos Gd1B - IgG'),
	(40309010, 'Adenosina de aminase (ADA) - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309029, 'Bioquímica ICR (proteínas + pandy + glicose + cloro) - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309037, 'Células, contagem total e específica - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309045, 'Células, pesquisa de células neoplásicas (citologia oncótica) - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309053, 'Criptococose, cândida, aspérgilus (látex) - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309061, 'Eletroforese de proteínas no líquor, com concentração - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309070, 'H. Influenzae, S. Pneumonieae, N. Meningitidis A, B e C W135 (cada) - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309088, 'Haemophilus influenzae - pesquisa de anticorpos (cada)- pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309096, 'Índice de imunoprodução (eletrof. e IgG em soro e líquor) - pesquisa e/ou dosagem'),
	(40309100, 'LCR ambulatorial rotina (aspectos cor + índice de cor + contagem global e  específica  de leucócitos e  hemácias + citologia  oncótica + proteína + glicose + cloro + eletroforese  com  concentração + IgG + reações para neurocisticercose (2) + reações para'),
	(40309118, 'LCR hospitalar neurologia (aspectos cor + índices de cor + contagem global e específica de  leucócitos e hemácias + proteína + glicose + cloro + reações para neurocisticercose (2) + reações para  neurolues (2) + bacterioscopia + cultura + látex para bacté'),
	(40309126, 'LCR pronto socorro (aspectos cor + índice  de cor + contagem  global  e  específica  de  leucócitos  e hemácias + proteína + glicose + cloro + lactato + bacterioscopia + cultura + látex para bactérias)'),
	(40309134, 'Pesquisa de bandas oligoclonais por isofocalização - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309142, 'Proteína mielina básica, anticorpo anti - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309150, 'Punção cisternal subocciptal com manometria para coleta de líquido cefalorraqueano'),
	(40309169, 'Punção lombar com manometria para coleta de líquido cefalorraqueano'),
	(40309177, 'Nonne-Apple; reação'),
	(40309185, 'Takata-Ara, reação'),
	(40309193, 'Babesia microti em líquor'),
	(40309207, 'Coccidióides em líquor'),
	(40309215, 'Líquor cisticercose Western Blot'),
	(40309223, 'Líquor encefalite, painel'),
	(40309231, 'Líquor imunofenotipagem T e B'),
	(40309240, 'Líquor índice IgG para citomegalovirus'),
	(40309258, 'Líquor látex para meningite'),
	(40309266, 'Aminoácidos no líquido cefalorraquidiano'),
	(40309304, 'Anticorpo antiespermatozóide - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309312, 'Espermograma (caracteres físicos, pH, fludificação, motilidade, vitalidade, contagem e morfologia)'),
	(40309320, 'Espermograma e teste de penetração "in vitro", velocidade penetração vertical, colocação  vital, teste de revitalização'),
	(40309401, 'Clements, teste'),
	(40309410, 'Espectrofotometria de líquido amniótico'),
	(40309428, 'Fosfolipídios (relação lecitina/esfingomielina) - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309436, 'Maturidade pulmonar fetal - - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309444, 'Rotina do líquido amniótico-amniograma (citológico espectrofotometria, creatinina e teste de clements)'),
	(40309452, 'Azul de nilo no líquido amniótico'),
	(40309509, 'Cristais com luz polarizada - pesquisa e/ou dosagem em líquidos orgânicos'),
	(40309517, 'Ragócitos, pesquisa'),
	(40309525, 'Rotina líquido sinovial - caracteres físicos, citologia, proteínas, ácido úrico, látex p/ F.R., BACT.'),
	...
	(40310051, 'B.A.A.R. (Ziehl ou fluorescência, pesquisa direta e após homogeneização) - pesquisa'),
	...
	(40310167, 'Cultura quantitativa de secreções pulmonares, quando necessitar tratamento prévio c/ N.C.A.'),
	(40310175, 'Cultura, fezes: salmonela, shigellae e esc. Coli enteropatogênicas, enteroinvasora (sorol. Incluída) + campylobacter SP. + E. Coli entero-hemorrágica'),
	(40310183, 'Cultura, fezes: salmonella, shigella e escherichia coli enteropatogênicas (sorologia incluída)'),
	...
	(40310418, 'Antibiograma (teste de sensibilidade e antibióticos e quimioterápicos), por bactéria - não automatizado'),
	...
	(40310485, 'Helicobacter pylori, cultura de biópsia'),
	(40310493, 'Herpes para imunofluorescência direta'),
	(40310507, 'Mycobactéria amplificação de DNA (PCR)'),
	(40310515, 'Pesquisa de antígenos bacterianos'),
	(40310523, 'Pesquisa de antígenos entamoeba histolytica'),
	(40310531, 'Poder bactericida (pós administração de antibiótico)'),
	(40310540, 'Protozoários, cultura para'),
	(40310558, 'Streptococcus B hemol cultura qualquer material'),
	(40310566, 'Teste de sensibilidade mycobacterium cepas de bactérias'),
	(40310574, 'Trichomonas, cultura para'),
	(40310582, 'Yersinia enterocolitica'),
	(40310590, 'Antígenos bacterianos / vários materiais'),
	(40310604, 'Antifungigrama'),
	(40310612, 'Chlamydia trachomatis, exame direto para vários materiais'),
	(40310620, 'Cultura, para agentes multirresistentes, vários materiais'),
	(40310639, 'Demodex folliculorum, pesquisa'),
	(40310647, 'Cultura quantitativa queimados (pele)'),
	(40310655, 'Influenza vírus, isolamento'),
	(40310663, 'Lactamase, teste da cepa'),
	(40310671, 'Cultura em leite materno'),
	(40310680, 'Acanthamoeba, pesquisa, vários materiais'),
	...
	(40311015, 'Ácido cítrico - pesquisa e/ou dosagem na urina'),
	(40311023, 'Ácido homogentísico - pesquisa e/ou dosagem na urina'),
	(40311031, 'Alcaptonúria  - pesquisa e/ou dosagem na urina'),
	...
	(40311074, 'Coproporfirina III - pesquisa e/ou dosagem na urina'),
	(40311082, 'Corpos cetônicos, pesquisa - na urina'),
	(40311090, 'Cromatografia de açúcares - na urina'),
	(40311104, 'Dismorfismo eritrocitário, pesquisa (contraste de fase) - na urina'),
	(40311112, 'Erros inatos do metabolismo baterias de testes químicos de triagem em urina (mínimo de 6 testes)'),
	...
	(40311180, 'Pesquisa ou dosagem de um componente urinário'),
	(40311198, 'Porfobilinogênio, pesquisa - na urina'),
	(40311201, 'Proteínas de Bence Jones, pesquisa - na urina'),
	...
	(40311260, 'Acidez titulável - pesquisa e/ou dosagem na urina'),
	(40311279, 'Bartituratos - pesquisa e/ou dosagem na urina'),
	(40311287, 'Beta mercapto-lactato-disulfidúria,pesquisa - na urina'),
	(40311295, 'Contagem sedimentar de Addis'),
	(40311309, 'Eletroforese de proteínas urinárias, com concentração'),
	(40311317, 'Fenilcetonúria, pesquisa'),
	(40311325, 'Histidina, pesquisa - na urina'),
	(40311333, 'Inclusão citomegálica, pesquisa de células com - na urina'),
	(40311341, 'Mioglobina, pesquisa - na urina'),
	(40311350, 'Osmolalidade, determinação - na urina'),
	(40311368, 'Prova de concentração (Fishberg ou Volhard) - na urina'),
	(40311376, 'Prova de diluição - na urina'),
	...
	(40311430, 'Hemoglobina livre na urina (amostra isolada)'),
	(40311449, 'MDMA (Êxtase), triagem (urina)'),
	(40311457, 'Pesquisa de espermatozóide na urina'),
	(40311465, 'Substâncias redutoras, pesquisa (urina)'),
	(40311473, 'Teste de concentração urinária após DDAVP'),
	(40311481, 'Urina, pesquisa antígeno para Legionella'),
	(40311490, 'Urocitograma'),
	(40311503, 'Pesquisa de sulfatídeos e material metacromático na urina'),
	(40312011, 'Cristalização do muco cervical, pequisa'),
	(40312020, 'Cromatina sexual, pesquisa'),
	(40312046, 'Iontoforese para a coleta de suor, com dosagem de cloro'),
	(40312054, 'Muco-nasal, pesquisa de eosinófilos e mastócitos'),
	(40312062, 'Perfil  metabólico  para  litíase  renal: sangue (Ca, P, AU, Cr) urina: (Ca, AU, P, citr, pesq. Cistina) AMP-cíclico'),
	(40312070, 'Gastroacidograma - secreção basal para 60" e 4 amostras após o estímulo (fornecimento de material inclusive tubagem), teste'),
	(40312089, 'Hollander (inclusive tubagem), teste'),
	(40312097, 'Pancreozima - secretina no suco duodenal, teste'),
	(40312100, 'Rotina da biles A, B, C e do suco duodenal (caracteres físicos e microscópicos inclusive tubagem)'),
	(40312119, 'Tubagem duodenal'),
	(40312127, 'Perfil reumatológico (ácido úrico, eletroforese de proteínas, FAN, VHS, prova do látex P/F. R, W. Rose)'),
	(40312135, 'pH - tornassol - pesquisa'),
	(40312143, 'Prova atividade de febre reumática (aslo, eletroforese de proteínas, muco-proteínas e proteína "C" reativa)'),
	(40312151, 'Provas de função hepática (bilirrubinas, eletroforese de proteínas, FA, TGO, TGP e Gama-PGT)'),
	(40312160, 'Teste do pezinho básico (TSH neonatal + fenilalanina + eletroforese de Hb para triagem de hemopatias)'),
	...
	(40312186, 'Cálculo biliar, análise química'),
	...
	(40312240, 'Isolamento de microorganismos especiais'),
	(40312259, 'Lavado gástrico, colheita por'),
	(40312267, 'Líquido pleural citológico'),
	(40312275, 'Pepsinogenio 2'),
	(40312283, 'Perfil para líquidos biológicos'),
	(40312291, 'Proteína 14-3-3'),
	(40312305, 'Prova de restrição calórica'),
	(40312313, 'Prova fármaco-dinâmica'),
	(40312321, 'Semiologia para impotência'),
	(40312330, 'Sexagem fetal'),
	(40312348, 'Sorologia doença arranhadura de gato'),
	(40312364, 'Vírus respiratório, triagem aspirado nasofaringeo'),
	(40312372, 'Vírus respiratório, triagem lavado nasofaringeo'),
	...
	(40312410, 'Teste respiratório da xylose'),
	(40312429, 'Teste respiratório de intolerância a frutose'),
	(40312437, 'Teste respiratório de intolerância a glicose'),
	(40312445, 'Teste respiratório de intolerânica a lactose'),
	(40312453, 'Teste respiratório de intolerância a sacarose'),
	(40312461, 'Teste respiratório de intolerância a sorbitol'),
	(40312470, 'Teste respiratório da lactulose (8 amostras)'),
	(40313018, 'Ácido delta aminolevulínico (para chumbo inorgânico) - pesquisa e/ou dosagem'),
	(40313026, 'Ácido delta aminolevulínico desidratase (para chumbo inorgânico) - pesquisa e/ou dosagem'),
	(40313034, 'Ácido fenilglioxílico (para estireno) - pesquisa e/ou dosagem'),
	(40313042, 'Ácido hipúrico (para tolueno) - pesquisa e/ou dosagem'),
	(40313050, 'Ácido mandélico (para estireno) - pesquisa e/ou dosagem'),
	(40313069, 'Ácido metilhipúrico (para xilenos) - pesquisa e/ou dosagem'),
	(40313077, 'Ácido salicílico - pesquisa e/ou dosagem'),
	(40313085, 'Azida sódica, teste da (para deissulfeto de carbono)'),
	(40313093, 'Carboxihemoglobina (para monóxido de carbono  diclorometano) - pesquisa e/ou dosagem'),
	(40313107, 'Chumbo - pesquisa e/ou dosagem'),
	(40313115, 'Colinesterase (para carbamatos  organofosforados) - pesquisa e/ou dosagem'),
	(40313123, 'Coproporfirinas (para chumbo inorgânico) - pesquisa e/ou dosagem'),
	(40313131, 'Dialdeído malônico - pesquisa e/ou dosagem'),
	(40313140, 'Etanol - pesquisa e/ou dosagem'),
	(40313158, 'Fenol (para benzeno, fenol) - pesquisa e/ou dosagem'),
	(40313166, 'Flúor (para fluoretos) - pesquisa e/ou dosagem'),
	(40313174, 'Formaldeído - pesquisa e/ou dosagem'),
	(40313182, 'Meta-hemoglobina (para anilina nitrobenzeno) - pesquisa e/ou dosagem'),
	(40313190, 'Metais Al, As, Cd, Cr, Mn, Hg, Ni, Zn, Co, outro (s) absorção atômica (cada) - pesquisa e/ou dosagem'),
	(40313204, 'Metanol - pesquisa e/ou dosagem'),
	(40313212, 'P-aminofenol (para anilina) - pesquisa e/ou dosagem'),
	(40313220, 'P-nitrofenol (para nitrobenzeno) - pesquisa e/ou dosagem'),
	(40313239, 'Protoporfirinas livres (para chumbo inorgânico) - pesquisa e/ou dosagem'),
	(40313247, 'Protoporfirinas Zn (para chumbo inorgânico) - pesquisa e/ou dosagem'),
	(40313255, 'Selênio, dosagem'),
	(40313263, 'Sulfatos orgânicos ou inorgânicos, pesquisa (cada)'),
	(40313271, 'Tiocianato (para cianetos  nitrilas alifáticas) - pesquisa e/ou dosagem'),
	(40313280, 'Triclorocompostos totais (para tetracloroetileno, tricloroetano, tricloroetileno) - pesquisa e/ou dosagem'),
	(40313298, 'Ácido acético - pesquisa e/ou dosagem'),
	(40313301, 'Ácido metil malônico - pesquisa e/ou dosagem'),
	...
	(40314014, 'Apolipoproteína E, genotipagem'),
	(40314022, 'Citomegalovírus - qualitativo, por PCR - pesquisa'),
	(40314030, 'Citomegalovírus - quantitativo, por PCR - pesquisa'),
	...
	(40314189, 'Parvovírus por PCR - pesquisa'),
	(40314197, 'Proteína S total + livre, dosagem'),
	(40314200, 'Rubéola por PCR - pesquisa'),
	(40314219, 'Sífilis por PCR - pesquisa'),
	(40314227, 'Toxoplasmose por PCR - pesquisa'),
	...
	(40314308, 'Quantificação de outros agentes por PCR'),
	(40314316, 'SCIH tipagem molecular de bactérias'),
	(40314324, 'Clonalidade para células B, detecção por PCR, vários materiais'),
	(40314332, 'Clonalidade para células T, detecção por PCR, sangue total'),
	(40314340, 'Coronavirus, detecção por PCR'),
	(40314359, 'Epstein BARR vírus por PCR'),
	(40314367, 'Hepatite B, genotipagem'),
	(40314375, 'Herpes vírus humano 1,2 por PCR'),
	(40314383, 'Herpes vírus humano 6,7 por PCR'),
	(40314391, 'Herpes vírus humano 8 por PCR'),
	(40314405, 'Herpes vírus zoster, (Varicella) por PCR'),
	(40314413, 'Hepatite C quantitativo por TMA'),
	(40314421, 'Papiloma virus humano, genotipagem'),
	(40314430, 'HLA B27, fenotipagem'),
	(40314448, 'HPV oncoproteínas virais E6/E7, pesquisa'),
	(40314456, 'Clostridium Difficile Toxigênico, pesquisa DNA, fezes'),
	(40314472, 'Detecção de bactérias e fungos em sangue periférico (Septifast), por PCR'),
	(40314480, 'Análise de quimerismo pós transplante (STR), cada'),
	(40314499, 'Teste de biologia molecular para hiperplasia adrenal congênita'),
	(40314502, 'HIV amplificação do DNA (PCR)'),
	(40314510, 'Pesquisa de mutação pré-core vírus hepatite B'),
	(40314529, 'TMA qualitativo para hepatite C'),
	(40314537, 'Chlamydia - PCR, amplificação de DNA'),
	(40314545, 'Mycobactéria amplificação de DNA (PCR)'),
	...
	(40316025, '3 alfa androstonediol glucoronídeo (3ALFDADIOL) - pesquisa e/ou dosagem'),
	...
	(40316327, 'Gonadotrófico coriônico, hormônio (HCG) - pesquisa e/ou dosagem'),
	...
	(40316521, 'Tireoestimulante, hormônio (TSH) - pesquisa e/ou dosagem'),
	...
	(40316564, 'Vasopressina (ADH) - pesquisa e/ou dosagem'),
	...
	(40316610, 'Anabolizantes esteróides na urina (amostra isolada)'),
	(40316629, 'Androsterona'),
	(40316637, 'Angiotensina II'),
	(40316645, 'Anticorpos antinucleossomo, soro'),
	(40316653, 'Antígenos prostático específico complexado, soro'),
	(40316661, 'Aquaporina 4 (AQP4)'),
	(40316670, 'Capacidade de ligação da vitamina B12'),
	(40316688, 'Corticosterona'),
	(40316696, 'CRH'),
	(40316700, 'Cromogranina A'),
	(40316718, 'Cromogranina A, soro'),
	(40316726, 'Curva de peptídeo C e insulina'),
	(40316734, 'Curva glicêmica (7 dosagens) via oral ou endovenosa ou potencializada'),
	(40316742, 'DCB'),
	(40316750, 'Dehidro rodamina teste de oxidação'),
	...
	(40316815, 'Fator II de crescimento, símile a insulina'),
	(40316823, 'Fator liberador hormônio do crescimento GH'),
	(40316831, 'Glicose após estímulo/glucagon'),
	(40316840, 'Glicosuria fracionada (4 dosagens)'),
	(40316858, 'Globulina ligadora do cortisol'),
	(40316866, 'Gonadotrofina coriônica - hemaglutinação ou látex'),
	(40316874, 'HGH estímulo com exercício e clonidina, HGH'),
	(40316882, 'Hipoglicemiantes (sulfonilurea painel)'),
	(40316890, 'Hormônio anti muleriano'),
	(40316904, 'Hormônio estimulador do alfa melanócito'),
	(40316912, 'ICA 512'),
	(40316920, 'IGFBP-1'),
	(40316939, 'IGFBP-2'),
	(40316947, 'Índice de recuperação da tireoglobulina'),
	(40316955, 'Insulina livre'),
	(40316963, 'Insulina total e livre'),
	(40316971, 'Megateste'),
	(40316980, 'Melanócito estimulante hormônio (MSH)'),
	(40316998, 'Melatonina (sangue)'),
	(40317013, 'Monitorização de glicose 1 dia'),
	(40317021, 'Monitorização de glicose 2 dias'),
	(40317030, 'Monitorização de glicose 3 dias'),
	(40317048, 'PCI e TG após TSH recombinante'),
	(40317056, 'Pregnenolona, dosagem'),
	(40317064, 'Pró-insulina'),
	(40317072, 'Proteína ligadora hormônio de crescimento GH'),
	(40317080, 'Prova de sobrecarga de glicose para insulina'),
	(40317099, 'Receptor fator de crescimento epidermal'),
	(40317102, 'Sub-unidade Alfa hormônios glicoproteicos'),
	(40317110, 'Sub-unidade Beta da gonadotrofina coriônica livre'),
	(40317129, 'Teste com ACTH para dosagem de DHEA'),
	(40317137, 'Teste com cálcio para dosar calcitonina'),
	(40317145, 'Teste com cortrosina para 17 alfa hidroxiprogesterona'),
	(40317153, 'Teste com estímulo para renina após captopril'),
	(40317161, 'Teste de estímulo com cortrosina para11 desoxicortisol'),
	(40317170, 'Teste de estímulo com TRH para dosagem de GH'),
	(40317188, 'Teste de estímulo do GH pela insulina (4 dosagens de GH)'),
	...
	(40317269, 'Curva insulínica e glicêmica (2 dosagens)'),
	(40317277, 'Curva insulínica e glicêmica (3 dosagens)'),
	(40317285, 'Curva insulínica e glicêmica (4 dosagens)'),
	(40317293, 'Curva insulínica e glicêmica (5 dosagens)'),
	(40317307, 'Curva insulínica e glicêmica (7 dosagens)'),
	(40317315, 'Curva insulínica e glicêmica (8 dosagens)'),
	(40317323, 'Curva insulínica e glicêmica (9 dosagens)'),
	(40317331, 'Curva glicêmica prolongada (7 dosagens)'),
	(40317340, 'C-Telopeptídeo'),
	(40317366, 'Grelina, polipeptídeo liberador da gastrina, dosagem'),
	(40317374, 'Cortisol ritmo (2 dosagens)'),
	(40317382, 'Testosterona na saliva, dosagem'),
	(40317390, 'Curva insulínica e glicêmica (6 dosagens)'),
	(40317404, 'Metanefrinas urinária após clonidina'),
	(40317412, 'Paratomônio, proteína relacionada, dosagem'),
	(40317420, 'Proteína ligadora do hormônio de crescimento (HGH), dosagem'),
	(40317439, 'Restrição hídrica, teste'),
	(40317447, 'Teste de estímulo para cortisol com insulina (cada)'),
	...
	(40317480, 'Prova de Testosterona, após HCG sem fornecimento do medicamento (por dosagem)'),
	(40319016, 'APT teste'),
	...
	(40319253, 'Prova funcional DDAVP - Von Willebrand (1hora)'),
	...
	(40319300, 'Viscosidade plasmática ou sanguínea'),
	...
	(40319466, 'Fibrinogênio quantitativo, nefelometria'),
	(40319474, 'Hemoglobinopatias, neonatal, sangue periférico'),
	(40319482, 'Imunofenotipagem Imunod nível 2'),
	...
	(40321053, 'Dióxido de carbono, dosagem'),
	(40321061, 'Dosagem de cafeína'),
	(40321070, 'Dosagem de cortisona'),
	(40321088, 'Dosagem de eletrólitos (sol. diálise)'),
	...
	(40321152, 'Ehrlichia chaffeensis, sorologia para'),
	(40321169, 'Estrôncio, dosagem'),
	(40321177, 'Extase'),
	(40321185, 'Fungos morfologia/bioquímica'),
	(40321193, 'Haloperidol, dosagem'),
	(40321207, 'Homocistina, pesquisa de'),
	(40321215, 'Identificação de bactérias por método sorológico/bioquímico'),
	...
	(40321339, 'Kunkel (sulfato de zinco), reação de'),
	...
	(40321398, 'Metanefrinas plasmáticas'),
	...
	(40321649, 'Toxina butoliníca A, anticorpo'),
	(40321657, 'Trifluoperazina, dosagem soro'),
	(40321665, 'Triptase, dosagem'),
	(40321673, 'Vanádio, dosagem'),
	...
	(40321762, 'Colinesterase com inibição de Dibucaina'),
	...
	(40321959, 'Manganes eritrocitário, dosagem'),
	...
	(40322033, 'Serotonina, dosagem urinária'),
	...
	(40322238, 'Piretróides inseticidas, dosagem'),
	(40322246, 'Receptor solúvel de transferrina'),
	(40322254, 'Superoxido dismutase, dosagem'),
	(40322262, 'Vitamina B5 (Pantofenato), dosagem'),
	(40322270, 'Ácido cítrico (Citrato), dosagem sangue'),
	(40322289, 'Ácido cítrico (Citrato), dosagem esperma'),
	(40322297, 'Creatina eritrocitária'),
	...
	(40322440, 'Cocaína, dosagem, sangue total'),
	...
	(40322548, 'Catalase eritrocitária'),
	...
	(40323226, 'Coclea autoac(s), soro'),
	(40323234, 'Coxsackie A,'),
	(40323242, 'Detecção antígeno histoplasma (urina)'),
	(40323250, 'Detecção de CMV para RNA nasba'),
	(40323269, 'Detecção de enterovirus no líquor'),
	(40323277, 'Detecção de Niemann Pick tipo Cc'),
	(40323285, 'Detecção/tipagem herpes vírus 1/2 líquor'),
	(40323293, 'Difteria, sorologia'),
	(40323307, 'Entamoeba histolytica, pesquisa (abscesso hepático)'),
	(40323315, 'Epstein BARR antígeno nuclear - IgM'),
	(40323323, 'Esquisocitos, pesquisa de'),
	(40323331, 'Febre amarela, sorologia'),
	(40323340, 'Febre do mediterrâneo'),
	...
	(40323420, 'Herpes vírus 7 - IgG/IgM'),
	(40323439, 'Herpes vírus, citologia (pesquisa de células herpet) ou IFD'),
	(40323447, 'Hipersensibilidade pneumonite triagem'),
	(40323455, 'Histoplasma, pesquisa de'),
	(40323463, 'HIV amplificação do DNA (PCR)'),
	...
	(40323544, 'Neuromielite óptica (Devic)'),
	(40323552, 'Neuropatia motora, painel'),
	(40323560, 'Painel para meningoencefalite (líquor)'),
	(40323579, 'Perfil para anticorpos anti gangliosídeo'),
	(40323587, 'Pesquisa antígeno da legionella'),
	(40323595, 'Pesquisa de adenovirus'),
	(40323609, 'Pesquisa de antígenos de giardia lamblia'),
	(40323617, 'Pesquisa de células Tzanck'),
	(40323625, 'Pesquisa de influenza A e B por imunofluorescência'),
	(40323633, 'Pesquisa de mutação pré-core vírus hepatite B'),
	...
	(40323706, 'Proteína C antígeno'),
	(40323714, 'Proteína ligadora fração C4 complemento'),
	(40323722, 'Proteína para ribossomal anticorpo soro'),
	(40323730, 'Reatividade contra painel de linfócitos'),
	...
	(40323820, 'Tetano, sorologia para'),
	(40323838, 'TMA qualitativo para hepatite C'),
	(40323846, 'Tularemia, anti'),
	(40323854, 'Unidades avançadas - triagem HCG'),
	(40323862, 'Vírus respiratório, pesquisa rápida'),
	(40323870, 'West Nile sorologia líquor LCR'),
	(40323889, 'ZAP-70'),
	(40323897, 'Anticorpos antidifteria'),
	(40323900, 'Anticorpos antitétano'),
	(40323919, 'Teste rápido para detecção de HIV em gestante'),
	(40323927, 'Filagrina, anticorpos IgG'),
	(40323935, 'Bartonella, anticorpos IgG'),
	(40323943, 'Bartonella, anticorpos IgM'),
	(40323951, 'Borrelia burgdorferi em líquor, anticorpos IgG'),
	(40323960, 'Borrelia burgdorferi em líquor, anticorpos IgM'),
	(40323978, 'Cadeias leves livres Kappa/Lambda em urina, dosagem'),
	(40323986, 'Calprotectina, detecção nas fezes'),
	...
	(40324060, 'Epstein BARR vírus antígeno precoce, anticorpos'),
	(40324079, 'HIV1/2, anticorpos (teste rápido)'),
	(40324087, 'Imunoglobulina M, dosagem no líquor'),
	...
	(40324184, 'Gangliosídeo 4, anticorpos'),
	(40324192, 'Antígeno NS1 do vírus da dengue, pesquisa'),
	(40324206, 'Antígenos de histocompatibilidade (séries A ou B)'),
	(40324214, 'Anticorpos contra canal de potássio regulado por voltagem'),
	(40324222, 'Fosfatidilserina, anticorpos IgG'),
	(40324230, 'Fosfatidilserina, anticorpos IgM'),
	(40324249, 'Fosfatidilserina, anticorpos IgA'),
	(40324257, 'HU (anti neurônio), anticorpos'),
	(40324265, 'Cadeias leves livres Kappa/Lambda, dosagem, sangue'),
	(40324273, 'Cadeias leves livres Kappa/Lambda, dosagem, líquor'),
	(40324281, 'Cadeias leves livres Kappa/Lambda, dosagem, urina'),
	...
	(40324338, 'Glicoproteína Beta 2, anticorpos, IgG'),
	(40324346, 'Glicoproteína Beta 2, anticorpos, IgM'),
	(40324354, 'Glicoproteína Beta 2, anticorpos, IgA'),
	...
	(40324397, 'Imunoglobulina G, líquor'),
	(40324400, 'Mitocôndria, pesquisa de anticorpos por Western Blot, soro'),
	...
	(40324443, 'Rotavírus, anticorpos'),
	(40324451, 'Antígeno HTLV III (HIV), EIE'),
	(40324460, 'Estreptococus A, sorologia'),
	(40324478, 'Imunoglobulina A, dosagem no líquor'),
	...
	(40324516, 'Células Sesary, pesquisa'),
	(40324524, 'Determinação de Apoptose'),
	...
	(40324583, 'Toxina butoliníca A, anticorpo'),
	(40324591, 'Vírus Zika - IgG'),
	(40324605, 'Vírus Zika – IgM'),
	(40324770, 'SARS-CoV-2 (Coronavírus COVID-19), pesquisa de anticorpos IgA, IgG ou IgM (cada par)'),
	(40401014, 'Transfusão (ato médico ambulatorial ou hospitalar)'),
	...
	(40402053, 'Unidade de concentrado de hemácias lavadas'),
	(40402061, 'Unidade de concentrado de plaquetas por aférese'),
	(40402070, 'Unidade de concentrado de plaquetas randômicas'),
	(40402088, 'Unidade de crioprecipitado de fator anti-hemofílico'),
	...
	(40402134, 'Irradiação de componentes hemoterápicos'),
	(40402142, 'Deleucotização de unidade de concentrado de plaquetas - entre 7 e 12 unidades'),
	(40402150, 'Unidade de concentrado de granulócitos'),
	(40402169, 'Unidade de concentrado de plaquetas (dupla centrifugação)'),
	(40402177, 'Concentrado de hemácias CMV negativos'),
	(40403017, 'Acompanhamento  hospitalar/dia  do  transplante   de  medula   óssea  por médico  hematologista  e/ou hemoterapeuta'),
	(40403025, 'Anticorpos eritrocitários naturais e imunes - titulagem'),
	(40403033, 'Aplicação de medula óssea ou células tronco'),
	(40403041, 'Coleta de células tronco de sangue de cordão umbilical para transplante de medula óssea'),
	(40403050, 'Coleta de células tronco por processadora automática para transplante de medula óssea'),
	(40403068, 'Coleta de biópsia de medula óssea por agulha'),
	(40403076, 'Coleta de medula óssea para transplante'),
	(40403084, 'Determinação de células CD34, CD45 positivas - Citômetro de Fluxo'),
	(40403092, 'Determinação de conteúdo de DNA - Citômetro de Fluxo'),
	(40403106, 'Eletroforese de hemoglobina por componente hemoterápico'),
	(40403114, 'Eletroforese de hemoglobina por unidade de sangue total'),
	(40403122, 'Exsanguíneo  transfusão'),
	(40403130, 'Fenotipagem de outros sistemas eritrocitários - por fenótipo'),
	(40403149, 'Fenotipagem de outros sistemas eritrocitários - por fenótipo - gel teste'),
	(40403157, 'Fenotipagem do sistema RH-HR (D, C, E, C E C) gel teste'),
	(40403165, 'Fenotipagem do sistema RH-HR (D, C, E, C, E)'),
	(40403173, 'Grupo sanguíneo ABO e RH - pesquisa'),
	(40403181, 'Grupo sanguíneo ABO e RH - gel teste - pesquisa'),
	(40403190, 'Identificação de anticorpos séricos irregulares antieritrocitários - método de eluição'),
	(40403203, 'Identificação de anticorpos séricos irregulares antieritrocitários - painel de hemácias enzimático'),
	(40403211, 'Identificação de anticorpos séricos irregulares antieritrocitários com painel de hemácias'),
	(40403220, 'Identificação de anticorpos séricos irregulares antieritrocitários com painel de hemácias tratadas por enzimas'),
	(40403238, 'Identificação de anticorpos séricos irregulares antieritrocitários com painel de hemácias - gel liss'),
	(40403246, 'Imunofenotipagem de subpopulações linfocitárias - Citômetro de Fluxo'),
	(40403254, 'Imunofenotipagem para classificação de leucemias - Citômetro de Fluxo'),
	...
	(40403300, 'Operação de processadora automática de sangue em aférese'),
	(40403319, 'Operação de processadora automática de sangue em autotransfusão intra-operatória'),
	(40403327, 'Pesquisa de anticorpos séricos antieritrocitários, anti-A e/ou anti-B - gel teste'),
	(40403335, 'Pesquisa de anticorpos séricos antieritrocitários, anti-A e/ou anti-B'),
	...
	(40403360, 'Pesquisa de anticorpos séricos irregulares antieritrocitários - método de eluição'),
	(40403378, 'Pesquisa de anticorpos séricos irregulares antieritrocitários a frio'),
	(40403386, 'Pesquisa de hemoglobina S por componente hemoterápico - gel teste'),
	(40403394, 'Pesquisa de hemoglobina S por unidade de sangue total - gel teste'),
	...
	(40403424, 'S. Anti-HTLV-I + HTLV-II (determinação conjunta) por componente hemoterápico'),
	(40403432, 'S. Anti-HTLV-I + HTLV-II (determinação conjunta) por unidade de sangue total'),
	(40403440, 'S. Chagas EIE por componente hemoterápico - pesquisa e/ou dosagem'),
	(40403459, 'S. Chagas EIE por unidade de sangue total - pesquisa e/ou dosagem'),
	(40403467, 'S. Hepatite B anti-HBC por componente hemoterápico - pesquisa e/ou dosagem'),
	(40403475, 'S. Hepatite B anti-HBC por unidade de sangue total - pesquisa e/ou dosagem'),
	(40403483, 'S. Hepatite C anti-HCV por componente hemoterápico - pesquisa e/ou dosagem'),
	(40403491, 'S. Hepatite C anti-HCV por unidade de sangue total - pesquisa e/ou dosagem'),
	...
	(40403564, 'S. Sífilis FTA - ABS por componente hemoterápico - pesquisa e/ou dosagem'),
	...
	(40403661, 'S. Hepatite B (HBsAg) RIE ou EIE por componente hemoterápico - pesquisa e/ou dosagem'),
	(40403670, 'S. Hepatite B (HBsAg) RIE ou EIE por unidade de sangue total - pesquisa e/ou dosagem'),
	...
	(40403769, 'TMO - determinação de HLA para transplantes de medula óssea - loci A e B'),
	(40403777, 'TMO - determinação de HLA para transplantes de medula óssea - loci DR e DQ (baixa resolução)'),
	(40403785, 'TMO - determinação de unidades formadoras de colônias'),
	(40403793, 'TMO - determinação de viabilidade de medula óssea'),
	(40403807, 'TMO - manutenção de congelamento de medula óssea ou células tronco (até 2 anos)'),
	(40403815, 'TMO - preparo de medula óssea ou células tronco periféricas para congelamento'),
	(40403823, 'TMO - preparo e filtração de medula óssea ou células tronco na coleta'),
	(40403831, 'TMO - tratamento "in vitro" de medula óssea ou células tronco por anticorpos monoclonais (purging)(4)'),
	(40403840, 'Transaminase pirúvica - TGP ou ALT por componente hemoterápico - pesquisa e/ou dosagem'),
	(40403858, 'Transaminase pirúvica - TGP ou ALT por unidade de sangue total - pesquisa e/ou dosagem'),
	(40403866, 'Transfusão fetal intra-uterina'),
	(40403874, 'Detecção de consumo de oxigênio  (O2) por unidade de concentrado de plaquetas (por unidade de concentrado de plaquetas de doador múltiplo)'),
	(40403882, 'Detecção de consumo de oxigênio (O2) por unidade de concentrado de plaquetas (por unidade de concentrado de plaquetas por aférese)'),
	...
	(40403912, 'Estimulação e mobilização de células CD34 positivas'),
	...
	(40403971, 'Imuno-hematológicos: tipificação ABO, incluindo tipagem reversa e determinação do fator RH (D), incluindo prova para D-fraco e pesquisa e identificação de anticorpos séricos irregulares antieritrocitários'),
	...
	(40404013, 'TMO - prova cruzada para histocompatibilidade de transplante de medula óssea'),
	(40404021, 'Aférese para paciente ABO incompatível'),
	(40404030, 'Antigenemia para diagnóstico de CMV pós transplante'),
	(40404048, 'Avaliação quimerismo - VNTR - doador - pré transplante'),
	(40404056, 'Avaliação quimerismo - VNTR - paciente - pré transplante'),
	(40404064, 'Avaliação quimerismo por STR - paciente - pós transplante'),
	...
	(40404110, 'PCR em tempo real para diagnóstico de adenovírus'),
	...
	(40404153, 'PCR em tempo real para os vírus para influenza e influenza'),
	(40404161, 'PCR em tempo real para vírus respiratório sincicial'),
	...
	(40404340, 'Imunofluorescência direta de pele'),
	(40404358, 'Descalcificação de tecido, anatomia patológica'),
	(40404366, 'NAT teste de ácido nucleico HIV/HCV/HBV'),
	...
	(40404390, 'Concentrado de hemácias raras congeladas'),
	(40404404, 'Fenotipagem do sistema RH-HR (D, C, E, C, E) e Kell'),
	(40404412, 'Fotoférese'),
	(40404420, 'Genotipagem completa plaquetária (HPA 1, 6 e 15)'),
	...
	(40404480, 'Granulócitos CMV negativos'),
	(40404498, 'Pesquisa de hemolisina'),
	(40404501, 'Pesquisa e identificação de anticorpos plaquetários (MAIPA)'),
	(40404510, 'Plaquetaférese CMV negativos'),
	(40404528, 'Plaquetaférese HLA compatível'),
	(40404536, 'Prova de compatibilidade para transfusão de plaquetas (MAIPA)'),
	(40404544, 'Técnicas de adsorção'),
	...
	(40501140, 'Diagnóstico genético pré-implantação por fish, por sonda'),
	...
	(40501191, 'Subcultura de pele para dosagens bioquímicas e/ou moleculares (adicional)'),
	...
	(40501248, 'CITOGENÉTICA DE MEDULA ÓSSEA'),
	(40501256, 'HER2 CISH para amplificação gênica em tumor de mama'),
	(40501264, 'Translocação PML/RARA  t(15;17) FISH em medula óssea'),
	...
	(40502090, 'Eletroforese ou cromatografia (papel ou camada delgada) para identificação de aminoácidos ou glicídios ou oligossacarídios ou sialoligossacarídios glicosaminoglicanos ou outros compostos para detecção de erros inatos do metabolismo (cada)'),
	...
	(40502139, 'Teste duplo - 1 trimestre (PAPP-A+Beta-HCG) ou outros 2 em soro ou líquido aminiótico com elaboração de laudo contendo cálculo de risco para anomalias fetais'),
	...
	(40502210, 'Terapia de reposição enzimática por infusão endovenosa, por procedimento'),
	...
	(40503825, 'Rearranjo PML/RARA  t(15;17) RQ-PCR (Quantitativo em tempo real)'),
	...
	(40503841, 'Mutação familial específica - Sequenciamento de Sanger do loccus identificado'),
	(40503844, 'Mutação familial específica - Sequenciamento de Sanger do loccus identificado'),
	(40503852, 'ALK - pesquisa de mutação'),
	...
	(40601250, 'Procedimento diagnóstico em lâminas de PAAF até 5'),
	(40601269, 'Coloração especial por coloração'),
	(40601277, 'Procedimento diagnóstico em imunofluorescência'),
	(40601285, 'Procedimento diagnóstico em painel de hibridização "in situ"'),
	...
	(40601315, 'Procedimento diagnóstico em citometria de imagens'),
	(40601323, 'Procedimento diagnóstico citopatológico em meio líquido'),
	(40601331, 'Citológico anatomia patológica, qualquer material'),
	...
	(40601382, 'DNA citometria fluxo parafina - outros materiais'),
	...
	(40701026, 'Cintilografia com hemácias marcadas'),
	...
	(40701050, 'Cintilografia do miocárdio necrose (infarto agudo)'),
	(40701069, 'Cintilografia do miocárdio perfusão - repouso'),
	(40701077, 'Cintilografia sincronizada das câmaras cardíacas - esforço'),
	(40701085, 'Cintilografia sincronizada das câmaras cardíacas - repouso'),
	(40701093, 'Fluxo sanguíneo das extremidades'),
	(40701107, 'Quantificação de "shunt" da direita para a esquerda'),
	(40701115, 'Quantificação de "shunt" periférico'),
	(40701123, 'Venografia radioisotópica'),
	(40701131, 'Cintilografia do miocárdio perfusão - estresse farmacológico'),
	(40701140, 'Cintilografia do miocárdio perfusão - estresse físico'),
	(40701158, 'Cintilografia de perfusão do miocárido, associada à Dobutamina'),
	(40702014, 'Cintilografia das glândulas salivares com ou sem estímulo'),
	(40702022, 'Cintilografia do fígado e do baço'),
	(40702030, 'Cintilografia do fígado e vias biliares'),
	(40702049, 'Cintilografia para detecção de hemorragia digestória ativa'),
	(40702057, 'Cintilografia para detecção de hemorragia digestória não ativa'),
	(40702065, 'Cintilografia para determinação do tempo de esvaziamento gástrico'),
	(40702073, 'Cintilografia para estudo de trânsito esofágico (líquidos)'),
	(40702081, 'Cintilografia para estudo de trânsito esofágico (semi-sólidos)'),
	(40702090, 'Cintilografia para pesquisa de divertículo de Meckel'),
	(40702103, 'Cintilografia para pesquisa de refluxo gastro-esofágico'),
	(40702111, 'Fluxo sanguíneo hepático (qualitativo e quantitativo)'),
	(40702120, 'Absorção de gorduras'),
	(40702138, 'Perdas proteicas'),
	(40702146, 'Cintilografia, receptores da Somatostatina com lutécio - 177'),
	(40703010, 'Cintilografia da tireóide e/ou captação (iodo - 123)'),
	(40703029, 'Cintilografia da tireóide e/ou captação (iodo - 131)'),
	(40703037, 'Cintilografia da tireóide e/ou captação (tecnécio - 99m TC)'),
	(40703045, 'Cintilografia das paratireóides'),
	(40703053, 'Cintilografia de corpo inteiro para pesquisa de metástases (PCI)'),
	(40703061, 'Teste de estímulo com TSH recombinante'),
	...
	(40704025, 'Cintilografia renal dinâmica com diurético'),
	(40704033, 'Cintilografia renal estática (quantitativa ou qualitativa)'),
	...
	(40704084, 'Determinação do fluxo plasmático renal'),
	(40704092, 'Renograma'),
	(40705013, 'Cintilografia do sistema retículo-endotelial (medula óssea)'),
	(40705021, 'Demonstração do sequestro de hemácias pelo baço'),
	(40705030, 'Determinação da sobrevida de hemácias'),
	(40705048, 'Determinação do volume eritrocitário'),
	(40705056, 'Determinação do volume plasmático'),
	(40705064, 'Teste de absorção de vitamina B12 com cobalto - 57 (teste de Schilling)'),
	(40706010, 'Cintilografia óssea (corpo total)'),
	(40706028, 'Fluxo sanguíneo ósseo'),
	(40707016, 'Cintilografia cerebral'),
	(40707024, 'Cintilografia cerebral com FDG-18 F, em câmara hibrída'),
	(40707032, 'Cintilografia de perfusão cerebral'),
	(40707040, 'Cisternocintilografia'),
	(40707059, 'Cisternocintilografia para pesquisa de fístula liquórica'),
	(40707067, 'Fluxo sanguíneo cerebral'),
	(40707075, 'Mielocintilografia'),
	(40707083, 'Ventrículo-cintilografia'),
	(40707091, 'Cintilografia perfusão cerebral para avaliação de transportadores de dopamina'),
	(40708012, 'Cintilografia com análogo de somatostatina'),
	...
	(40708055, 'Cintilografia de corpo total com FDG-18 F, em câmara híbrida'),
	(40708063, 'Cintilografia de mama (bilateral)'),
	(40708071, 'Demarcação radioisotópica de lesões tumorais'),
	(40708080, 'Detecção intraoperatória radioguiada de lesões tumorais'),
	(40708098, 'Detecção intraoperatória radioguiada de linfonodo sentinela'),
	(40708101, 'Linfocintilografia'),
	(40708110, 'Quantificação da captação pulmonar com gálio-67'),
	(40708128, 'PET dedicado oncológico'),
	(40709019, 'Cintilografia para detecção de aspiração pulmonar'),
	...
	(40710050, 'Tratamento de hipertireoidismo-bócio nodular tóxico (Graves)'),
	(40710068, 'Tratamento de hipertireoidismo-bócio nodular tóxico (Plummer)'),
	(40710076, 'Tratamento de metástases ósseas (estrôncio-90)'),
	(40710084, 'Tratamento de metástases ósseas (samário-153)'),
	(40710092, 'Tratamento de tumores neuroendócrinos'),
	...
	(40801047, 'RX - Orelha, mastóides ou rochedos - bilateral'),
	...
	(40801101, 'RX - Arcos zigomáticos ou malar ou apófises estilóides'),
	(40801110, 'RX - Articulação temporomandibular - bilateral'),
	(40801128, 'RX - Adenóides ou cavum'),
	(40801136, 'RX - Panorâmica de mandíbula (ortopantomografia)'),
	(40801144, 'RX - Teleperfil em cefalostato - sem traçado'),
	(40801152, 'RX - Teleperfil em cefalostato - com traçado'),
	(40801160, 'RX - Arcada dentária (por arcada)'),
	(40801179, 'RX - Radiografia peri-apical'),
	(40801187, 'RX - Radiografia oclusal'),
	(40801195, 'RX - Planigrafia linear de crânio ou sela túrcica ou face ou mastóide'),
	...
	(40802060, 'RX - Coluna lombo-sacra - 5 incidências'),
	(40802078, 'RX - Sacro-coccix'),
	(40802086, 'RX - Coluna dorso-lombar para escoliose'),
	(40802094, 'RX - Coluna total para escoliose (telespondilografia)'),
	(40802108, 'RX - Planigrafia de coluna vertebral (dois planos)'),
	...
	(40805069, 'RX - Planigrafia de tórax, mediastino ou laringe'),
	...
	(40806057, 'RX - Esôfago - hiato - estômago e duodeno'),
	(40806065, 'RX - Trânsito e morfologia do delgado'),
	(40806073, 'RX - Estudo do delgado com duplo contraste'),
	(40806081, 'RX - Clister ou enema opaco (duplo contraste)'),
	(40806090, 'RX - Defecograma'),
	(40806103, 'RX - Colangiografia intra-operatória'),
	(40806111, 'RX - Colangiografia pós-operatória (pelo dreno)'),
	...
	(40808050, 'RX - Ampliação ou magnificação de lesão mamária'),
	(40808068, 'Marcação pré-cirúrgica por estereotaxia, orientada por imagem - por mama (já inclui exame de base)'),
	(40808084, 'Punção ou biópsia mamária percutânea por agulha fina orientada por imagem (já inclui o exame de base)'),
	(40808092, 'Biópsia percutânea de fragmento mamário (core biopsy) orientada por US ou RX - agulha grossa'),
	...
	(40808130, 'Densitometria óssea - rotina: coluna e fêmur (ou dois segmentos)'),
	(40808149, 'Densitometria óssea - corpo inteiro (avaliação de massa óssea ou de composição corporal)'),
	(40808157, 'RX - Avaliação de fraturas vertebrais por DXA'),
	(40808165, 'Planigrafia de osso'),
	(40808173, 'Xeromamografia'),
	(40808181, 'Biópsia de mama, dirigida por RM'),
	(40808190, 'Marcação pré-cirúrgica por nódulo - máximo de 3 nódulos por mama, por estereotaxia (não inclui exame de imagem)'),
	(40808200, 'MARCAÇÃO PRÉ-CIRÚRGICA POR NÓDULO - MÁXIMO DE 3 NÓDULOS POR MAMA, POR US (NÃO INCLUI EXAME DE IMAGEM)'),
	...
	(40808246, 'Punção ou biópsia mamária percutânea por agulha fina orientada por TC (não inclui o exame de base)'),
	(40808254, 'Biópsia percutânea de fragmento mamário por agulha grossa (core biopsy) orientada por estereotaxia (não inclui o exame de imagem)'),
	...
	(40808300, 'Mamotomia por RM (não inclui o exame de imagem)'),
	...
	(40809099, 'Punção biópsia/aspirativa de órgão ou estrutura orientada por RX, US ou CT (acrescentar o exame base)'),
	(40809102, 'Drenagem percutânea orientada por RX (acrescentar o exame de base)'),
	(40809110, 'Broncografia (por punção ou entubação traqueal)'),
	(40809129, 'Broncografia unilateral'),
	(40809137, 'Pneumoperitônio (RX)'),
	(40809145, 'Colocação de marcador de local da intervenção'),
	...
	(40810038, 'Colheita seletiva de sangue para dosagem hormonal'),
	...
	(40812014, 'Aortografia abdominal por punção translombar'),
	...
	(40812090, 'Flebografia retrógrada por cateterismo - unilateral'),
	...
	(40813010, 'Ablação percutânea de tumor torácico (qualquer método)'),
	(40813029, 'Ablação percutânea de tumor hepático (qualquer método) - metodo intervencionista/terapêutico por imagem'),
	(40813037, 'Ablação percutânea de tumor ósseo (qualquer método)'),
	(40813045, 'Ablação percutânea de tumor (qualquer método)'),
	...
	(40813401, 'Aterectomia percutânea orientada por RX'),
	(40813410, 'Drenagem percutânea de coleção pleural'),
	(40813428, 'Drenagem percutânea de pneumotórax'),
	...
	(40813576, 'Embolização de fístula arteriovenosa em cabeça, pescoço ou coluna - por vaso'),
	...
	(40813614, 'Embolização pulmonar para tratamento de fístula arteriovenosa ou outra situação'),
	...
	(40813657, 'Embolização esplênica para tratamento de hiperesplenismo ou outra situação'),
	...
	(40813746, 'Embolização de artéria uterina para tratamento de mioma ou outras situações'),
	(40813754, 'Embolização de veia espermática para tratamento de varicocele'),
	(40813762, 'Embolização de veias ovarianas para tratamento de varicocele'),
	(40813770, 'Embolização definitiva não especificada acima - por vaso'),
	...
	(40813886, 'Pielografia percutânea orientada por RX, US, TC ou RM'),
	(40813894, 'Exérese percutânea de tumor benigno orientada por RX, US, TC ou RM'),
	(40813908, 'Quimioterapia por cateter de tumor de cabeça e pescoço'),
	(40813916, 'Quimioembolização para tratamento de tumor hepático'),
	(40813924, 'Quimioterapia por cateter intra-arterial'),
	(40813932, 'TIPS - anastomose porto-cava percutânea para tratamento de hipertensão portal'),
	...
	(40813967, 'Tratamento de pseudoaneurisma por compressão com US-Doppler'),
	(40813975, 'Tratamento do vasoespasmo pós-trauma'),
	(40813983, 'Trombectomia mecânica para tratamento de TEP'),
	(40813991, 'Trombectomia mecânica venosa'),
	(40814017, 'Trombectomia medicamentosa para tratamento de TEP'),
	(40814025, 'Trombólise medicamentosa arterial ou venosa - por vaso'),
	(40814033, 'Trombólise medicamentosa arterial ou venosa para tratamento de isquemia mesentérica'),
	(40814041, 'Trombólise medicamentosa em troncos supra-aórticos e intracranianos'),
	(40814050, 'Repermeabilização tubária para tratamento de infertilidade'),
	(40814068, 'Retirada percutânea de cálculos biliares orientada por RX, US ou TC'),
	(40814076, 'Retirada percutânea de cálculos renais orientada por RX, US ou TC'),
	...
	(40814122, 'Trituração de calcificação tendínea orientada por RX ou US'),
	(40814130, 'Sinusografia (abscessografia)'),
	(40814149, 'Paracentese orientada por RX ou US'),
	(40814157, 'Manipulação de drenos pós-drenagem (orientada por RX, TC, US ou RM)'),
	(40814165, 'Esclerose percutânea de nódulos benignos dirigida por RX, US, TC ou RM'),
	(40814173, 'Escleroterapia de cistos (renais, hepáticos, ovarianos), orientada por imagem'),
	(40901017, 'US - Globo ocular - bilateral'),
	(40901025, 'US - Globo ocular com Doppler colorido - bilateral'),
	(40901033, 'US - Glândulas salivares (todas)'),
	(40901041, 'US - Torácico extracardíaco'),
	(40901050, 'Ecodopplercardiograma com contraste intracavitário'),
	...
	(40901092, 'Ecodopplercardiograma transesofágico (inclui transtorácico)'),
	...
	(40901130, 'US - Abdome superior (fígado, vias biliares, vesícula, pâncreas e baço)'),
	(40901149, 'US - Retroperitônio (grandes vasos ou adrenais)'),
	(40901157, 'Aparelho urinário feminino (rins, ureteres e bexiga)'),
	(40901165, 'Aparelho urinário masculino (rins, ureteres, bexiga e próstata)'),
	(40901173, 'US - Abdome inferior masculino (bexiga, próstata e vesículas seminais)'),
	(40901181, 'US - Abdome inferior feminino (bexiga, útero, ovário e anexos)'),
	(40901190, 'US - Dermatológico - pele e subcutâneo'),
	(40901203, 'US - Órgãos superficiais (tireóide ou escroto ou pênis ou crânio)'),
	(40901211, 'US - Estruturas superficiais (cervical ou axilas ou músculo ou tendão)'),
	...
	(40901360, 'Doppler colorido de vasos cervicais arteriais bilateral (carótidas e vertebrais)'),
	(40901378, 'Doppler colorido de vasos cervicais venosos bilateral (subclávias e jugulares)'),
	...
	(40901440, 'Doppler colorido peniano com fármaco-indução'),
	...
	(40901491, 'US - Tridimensional - acrescentar ao exame de base'),
	(40901505, 'US - Obstétrica: perfil biofísico fetal'),
	(40901513, 'Doppler colorido de artérias penianas (sem fármaco indução)'),
	(40901521, 'Ultrassonografia biomicroscópica - monocular'),
	(40901530, 'Ultrassonografia diagnóstica - monocular'),
	(40901548, 'Doppler convencional órgão/estrutura isolada'),
	(40901556, 'Ecocardiografia fetal gestação múltipla'),
	(40901564, 'Ecoencefalograma'),
	(40901572, 'Ultrassom com doppler abdôme total e pelve feminino'),
	(40901580, 'US - Estudo sonográfico dinâmico das vias urinárias (masculino)'),
	(40901599, 'US - Estudo sonográfico dinâmico das vias urinárias (feminino)'),
	...
	(40901637, 'US - Ecocardiograma com Doppler convencional - artérias'),
	(40901645, 'US - Ecocardiograma com Doppler convencional - carótidas'),
	...
	(40901688, 'US - Adicional de reconstrução 3D - ECO'),
	(40901696, 'US - Ecodopplercardiograma com estresse físico'),
	(40901700, 'Ecodopplercardiograma sob estresse físico ou farmacológico com contraste'),
	(40901718, 'Ecodopplercardiograma para ajuste de marca-passo'),
	...
	(40901793, 'Elastografia hepática ultrassônica'),
	(40902013, 'US - Obstétrica: com amniocentese'),
	(40902021, 'US - Obstétrica 1º trimestre com punção: biópsia ou aspirativa'),
	(40902030, 'US - Próstata transretal com biópsia - até 8 fragmentos'),
	(40902048, 'US - Próstata transretal com biópsia - mais de 8 fragmentos'),
	(40902056, 'US - Intra-operatório'),
	(40902064, 'Doppler colorido intra-operatório'),
	(40902072, 'Ecodopplercardiograma transoperatório (transesofágico ou epicárdico) (1ª hora)'),
	(40902080, 'Ecodopplercardiograma transoperatório (transesofágico ou epicárdico) - por hora suplementar'),
	...
	(40902137, 'Monitorização por Doppler transcraniano'),
	(40902145, 'Ecodopplercardiograma intracardíaco'),
	(41001010, 'TC - Crânio ou sela túrcica ou órbitas'),
	(41001028, 'TC - Mastóides ou orelhas'),
	(41001036, 'TC - Face ou seios da face'),
	(41001044, 'TC - Articulações temporomandibulares'),
	(41001052, 'TC - Dental (dentascan)'),
	(41001060, 'TC - Pescoço (partes moles, laringe, tireóide, faringe e glândulas salivares)'),
	(41001079, 'TC - Tórax'),
	(41001087, 'TC - Coração - para avaliação do escore de cálcio coronariano'),
	(41001095, 'TC - Abdome total (abdome superior, pelve e retroperitônio)'),
	(41001109, 'TC - Abdome superior'),
	(41001117, 'TC - Pelve ou bacia'),
	(41001125, 'TC - Coluna cervical ou dorsal ou lombo-sacra (até 3 segmentos)'),
	(41001133, 'TC - Coluna - segmento adicional'),
	(41001141, 'TC - Articulação (esternoclavicular ou ombro ou cotovelo ou punho ou sacroilíacas ou coxofemoral ou joelho ou tornozelo) - unilateral'),
	(41001150, 'TC - Segmento apendicular (braço ou antebraço ou mão ou coxa ou perna ou pé) - unilateral'),
	(41001168, 'Angiotomografia (crânio ou pescoço ou tórax ou abdome superior ou pelve) - arterial ou venosa'),
	(41001176, 'Angiotomografia de aorta torácica'),
	(41001184, 'Angiotomografia de aorta abdominal'),
	(41001192, 'TC - Escanometria digital'),
	(41001206, 'TC - Reconstrução tridimensional de qualquer órgão ou estrutura - acrescentar ao exame de base'),
	(41001214, 'Endoscopia virtual de qualquer órgão ou estrutura por TC - acrescentar ao exame de base'),
	(41001222, 'TC para PET dedicado oncológico'),
	(41001230, 'TC - Angiotomografia coronariana'),
	(41001249, 'TC - Artérias de membro superior'),
	(41001257, 'TC - Cisternografia por tomografia'),
	(41001265, 'TC - Colonoscopia virtual'),
	(41001273, 'TC - Mandíbula'),
	(41001281, 'TC - Maxilar'),
	(41001290, 'PET-CT cardiológico'),
	(41001303, 'PET-CT infecção'),
	(41001311, 'PET-CT neurológico'),
	(41001320, 'TC - Tomossíntese digital mamária'),
	(41001338, 'TC - Radiocirurgia esterotáxica'),
	(41001346, 'TC - Multifase (dinâmica)'),
	(41001354, 'TC - Articular dinâmica'),
	(41001362, 'TC - Vias urinárias (Urotomografia)'),
	...
	(41002016, 'Tomomielografia (até 3 segmentos) - acrescentar a TC da coluna e incluir a punção'),
	(41002024, 'Punção aspirativa orientada por TC (acrescentar o exame de base)'),
	...
	(41101049, 'Estudo funcional (mapeamento cortical por RM)'),
	...
	(41101103, 'RM - Articulação temporomandibular (bilateral)'),
	(41101111, 'RM - Pescoço (nasofaringe, orofaringe, laringe, traquéia, tireóide, paratireóide)'),
	(41101120, 'RM - Tórax (mediastino, pulmão, parede torácica)'),
	(41101138, 'RM - Coração - morfológico e funcional'),
	...
	(41101170, 'RM - Abdome superior (fígado, pâncreas, baço, rins, supra-renais, retroperitônio)'),
	(41101189, 'RM - Pelve (não inclui articulações coxofemorais)'),
	(41101197, 'RM - Fetal'),
	(41101200, 'RM - Pênis'),
	(41101219, 'RM - Bolsa escrotal'),
	(41101227, 'RM - Coluna cervical ou dorsal ou lombar'),
	(41101235, 'RM - Fluxo liquórico (como complementar)'),
	(41101243, 'RM - Plexo braquial (desfiladeiro torácico) ou lombossacral (não inclui coluna cervical ou lombar)'),
	(41101251, 'RM - Membro superior unilateral (não inclui mão e articulações)'),
	...
	(41101324, 'Angio-RM (crânio ou pescoço ou tórax ou abdome superior ou pelve) - arterial ou venosa'),
	...
	(41101367, 'RM - Endocavitária (endorretal ou endovaginal)'),
	(41101375, 'Endoscopia virtual por RM - acrescentar ao exame de base'),
	(41101383, 'RM - Reconstrução tridimensional - acrescentar ao exame de base'),
	(41101391, 'RM artérias membros inferiores'),
	(41101430, 'RM - Avaliação de ferro (coração ou fígado)'),
	(41101448, 'RM - Tractografia'),
	(41101456, 'RM - Difusão por RM'),
	(41101464, 'RM - Multiparamétrica transretal da próstata'),
	...
	(41203020, 'Radiocirurgia (RTC) - nível 1, lesão única e/ou um isocentro - por tratamento'),
	(41203038, 'Radiocirurgia (RTC) - nível 2, duas lesões e/ou dois a quatro isocentros - por tratamento'),
	(41203046, 'Radiocirurgia (RTC) - nível 3, três lesões e/ou de mais de quatro isocentros - por tratamento'),
	...
	(41203070, 'Radioterapia Convencional de Megavoltagem com Acelerador Linear com Fótons e Elétrons - por campo'),
	...
	(41203160, 'Radioterapia Intra-operatória (IORT) - por tratamento'),
	(41203178, 'Radioterapia Rotatória com acelerador linear com fótons e elétrons - por volume tratado e por dia'),
	(41203186, 'Radioterapia Rotatória com acelerador linear só com fótons - por volume tratado e por dia'),
	(41203194, 'Radioterapia Rotatória com unidade de cobalto - por volume tratado e por dia'),
	(41203208, 'Sangues e derivados (por unidade)'),
	(41204018, 'Colimação individual - 1 por incidência planejada'),
	(41204026, 'Filme de verificação (cheque-filme) - 1 por incidência planejada/semana - filme a parte'),
	...
	(41204050, 'Planejamento de tratamento simples (não computadorizado) - 1 por volume tratado'),
	...
	(41204085, 'Simulação de tratamento simples (sem tomografia computadorizada) - 1 por volume tratado'),
	...
	(41205065, 'Braquiterapia intersticial de baixa taxa de dose (BBTD) com ouro, irídio ou iodo - por tratamento'),
	...
	(41205111, 'Braquiterapia por moldagem ou contato de baixa taxa de dose (BBTD) com ouro, irídio ou iodo - por tratamento'),
	(41205120, 'Braquiterapia por moldagem ou contato, de alta taxa de dose (BATD) - por inserção'),
	(41206010, 'Filme de verificação (cheque-filme) de braquiterapia - 2 por inserção - filme à parte'),
	(41206029, 'Colocação ou retirada da placa oftálmica - 1 colocação e 1 retirada por tratamento'),
	...
	(41301021, 'Angiografia com indocianina verde - monocular'),
	(41301030, 'Avaliação órbito-palpebral-exoftalmometria - binocular'),
	...
	(41301170, 'Avaliação de vias lacrimais (Teste de Schirmer) - monocular'),
	...
	(41301390, 'Coleta de raspado dérmico em lesões e sítios específicos para baciloscopia (por sítio)'),
	(41301404, 'Avaliação da função muscular por movimento manual (por membro)'),
	...
	(41301471, 'Teste do reflexo vermelho em recém nato (teste do olhinho)'),
	(41301480, 'Ceratoscopia computadorizada da córnea por orbscan, olho'),
	(41301498, 'Exame neuro oftalmlógico'),
	(41301510, 'Topografia do disco óptico - HRT - binocular'),
	...
	(41301549, 'Campimetria blue-yellow (perimetria azul amarelo)'),
	...
	(41401069, 'Provas imuno-alérgicas para bactérias (por antígeno)'),
	(41401077, 'Provas imuno-alérgicas para fungos (por antígeno)'),
	(41401085, 'Teste da histamina (duas áreas testadas)'),
	(41401093, 'Teste de adaptação patológica (tone decay test)'),
	(41401107, 'Teste de broncoprovocação'),
	(41401115, 'Teste de caminhada de 6 minutos'),
	(41401123, 'Teste de desempenho anaeróbico em laboratório (T. de Wingate)'),
	(41401131, 'Teste de equilíbrio peritoneal (PET)'),
	(41401140, 'Teste de exercício dos 4 segundos'),
	(41401158, 'Teste de exercício em ergômetro   com  determinação  do lactato sanguíneo'),
	(41401166, 'Teste de exercício em ergômetro com   realização  de gasometria arterial'),
	...
	(41401190, 'Teste de exercício em ergômetro com medida de gases expirados (teste cardiopulmonar de exercício) com qualquer ergômetro'),
	(41401204, 'Teste de exercício em ergômetro com medida de gases expirados e eletrocardiograma'),
	(41401212, 'Teste de glicerol (com audiometria tonal limiar pré e pós)'),
	(41401220, 'Teste de glicerol (com eletrococleografia pré e pós)'),
	...
	(41401298, 'Teste para broncoespasmo de exercício'),
	(41401301, 'Teste provocativo para glaucoma - binocular'),
	(41401310, 'Testes aeróbicos em campo com determinação do lactato sanguíneo'),
	(41401328, 'Testes aeróbicos em campo com medida de gases expirados'),
	(41401336, 'Testes aeróbicos em campo com telemetria da frequência cardíaca'),
	(41401344, 'Testes anaeróbicos em campo com determinação do lactato sanguíneo'),
	(41401352, 'Testes anaeróbicos em campo sem determinação do lactato sanguíneo'),
	...
	(41401417, 'Testes de aptidão em laboratório (agilidade, equilíbrio, tempo de reação e coordenação)'),
	(41401425, 'Testes de contato - até 30 substâncias'),
	(41401433, 'Testes de contato - por substância, acima de 30'),
	(41401441, 'Testes de contato por fotossensibilização - até 30 substâncias'),
	(41401450, 'Testes de contato por fotossensibilização - por substância, acima de 30'),
	(41401468, 'Testes do desenvolvimento (escala de Denver e outras)'),
	(41401476, 'Testes vestibulares, com prova calórica, com eletronistagmografia'),
	(41401484, 'Testes vestibulares, com prova calórica, sem eletronistagmografia'),
	...
	(41401549, 'Teste de monitorização contínua da glicose (TMCG)'),
	(41401557, 'Repertorização'),
	(41401565, 'Teste de avaliação geriátrica global'),
	...
	(41401646, 'Testes cutâneos de contato (patch tests)'),
	(41401654, 'Teste de fluxo salivar'),
	(41401662, 'Teste de estimulação muscúlo-esquelética "in vitro" (mínimo seis)'),
	(41401670, 'Teste de fibronectina fetal - indicador bioquímico para parto prematuro'),
	(41401689, 'Metabolismo de repouso'),
	(41401697, 'Estudo da halitose'),
	(41401700, 'Teste de Wada'),
	(41401719, 'Teste rápido para detecção da PAMG-1 para diagnóstico de ruptura de membranas fetais'),
	(41401751, 'Teste de contato bateria cosméticos'),
	(41401760, 'Teste de contato bateria regional'),
	(41401778, 'Teste de contato bateria capilar'),
	(41401786, 'Teste de contato bateria unhas'),
	(41401794, 'Teste de contato bateria medicamentos/corticoides'),
	(41401808, 'Teste de contato bateria agentes ocupacionais'),
	(41501012, 'Biometria ultrassônica - monocular'),
	(41501020, 'Cavernosometria'),
	(41501047, 'Dopplermetria dos cordões espermáticos'),
	(41501063, 'Investigação ultrassônica com registro gráfico (qualquer área)'),
	(41501071, 'Investigação ultrassônica com teste de stress e com registro gráfico'),
	(41501080, 'Investigação ultrassônica com teste de stress e sem registro gráfico'),
	(41501098, 'Investigação ultrassônica com teste de stress em esteira e com registro gráfico'),
	(41501101, 'Investigação ultrassônica sem registro gráfico (qualquer área)'),
	(41501110, 'Medida de índice de artelhos com registro gráfico'),
	(41501128, 'Paquimetria ultrassônica - monocular'),
	(41501136, 'Termometria cutânea (por lateralidade: pescoço, membros, bolsa escrotal, por território peniano)'),
	(41501144, 'Tomografia de coerência óptica - monocular'),
	(41501179, 'Fotopletismografia (venosa ou arterial) por lateralidade ou segmento'),
	(41501187, 'Medida de pressão segmentar (nos quatro segmentos)'),
	...
	(50000071, 'Consulta individual hospitalar, em terapia ocupacional'),
	...
	(50000101, 'Sessão individual hospitalar, em terapia ocupacional'),
	...
	(50000209, 'Sessão para assistência fisioterapêutica ambulatorial ao paciente com disfunção decorrente de alterações do sistema linfático e/ou vascular periférico'),
	(50000217, 'Sessão para assistência fisioterapêutica ambulatorial no pré e pós cirúrgico e em recuperação de tecidos'),
	(50000225, 'Sessão para assistência fisioterapêutica ambulatorial por alterações endocrino-metabólicas'),
	(50000233, 'Sessão para assistência fisioterapêutica ambulatorial para alterações inflamatórias e ou degenerativas do aparelho genito-urinário e reprodutor'),
	(50000241, 'Consulta domiciliar em fisioterapia'),
	(50000250, 'Sessão para assistência fisioterapêutica domiciliar ao paciente com disfunção decorrente de lesão do sistema nervoso central e/ou periférico'),
	(50000268, 'Sessão para assistência fisioterapêutica domiciliar ao paciente com disfunção decorrente de alterações do sistema músculo-esquelético'),
	(50000276, 'Sessão para assistência fisioterapêutica domiciliar ao paciente com disfunção decorrente de alterações no sistema respiratório'),
	(50000284, 'Sessão para assistência fisioterapêutica domiciliar ao paciente com disfunção decorrente de alterações do sistema cardiovascular'),
	(50000292, 'Sessão para assistência fisioterapêutica domiciliar ao paciente com disfunção decorrente de queimaduras'),
	(50000306, 'Atendimento fisioterapêutico domiciliar ao paciente com disfunção decorrente de alterações do sistema linfático e/ou vascular periférico'),
	(50000314, 'Sessão para assistência fisioterapêutica domiciliar no pré e pós cirúrgico e em recuperação de tecidos'),
	(50000322, 'Sessão para assistência fisioterapêutica domiciliar por alterações endocrino-metabólicas'),
	(50000330, 'Atendimento fisioterapêutico domiciliar para alterações inflamatórias e ou degenerativas do aparelho genito-urinário, reprodutor e/ou proctológico'),
	(50000349, 'Consulta hospitalar em fisioterapia'),
	(50000357, 'Sessão para assistência fisioterapêutica hospitalar ao paciente com disfunção decorrente de lesão do sistema nervoso central e/ou periférico'),
	...
	(50000381, 'Sessão para assistência fisioterapêutica hospitalar ao paciente com disfunção decorrente de alterações do sistema cardiovascular'),
	(50000390, 'Atendimento fisioterapêutico hospitalar ao paciente com disfunção decorrente de queimaduras'),
	(50000403, 'Sessão para assistência fisioterapêutica hospitalar ao paciente com disfunção decorrente de alterações do sistema linfático e/ou vascular periférico'),
	(50000411, 'Atendimento fisioterapêutico hospitalar no pré e pós cirúrgico e em recuperação de tecidos'),
	(50000420, 'Sessão para assistência fisioterapêutica hospitalar por alterações endocrino-metabólicas'),
	(50000438, 'Hidroterapia'),
	(50000446, 'RPG'),
	...
	(50000799, 'Atendimento fisioterapêutico hospitalar ao paciente independente ou com dependência parcial, com disfunção decorrente de lesão do sistema nervoso central e/ou periférico'),
	(50000802, 'Atendimento fisioterapêutico hospitalar ao paciente dependente com disfunção decorrente de lesão do sistema nervoso central e/ou periférico'),
	(50000810, 'Atendimento fisioterapêutico hospitalar ao paciente com disfunção decorrente de alterações no sistema respiratório com assistência ventilatória.'),
	(50000829, 'Atendimento fisioterapêutico hospitalar ao paciente com disfunção decorrente de alterações no sistema respiratório sem assistência ventilatória'),
	(50000837, 'Fisioterapia aquatica individual'),
	...
	(50000896, 'Avaliação ergonômica'),
	(50000900, 'EMG não  invasivo'),
	(50000918, 'Estabilometria'),
	(50000926, 'Ventilometria (incluindo Capacidade Vital, Capacidade Inspiratoria, volume minuto, volume corrente e todos índices derivados destas avaliações)'),
	(50000934, 'Análise Eletroterapêutica não invasiva, identificação de ponto motor, cronaximetria, reobase, acomodação e curva I/T - por segmento ou membro'),
	(50000942, 'Atendimento fisioterapêutico ambulatorial individual ao paciente com disfunção decorrente de alterações do sistema cardiovascular'),
	(50000950, 'Atendimento fisioterapêutico ambulatorial em grupo ao paciente com disfunção decorrente de alterações do sistema cardiovascular'),
	(50000969, 'Hidroterapia individual'),
	(50000977, 'Hidroterapia em grupo'),
	(50000985, 'Atendimento fisioterapêutico ambulatorial individual ao paciente com disfunção decorrente de alterações no sistema respiratório'),
	(50000993, 'Atendimento fisioterapêutico ambulatorial em grupo ao paciente com disfunção decorrente de alterações no sistema respiratório'),
	(50001000, 'Atendimento fisioterapêutico hospitalar ao paciente com disfunção decorrente de alterações no sistema respiratório sem Assistência Ventilatória Mecânica.'),
	(50001019, 'Atendimento fisioterapêutico hospitalar ao paciente com disfunção decorrente de alterações no sistema respiratório com Assistência Ventilatória Mecânica.'),
	(50001027, 'Atendimento fisioterapêutico ambulatorial individual por alterações endocrino-metabólicas'),
	(50001035, 'Atendimento fisioterapêutico ambulatorial em grupo por alterações endocrino-metabólicas'),
	(50001043, 'Atendimento fisioterapêutico hospitalar ao paciente com dependência parcial com disfunção decorrente de lesão do sistema nervoso central e/ou periférico'),
	(50001051, 'Atendimento fisioterapêutico hospitalar ao paciente com dependência total com disfunção decorrente de lesão do sistema nervoso central e/ou periférico'),
	...
	(50001086, 'Atendimento Fisioterapêutico individual em Pilates'),
	(50001094, 'Atendimento Fisioterapêutico em grupo em Pilates'),
	(50001108, 'Atendimento fisioterapêutico em Quiropraxia'),
	(50001116, 'Análise Eletroterapêutica não invasiva, identificação de ponto motor, cronaximetria, reobase, acomodação e curva I/T - por segmento ou membro'),
	(50001124, 'Baropodometria'),
	(50001132, 'Avaliação ergonômica'),
	(50001140, 'EMG não invasivo'),
	(50001159, 'Estabilometria'),
	(50001167, 'Confecção de recursos de tecnologia assistiva'),
	(50001175, 'Ventilometria (incluindo Capacidade Vital, Capacidade Inspiratória, volume minuto, volume corrente e todos índices derivados destas avaliações)'),
	...
	(81000510, 'Tomografia computadorizada por feixe cônico – cone beam'),
	(81000529, 'Tomografia convencional – linear ou multi-direcional'),
	(81000537, 'Traçado Cefalométrico'),
	(81000545, 'Diagnóstico e tratamento de trismo'),
	(81000553, 'Documentação odontológica em mídia digital'),
	...
	(82000522, 'Criocirurgia de neoplasias da região buco-maxilo-facial'),
	(82000549, 'Crioterapia ou termoterapia em odontologia'),
	...
	(82001138, 'Reabertura - colocação de cicatrizador'),
	...
	(82001375, 'Remoção de tamponamento nasal'),
	...
	(82001430, 'Retirada dos meios de fixação da região buco-maxilo-facial'),
	...
	(82001707, 'Ulectomia'),
	(82001715, 'Ulotomia'),
	(82001723, 'Aplicação de laser pós cirúrgico'),
	...
	(82001766, 'Placa de contenção cirúrgica'),
	...
	(85100030, 'Clareamento dentário de consultório'),
	...
	(85100250, 'Aplicação de laser terapêutico'),
	...
	(85300101, 'Tracionamento de raiz residual'),
	...
	(85400122, 'Coroa total livre de metal (metalfree) sobre implante - cerâmica'),
	(85400130, 'Coroa total livre de metal (metalfree) sobre implante - cerômero'),
	...
	(85400564, 'Prótese total imediata sobre implantes'),
	(85400572, 'Coroa 3/4 ou 4/5'),
	(85400580, 'JIG ou Front plato - órtese reposicionadora'),
	(85400599, 'Planejamento em prótese'),
	(85400602, 'Ponto de solda'),
	(85400610, 'Prótese total caracterizada'),
	...
	(85500089, 'Manutenção de prótese sobre implantes'),
	(85500097, 'Overdenture barra clipe ou o"ring sobre dois implantes'),
	...
	(85500135, 'Prótese parcial fixa provisória em carga imediata'),
	(85500143, 'Protocolo Branemark em carga imediata para 4 implantes - parte protética'),
	...
	(85500208, 'Barra clipe'),
	(85500216, 'Plasma rico em plaquetas (PRP)'),
	(85500224, 'Tratamento de perimplantite por implante'),
	...
	(86000063, 'Aparelho ortodôntico fixo estético'),
	...
	(86000411, 'Monobloco'),
	(86000420, 'Obtenção de modelos gnatostáticos de Planas'),
	...
	(86000616, 'Recolocação de mantenedor de espaço'),
	(87000016, 'Colocação de aparelho ortodôntico removível'),
	...
	(87000164, 'Sedação consciente com óxido nitroso e oxigênio em pacientes com necessidades especiais em odontologia'),
	(87000180, 'Sedação medicamentosa ambulatorial em pacientes com necessidades especiais em odontologia'),
	(87000199, 'Colocação de aparelho ortodôntico removível');
/*!40000 ALTER TABLE `ea_procedimentos` ENABLE KEYS */;
